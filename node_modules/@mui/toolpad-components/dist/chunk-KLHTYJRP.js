...
} from "./chunk-EIL5763P.js";
import {
  SX_PROP_HELPER_TEXT
} from "./chunk-OUMUE6ED.js";
import {
  createBuiltin
} from "./chunk-Z6CWKUOP.js";
...
import { createFormat as createNumberFormat } from "@mui/toolpad-core/numberFormat";
import { createFormat as createDateFormat } from "@mui/toolpad-core/dateFormat";
...
function dateValueGetter({ value }) {
...
var CUSTOM_COLUMN_TYPES = {
  json: {
    valueFormatter: ({ value: cellValue }) => JSON.stringify(cellValue)
  },
  date: {
...
function parseColumns(columns) {
  return columns.map((column) => {
    ...
    const type = column.type && column.type in DEFAULT_COLUMN_TYPES ? column.type : void 0;
...
function ActionResultOverlay({ result, onClose, apiRef }) {
  ...
  if (lastResult) {
    if (lastResult.action === "create") {
      message = lastResult.error ? `Failed to create a record, ${lastResult.error.message}` : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
        Link,
        {
          href: "#",
          color: "inherit",
...
var DataGrid_default = createBuiltin(DataGridComponent, {
  helperText: "The MUI X [Data Grid](https://mui.com/x/react-data-grid/) component.\n\nThe datagrid lets users display tabular data in a flexible grid.",
  errorProp: "error",
...
//# sourceMappingURL=chunk-KLHTYJRP.js.map
...
var grey = {
  ...
  400: "#B2BAC2",
  // vs blueDark 900: WCAG 9 AAA, APCA 63.3 Ok for text
  500: "#A0AAB4",
  // vs blueDark 900: WCAG 7.5 AAA, APCA 54.3 Only for large text
  600: "#6F7E8C",
  // vs white bg: WCAG 4.1 AA, APCA 68.7 Ok for text
  700: "#3E5060",
  // vs white bg: WCAG 8.3 AAA, APCA 88.7 Best for text
  800: "#2D3843",
  // vs white bg: WCAG 11.9 AAA, APCA 97.3 Best for text
  900: "#1A2027"
};
var systemFont = [
  "-apple-system",
...
var getDesignTokens = (mode) => ({
  palette: {
    ...
    warning: {
      ...
      900: "#5A3600"
      // vs white bg: WCAG 10.7 AAA, APCA 95 Best for text
    }
  },
  shape: {
    borderRadius: 10
        ...
        styleOverrides: {
          root: ({ ownerState: { color, variant } }) => ({
            ...
            ...variant === "filled" && color === "default" && {
              ...
              backgroundColor: theme.palette.mode === "dark" ? alpha(theme.palette.primaryDark[500], 0.8) : alpha(theme.palette.primary[100], 0.5),
              "&:hover": {
...
//# sourceMappingURL=chunk-OGNZ7XRX.mjs.map
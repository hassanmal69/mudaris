...
import {
  ...
  TOOLPAD_BRIDGE_GLOBAL,
  UPGRADE_URL,
  VERSION_CHECK_INTERVAL
} from "./chunk-TS2BGFNC.mjs";
import {
  AppHostContext,
  CanvasHooksContext,
...
import { CircularProgress as CircularProgress4, Box as Box38, styled as styled37, CssBaseline, Button as Button24, Stack as Stack26, Tooltip as Tooltip18 } from "@mui/material";
...
import useBoolean9 from "@mui/toolpad-utils/hooks/useBoolean";
...
import { styled as styled26 } from "@mui/material";
import usePageTitle from "@mui/toolpad-utils/hooks/usePageTitle";
import * as appDom21 from "@mui/toolpad-core/appDom";
...
import * as appDom6 from "@mui/toolpad-core/appDom";

// src/toolpad/AppEditor/PageEditor/EditorCanvasHost.tsx
import * as React5 from "react";
import { Fade, styled as styled2 } from "@mui/material";
...
var PREFIX = process.env.EXPERIMENTAL_INLINE_CANVAS ? "/editor" : "";
...
function CenteredSpinner({ sx }) {
  return /* @__PURE__ */ React4.createElement(
    ...
    /* @__PURE__ */ React4.createElement(CircularProgress, null)
  );
}
...
function Overlay(props) {
  ...
  return /* @__PURE__ */ React5.createElement(CacheProvider, { value: cache }, children);
}
var CanvasRoot = styled2("div")({
  width: "100%",
  position: "relative"
});
var CanvasOverlay = styled2("div")(({ theme }) => ({
...
function useOnChange(value, handler) {
  const stableHandler = useEventCallback2(handler);
  const prevValue = React5.useRef(value);
  React5.useEffect(() => {
...
function EditorCanvasHost({
  ...
  const [bridge, setBridge] = React5.useState(null);
  const updateOnBridge = React5.useCallback(() => {
    if (bridge) {
  ...
  const [editorOverlayRoot, setEditorOverlayRoot] = React5.useState(null);
  ...
  const initBridge = useEventCallback2((bridgeInstance) => {
    const handleReady = (readyBridge) => {
      setLoading(false);
  ...
  const handleFrameLoad = React5.useCallback(
    (event) => {
  ...
  const invalidateCanvasQueries = useEventCallback2(() => {
  ...
  return /* @__PURE__ */ React5.createElement(CanvasRoot, { className }, /* @__PURE__ */ React5.createElement(
    CanvasFrame,
    {
      name: "data-toolpad-canvas",
      onLoad: handleFrameLoad,
      src,
      "data-toolpad-canvas": true
    }
  ), editorOverlayRoot ? ReactDOM.createPortal(
    /* @__PURE__ */ React5.createElement(Overlay, { container: editorOverlayRoot }, overlay),
    editorOverlayRoot
  ) : null, /* @__PURE__ */ React5.createElement(Fade, { in: loading, appear: false, timeout: { enter: 0, exit: 100 } }, /* @__PURE__ */ React5.createElement(CanvasOverlay, null, /* @__PURE__ */ React5.createElement(CenteredSpinner, null))));
}

// src/toolpad/AppEditor/PageEditor/EditorCanvasHostInline.tsx
import * as React6 from "react";
import { styled as styled3, useEventCallback as useEventCallback3 } from "@mui/material";
import createCache2 from "@emotion/cache";
import { CacheProvider as CacheProvider2 } from "@emotion/react";
import * as ReactDOM2 from "react-dom";
import { Emitter as Emitter2 } from "@mui/toolpad-utils/events";
import { update as update2 } from "@mui/toolpad-utils/immutability";
...
function Overlay2(props) {
  ...
  cache.compat = true;
  return /* @__PURE__ */ React6.createElement(CacheProvider2, { value: cache }, children);
}
var CanvasRoot2 = styled3("div")({
  width: "100%",
  position: "relative"
});
var CanvasFrame2 = styled3("iframe")({
  border: "none",
  position: "absolute",
  width: "100%",
  height: "100%"
...
function EditorCanvasHost2({
  ...
  const project = useProject();
  const [canvasEvents, setCanvasEvents] = React6.useState(null);
  const [editorOverlayRoot, setEditorOverlayRoot] = React6.useState(null);
  const [portal, setPortal] = React6.useState(null);
  const appStateApi = useAppStateApi();
  const handleIframeLoad = useEventCallback3((event) => {
    invariant4(event.currentTarget.contentDocument, "iframe contentDocument is not available");
    const root = event.currentTarget.contentDocument.getElementById("root");
    invariant4(root, "root element not found");
    const iframeWindow = event.currentTarget.contentWindow;
    invariant4(iframeWindow, "Iframe not attached");
  ...
  const viewState = React6.useRef({ nodes: {} });
  const canvasHooks = React6.useMemo(
    () => ({
  ...
  const appRootCleanupRef = React6.useRef();
  const projectEventSubscriptionRef = React6.useRef();
  const onAppRoot = React6.useCallback(
    (appRoot) => {
  ...
  return /* @__PURE__ */ React6.createElement(CanvasRoot2, { className }, /* @__PURE__ */ React6.createElement(
    CanvasFrame2,
    {
      name: "data-toolpad-canvas",
      srcDoc: `
  ...
  ), page && portal ? ReactDOM2.createPortal(
    /* @__PURE__ */ React6.createElement(Overlay2, { container: portal }, /* @__PURE__ */ React6.createElement(CanvasHooksContext.Provider, { value: canvasHooks }, /* @__PURE__ */ React6.createElement(CanvasEventsContext.Provider, { value: canvasEvents }, /* @__PURE__ */ React6.createElement(AppHostContext.Provider, { value: appHost }, /* @__PURE__ */ React6.createElement(ToolpadAppProvider, { rootRef: onAppRoot, basename: base, state: runtimeState }, /* @__PURE__ */ React6.createElement(RenderedPage, { page })))))),
    portal
  ) : null, editorOverlayRoot ? ReactDOM2.createPortal(
    /* @__PURE__ */ React6.createElement(Overlay2, { container: editorOverlayRoot }, overlay),
    editorOverlayRoot
  ) : null);
}
...
import { update as update3, updateOrCreate } from "@mui/toolpad-utils/immutability";
...
var PageEditorContext = React7.createContext(null);
function usePageEditorState() {
  const state = React7.useContext(PageEditorContext);
  if (!state) {
    throw new Error(`Missing PageEditorContext`);
  }
  return state;
}
var PageEditorApiContext = React7.createContext(
  createPageEditorApi(() => void 0)
);
function PageEditorProvider({ children, nodeId }) {
  const initialState = createPageEditorState(nodeId);
  const [state, dispatch] = React7.useReducer(pageEditorReducer, initialState);
  const api = React7.useMemo(() => createPageEditorApi(dispatch), []);
  React7.useEffect(() => {
    api.replace(createPageEditorState(nodeId));
  }, [api, nodeId]);
  return /* @__PURE__ */ React7.createElement(PageEditorContext.Provider, { value: state }, /* @__PURE__ */ React7.createElement(PageEditorApiContext.Provider, { value: api }, children));
}
function usePageEditorApi() {
  return React7.useContext(PageEditorApiContext);
}
...
import { omit as omit2 } from "@mui/toolpad-utils/immutability";
import * as appDom5 from "@mui/toolpad-core/appDom";
...
import { IconButton, styled as styled4, Tooltip } from "@mui/material";
...
var NodeHudWrapper = styled4("div", {
...
var SelectionHintWrapper = styled4("div", {
...
var DraggableEdgeWrapper = styled4("div")({
  userSelect: "none",
  position: "absolute",
  zIndex: 90
});
var DraggableEdge = styled4("div", {
...
var ResizePreview = styled4("div")(({ theme }) => ({
...
function NodeHud({
  ...
  const interactiveNodeClipPath = React8.useMemo(
  ...
  return /* @__PURE__ */ React8.createElement(React8.Fragment, null, /* @__PURE__ */ React8.createElement(
    ...
    isSelected ? /* @__PURE__ */ React8.createElement("span", { className: nodeHudClasses.selected }) : null,
    isResizing ? /* @__PURE__ */ React8.createElement(ResizePreview, { ref: resizePreviewElementRef, style: absolutePositionCss(rect) }) : null
  ), isSelected ? /* @__PURE__ */ React8.createElement(SelectionHintWrapper, { style: absolutePositionCss(rect), hintPosition }, /* @__PURE__ */ React8.createElement(
    "div",
    {
      draggable: true,
    ...
    node.name,
    /* @__PURE__ */ React8.createElement(DragIndicatorIcon, { color: "inherit" }),
    /* @__PURE__ */ React8.createElement(IconButton, { "aria-label": "Duplicate", color: "inherit", onMouseUp: onDuplicate }, /* @__PURE__ */ React8.createElement(Tooltip, { title: "Duplicate", enterDelay: 400 }, /* @__PURE__ */ React8.createElement(ContentCopy, { color: "inherit" }))),
    /* @__PURE__ */ React8.createElement(IconButton, { "aria-label": "Remove", color: "inherit", onMouseUp: onDelete }, /* @__PURE__ */ React8.createElement(Tooltip, { title: "Remove", enterDelay: 400 }, /* @__PURE__ */ React8.createElement(DeleteIcon, { color: "inherit" })))
  )) : null, onEdgeDragStart ? /* @__PURE__ */ React8.createElement(DraggableEdgeWrapper, { style: absolutePositionCss(rect) }, draggableEdges.map((edge) => /* @__PURE__ */ React8.createElement(
    DraggableEdge,
    {
...
import { Grid, styled as styled5 } from "@mui/material";
import invariant5 from "invariant";
var GRID_NUMBER_OF_COLUMNS = 12;
var GRID_COLUMN_GAP = 1;
var GridContainer = styled5("div")({
  pointerEvents: "none",
  position: "absolute",
  zIndex: 1
});
var StyledGrid = styled5(Grid)({
  height: "100%"
});
var StyledGridColumn = styled5("div")(({ theme }) => ({
  backgroundColor: theme.palette.grey[400],
  height: "100%",
  opacity: 0.2
}));
var OverlayGrid = React9.forwardRef(
  function OverlayGrid2(props, forwardedRef) {
    const gridRef = React9.useRef(null);
    ...
    const appTheme = React9.useMemo(() => createToolpadAppTheme(dom), [dom]);
    React9.useImperativeHandle(
      forwardedRef,
      () => {
        const gridElement = gridRef.current;
        invariant5(gridElement, "Overlay grid ref not bound");
        let columnEdges = [];
    ...
    return pageChildrenSlotRect ? /* @__PURE__ */ React9.createElement(GridContainer, { style: { ...absolutePositionCss(pageChildrenSlotRect), height: "100%" } }, /* @__PURE__ */ React9.createElement(StyledGrid, { ref: gridRef, container: true, columnSpacing: appTheme.spacing(GRID_COLUMN_GAP) }, [...Array(GRID_NUMBER_OF_COLUMNS)].map((column, index) => /* @__PURE__ */ React9.createElement(Grid, { key: index, item: true, xs: 1 }, /* @__PURE__ */ React9.createElement(StyledGridColumn, null))))) : null;
  }
);
...
var StyledNodeDropArea = styled6("div", {
...
var EmptySlot = styled6("div")(({ theme }) => ({
  alignItems: "center",
...
function NodeDropArea({
  ...
  const dropAreaNodeChildNodes = React10.useMemo(
  ...
  const highlightedZone = React10.useMemo(() => {
  ...
  ), isEmptySlot && slotRect ? /* @__PURE__ */ React10.createElement(EmptySlot, { style: absolutePositionCss(slotRect) }, /* @__PURE__ */ React10.createElement(Typography, { variant: "subtitle2" }, "Drop component here")) : null);
}

// src/PinholeOverlay.tsx
import * as React11 from "react";
import { styled as styled7 } from "@mui/material";
var PinholeOverlayRoot = styled7("div")({
...
var PinholeOverlay = React11.forwardRef(function PinholeOverlay2({ className, onClick, pinhole }, ref) {
  const left = React11.useRef(null);
  const topLeft = React11.useRef(null);
  const top = React11.useRef(null);
  const topRight = React11.useRef(null);
  const right = React11.useRef(null);
  const bottomRight = React11.useRef(null);
  const bottom = React11.useRef(null);
  const bottomLeft = React11.useRef(null);
  ...
  return /* @__PURE__ */ React11.createElement(PinholeOverlayRoot, { ref, className }, pinhole ? /* @__PURE__ */ React11.createElement(React11.Fragment, null, /* @__PURE__ */ React11.createElement("div", { key: "left", ref: left, onClick: handleClick }), /* @__PURE__ */ React11.createElement("div", { key: "topLeft", ref: topLeft, onClick: handleClick }), /* @__PURE__ */ React11.createElement("div", { key: "top", ref: top, onClick: handleClick }), /* @__PURE__ */ React11.createElement("div", { key: "topRight", ref: topRight, onClick: handleClick }), /* @__PURE__ */ React11.createElement("div", { key: "right", ref: right, onClick: handleClick }), /* @__PURE__ */ React11.createElement("div", { key: "bottomRight", ref: bottomRight, onClick: handleClick }), /* @__PURE__ */ React11.createElement("div", { key: "bottom", ref: bottom, onClick: handleClick }), /* @__PURE__ */ React11.createElement("div", { key: "bottomLeft", ref: bottomLeft, onClick: handleClick })) : (
    // eslint-disable-next-line jsx-a11y/click-events-have-key-events,jsx-a11y/no-static-element-interactions
    /* @__PURE__ */ React11.createElement("div", { key: "full", onClick: handleClick })
  ));
});

// src/toolpad/AppEditor/pageLayout.ts
import * as appDom4 from "@mui/toolpad-core/appDom";
...
function RenderOverlay({ bridge }) {
  ...
  const pageNodes = React12.useMemo(() => {
  ...
  const selectNode = React12.useCallback(
    (nodeId) => {
  ...
  const deselectNode = React12.useCallback(() => {
    if (selectedNodeId) {
      appStateApi.deselectNode();
    }
  }, [appStateApi, selectedNodeId]);
  const handleNodeMouseUp = React12.useCallback(
    (event) => {
  ...
  const handleNodeDelete = React12.useCallback(
    (nodeId) => (event) => {
      if (event) {
        event.stopPropagation();
      }
  ...
  const interactiveNodes = React12.useMemo(() => {
    if (!selectedNode) {
  ...
  const handleNodeDragStart = React12.useCallback(
    (node) => (event) => {
      event.stopPropagation();
  ...
  const handleNodeDuplicate = React12.useCallback(
    (node) => (event) => {
      event.stopPropagation();
      domApi.update((draft) => {
  ...
  const getNodeDraggableHorizontalEdges = React12.useCallback(
    (node) => {
  ...
  const handleEdgeDragStart = React12.useCallback(
    (node) => (edge) => (event) => {
      event.stopPropagation();
      const parent = appDom5.getParent(dom, node);
  ...
  const availableDropTargets = React12.useMemo(() => {
    if (!draggedNode) {
      return [];
    }
  ...
  const availableDropTargetIds = React12.useMemo(
    () => new Set(availableDropTargets.map((n) => n.id)),
    [availableDropTargets]
  );
  const availableDropZones = React12.useMemo(() => {
  ...
  const dropAreaRects = React12.useMemo(() => {
    const rects = {};
    pageNodes.forEach((node) => {
  ...
  const getDropAreaRect = React12.useCallback(
    (nodeId, parentProp) => {
      if (parentProp) {
  ...
  const handleNodeDragOver = React12.useCallback(
    (event) => {
      event.preventDefault();
      const cursorPos = bridge?.canvasCommands.getViewCoordinates(event.clientX, event.clientY);
  ...
  const handleNodeDrop = React12.useCallback(
    (event) => {
      const cursorPos = bridge?.canvasCommands.getViewCoordinates(event.clientX, event.clientY);
      ...
      if (newNode) {
        ...
        invariant6(overlayElement, "Overlay ref not bound");
  ...
  const handleNodeDragEnd = React12.useCallback(
    (event) => {
      event.preventDefault();
      api.dragEnd();
    },
  ...
  const resizePreviewElementRef = React12.useRef(null);
  const overlayGridRef = React12.useRef({
    gridElement: null,
    getMinColumnWidth: () => 0,
    getLeftColumnEdges: () => [],
    getRightColumnEdges: () => []
  ...
  const handleEdgeDragEnd = React12.useCallback(
    (event) => {
      event.preventDefault();
      if (!draggedNode) {
        return;
  ...
  return /* @__PURE__ */ React12.createElement(
    ...
    pageNodes.map((node) => {
      ...
      return /* @__PURE__ */ React12.createElement(React12.Fragment, { key: node.id }, !isPageNode ? /* @__PURE__ */ React12.createElement(
        NodeHud,
        {
          node,
          rect: nodeRect,
    ...
    /* @__PURE__ */ React12.createElement(PinholeOverlay, { className: overlayClasses.hudOverlay, pinhole: selectedRect }),
    draggedEdge ? /* @__PURE__ */ React12.createElement(OverlayGrid, { ref: overlayGridRef }) : null
  );
}

// src/toolpad/AppEditor/PageEditor/RenderPanel/RenderPanel.tsx
var EditorCanvasHost3 = process.env.EXPERIMENTAL_INLINE_CANVAS ? EditorCanvasHost2 : EditorCanvasHost;
var classes = {
  view: "Toolpad_View"
};
var RenderPanelRoot = styled9("div")({
  position: "relative",
  overflow: "hidden",
  [`& .${classes.view}`]: {
    height: "100%"
...
function useRuntimeState() {
  const { dom } = useAppState();
  return React13.useMemo(() => createRuntimeState({ dom }), [dom]);
}
function RenderPanel({ className }) {
  ...
  const [bridge, setBridge] = React13.useState(null);
  const savedNodes = React13.useMemo(
    () => getNodeHashes(appState.savedDom),
    [appState.savedDom]
  );
  const handleInit = useEventCallback4((initializedBridge) => {
  ...
  return /* @__PURE__ */ React13.createElement(RenderPanelRoot, { className }, /* @__PURE__ */ React13.createElement(
    EditorCanvasHost3,
    {
      ...
      savedNodes,
      pageName: page.name,
      overlay: appDom6.isCodePage(page) ? null : /* @__PURE__ */ React13.createElement(RenderOverlay, { bridge }),
      onInit: handleInit
    }
  ));
}
...
import { Tab as Tab2, Box as Box9, styled as styled16, Typography as Typography9, Link as Link3 } from "@mui/material";
import * as React48 from "react";
import * as appDom16 from "@mui/toolpad-core/appDom";
...
import * as appDom12 from "@mui/toolpad-core/appDom";
...
import * as appDom7 from "@mui/toolpad-core/appDom";

// src/components/MapEntriesEditor.tsx
import { Box as Box2, TextField, IconButton as IconButton2 } from "@mui/material";
...
function MapEntriesEditor({
  ...
  const fieldInputRef = React14.useRef(null);
  const handleRemove = React14.useCallback(
    (index) => () => {
      onChange(value.filter((entry, i) => i !== index));
    },
    [onChange, value]
  );
  const isValidFieldName = React14.useMemo(() => {
    const counts = {};
    value.forEach(([field]) => {
  ...
  return /* @__PURE__ */ React14.createElement(Box2, { sx, display: "grid", gridTemplateColumns: "1fr 2fr auto", alignItems: "center", gap: 1 }, label ? /* @__PURE__ */ React14.createElement(Box2, { gridColumn: "span 3" }, label, ":") : null, value.map((entry, index) => {
    const [field, fieldValue] = entry;
    const entryDisabled = disabled || isEntryDisabled?.(entry, index);
    return /* @__PURE__ */ React14.createElement(React14.Fragment, { key: index }, /* @__PURE__ */ React14.createElement(
      TextField,
      {
      ...
      /* @__PURE__ */ React14.createElement(DeleteIcon2, null)
    ));
  }), /* @__PURE__ */ React14.createElement("form", { autoComplete: "off", style: { display: "contents" } }, /* @__PURE__ */ React14.createElement(
    TextField,
    {
...
function useUnsavedChangesConfirm({
  ...
  const handleCloseWithUnsavedChanges = React15.useCallback(() => {
...
function UrlQueryString({ input }) {
  const queryString = React16.useMemo(() => {
    const search = new URLSearchParams(input).toString();
    return search.length ? search : "";
  }, [input]);
  return /* @__PURE__ */ React16.createElement(React16.Fragment, null, /* @__PURE__ */ React16.createElement(Divider, { variant: "middle", sx: { alignSelf: "stretch", marginTop: "20px" } }), /* @__PURE__ */ React16.createElement(Typography2, { variant: "overline" }, "Usage Preview:"), /* @__PURE__ */ React16.createElement(Typography2, null, /* @__PURE__ */ React16.createElement("code", null, queryString)));
}
function UrlQueryEditor({ pageNodeId }) {
  ...
  const [input, setInput] = React16.useState(value);
  ...
  const handleButtonClick = React16.useCallback(() => {
    appStateApi.setView({
      ...currentView,
      kind: "page",
      name: page.name,
  ...
  const handleDialogClose = React16.useCallback(() => {
    appStateApi.setView({
      ...currentView,
      kind: "page",
      name: page.name,
  ...
  return /* @__PURE__ */ React16.createElement("div", null, /* @__PURE__ */ React16.createElement(Button, { color: "inherit", startIcon: /* @__PURE__ */ React16.createElement(AddIcon, null), onClick: handleButtonClick }, "Add page parameters"), /* @__PURE__ */ React16.createElement(Dialog, { fullWidth: true, open: isDialogOpen, onClose: handleCloseWithUnsavedChanges }, /* @__PURE__ */ React16.createElement(DialogTitle, null, "Edit page parameters"), /* @__PURE__ */ React16.createElement(DialogContent, null, /* @__PURE__ */ React16.createElement(Typography2, null, "Page parameters allow you to pass external data into the Toolpad page state via the URL query. Read more in the", " ", /* @__PURE__ */ React16.createElement(
    Link,
    {
    ...
    "docs"
  ), "."), /* @__PURE__ */ React16.createElement(UrlQueryString, { input }), /* @__PURE__ */ React16.createElement(
    MapEntriesEditor,
    {
      sx: { my: 3 },
  ...
  )), /* @__PURE__ */ React16.createElement(DialogActions, null, /* @__PURE__ */ React16.createElement(Button, { color: "inherit", variant: "text", onClick: handleDialogClose }, "Close"), /* @__PURE__ */ React16.createElement(Button, { disabled: value === input, onClick: handleSave }, "Save"))));
}

// src/toolpad/AppEditor/NodeNameEditor.tsx
import { TextField as TextField2 } from "@mui/material";
import * as React18 from "react";
import * as appDom9 from "@mui/toolpad-core/appDom";

// src/toolpad/AppEditor/PagesExplorer/validation.ts
import * as React17 from "react";
import * as appDom8 from "@mui/toolpad-core/appDom";
...
function NodeNameEditor({ node, sx }) {
  ...
  const { dom } = useAppState();
  const projectApi = useProjectApi();
  const [nameInput, setNameInput] = React18.useState(node.name);
  React18.useEffect(() => setNameInput(node.name), [node.name]);
  const handleNameInputChange = React18.useCallback(
    (event) => setNameInput(event.target.value),
    []
  );
  const existingNames = React18.useMemo(() => appDom9.getExistingNamesForNode(dom, node), [dom, node]);
  const nodeNameError = useNodeNameValidation(nameInput, existingNames, node.type);
  const isNameValid = !nodeNameError;
  const handleNameCommit = React18.useCallback(() => {
    if (isNameValid) {
...
import * as appDom10 from "@mui/toolpad-core/appDom";
...
function PageTitleEditor({ node }) {
  const domApi = useDomApi();
  const [pageTitleInput, setPageTitleInput] = React19.useState(appDom10.getPageTitle(node));
  const handlePageTitleChange = React19.useCallback(
  ...
  const handleKeyPress = React19.useCallback(
    (event) => {
      if (event.code === "Enter") {
        handleCommit();
      }
...
// src/toolpad/AppEditor/UpgradeAlert.tsx
...
function UpgradeAlert({
  ...
  return /* @__PURE__ */ React20.createElement(
    Alert,
    {
      severity: type ?? "error",
      sx,
      action: hideAction ? null : /* @__PURE__ */ React20.createElement(Button2, { variant: "text", LinkComponent: "a", href: UPGRADE_URL, target: "_blank" }, "Upgrade", /* @__PURE__ */ React20.createElement(OpenInNewIcon, { fontSize: "inherit", sx: { ml: 1 } }))
    },
    alert
  );
}
...
import * as appDom11 from "@mui/toolpad-core/appDom";
...
function PageDisplayNameEditor({ node }) {
  const domApi = useDomApi();
  const pageDisplayName = React21.useMemo(() => appDom11.getPageDisplayName(node), [node]);
  const [pageDisplayNameInput, setPageDisplayNameInput] = React21.useState(pageDisplayName);
  React21.useEffect(() => setPageDisplayNameInput(pageDisplayName), [pageDisplayName]);
  const handlePageDisplayNameChange = React21.useCallback(
    (event) => setPageDisplayNameInput(event.target.value),
    []
  );
  const handleCommit = React21.useCallback(() => {
    domApi.update(
      (dom) => appDom11.setNodeNamespacedProp(dom, node, "attributes", "displayName", pageDisplayNameInput)
    );
  }, [node, pageDisplayNameInput, domApi]);
  const handleReset = React21.useCallback(() => {
    domApi.update(
      (dom) => appDom11.setNodeNamespacedProp(dom, node, "attributes", "displayName", void 0)
    );
  }, [node, domApi]);
  const handleKeyPress = React21.useCallback(
    (event) => {
      if (event.code === "Enter") {
        handleCommit();
      }
  ...
  return /* @__PURE__ */ React21.createElement(
    TextField4,
    {
      ...
      InputProps: {
        endAdornment: pageDisplayNameInput === node.attributes.displayName ? /* @__PURE__ */ React21.createElement(InputAdornment, { position: "end" }, /* @__PURE__ */ React21.createElement(Tooltip2, { title: "Reset to default value" }, /* @__PURE__ */ React21.createElement(IconButton3, { onClick: handleReset, edge: "end" }, /* @__PURE__ */ React21.createElement(ResetIcon, null)))) : null
      }
    }
  );
}
...
function PageOptionsPanel() {
  ...
  const handleDisplayModeChange = React22.useCallback(
    (event, newValue) => {
      domApi.update(
  ...
  const availableRoles = React22.useMemo(() => {
    return new Map(appNode.attributes?.authorization?.roles?.map((role) => [role.name, role]));
  }, [appNode]);
  const handleAllowedRolesChange = React22.useCallback(
    (event, newValue) => {
      domApi.update(
  ...
  const handleAllowAllChange = React22.useCallback(
    (event, isAllowed) => {
      domApi.update(
        (draft) => appDom12.setNodeNamespacedProp(draft, page, "attributes", "authorization", {
          allowAll: isAllowed,
  ...
  return /* @__PURE__ */ React22.createElement(Stack, { spacing: 2, alignItems: "stretch", "data-testid": "page-editor" }, /* @__PURE__ */ React22.createElement(Typography3, { variant: "subtitle1" }, "Page:"), /* @__PURE__ */ React22.createElement("div", null, /* @__PURE__ */ React22.createElement(NodeNameEditor, { node: page }), /* @__PURE__ */ React22.createElement(PageDisplayNameEditor, { node: page }), /* @__PURE__ */ React22.createElement(PageTitleEditor, { node: page })), /* @__PURE__ */ React22.createElement("div", null, /* @__PURE__ */ React22.createElement(Typography3, { variant: "body2" }, "Display mode:"), /* @__PURE__ */ React22.createElement(
    Tooltip3,
    {
      arrow: true,
      placement: "left-start",
      title: /* @__PURE__ */ React22.createElement(Typography3, { variant: "inherit" }, "Control how the app shell is displayed in the final application. Read more in the", " ", /* @__PURE__ */ React22.createElement(
        Link2,
        {
    ...
    /* @__PURE__ */ React22.createElement(
      ...
      PAGE_DISPLAY_OPTIONS.map((option) => {
        return /* @__PURE__ */ React22.createElement(ToggleButton, { key: option.value, value: option.value }, option.label);
      })
    )
  )), /* @__PURE__ */ React22.createElement("div", null, /* @__PURE__ */ React22.createElement(Typography3, { variant: "body2" }, "Authorization:"), isPaidPlan ? /* @__PURE__ */ React22.createElement(React22.Fragment, null, /* @__PURE__ */ React22.createElement(
    FormControlLabel,
    {
      control: /* @__PURE__ */ React22.createElement(Checkbox, { checked: allowAll, onChange: handleAllowAllChange }),
    ...
    Autocomplete,
    {
      ...
      renderInput: (params) => /* @__PURE__ */ React22.createElement(TextField5, { ...params, label: "Allowed roles", placeholder: "Roles" })
    }
  )) : /* @__PURE__ */ React22.createElement(UpgradeAlert, { feature: "Role based access control", hideAction: true })), appDom12.isCodePage(page) ? null : /* @__PURE__ */ React22.createElement("div", null, /* @__PURE__ */ React22.createElement(Divider2, { variant: "middle", sx: { alignSelf: "stretch" } }), /* @__PURE__ */ React22.createElement(Typography3, { variant: "overline" }, "Page State:"), /* @__PURE__ */ React22.createElement(UrlQueryEditor, { pageNodeId })));
}

// src/toolpad/AppEditor/PageEditor/ComponentEditor.tsx
import { Stack as Stack4, styled as styled13, Typography as Typography7, Divider as Divider4 } from "@mui/material";
import * as React44 from "react";
import { groupBy } from "lodash-es";

// src/toolpad/AppEditor/PageEditor/NodeAttributeEditor.tsx
import * as React42 from "react";
import { Alert as Alert2, Box as Box6 } from "@mui/material";
import { useBrowserJsRuntime } from "@mui/toolpad-core/jsBrowserRuntime";
import * as appDom14 from "@mui/toolpad-core/appDom";
...
import { createProvidedContext as createProvidedContext2 } from "@mui/toolpad-utils/react";
...
import { Tooltip as Tooltip4, Link as MuiLink } from "@mui/material";
import Markdown from "markdown-to-jsx";
import * as React23 from "react";
function MarkdownTooltip({ title, children, ...props }) {
  const renderedTitle = React23.useMemo(
    () => title ? /* @__PURE__ */ React23.createElement(
      Markdown,
      {
        options: {
          overrides: {
  ...
  return /* @__PURE__ */ React23.createElement(Tooltip4, { title: renderedTitle, ...props }, children);
}

// src/components/PropertyControl.tsx
function PropertyControl({ propType, children }) {
  return /* @__PURE__ */ React24.createElement(MarkdownTooltip, { placement: "left", title: propType.helperText ?? "" }, children);
}
...
function BooleanPropEditor({ propType, label, value, onChange, disabled }) {
  ...
  return /* @__PURE__ */ React26.createElement(PropertyControl, { propType }, /* @__PURE__ */ React26.createElement(
    FormControlLabel2,
    {
      control: /* @__PURE__ */ React26.createElement(Checkbox2, { checked: !!value, disabled, onChange: handleChange }),
      label
    }
  ));
}
...
function NumberPropEditor({ label, value, onChange, disabled, propType }) {
  ...
  return /* @__PURE__ */ React27.createElement(PropertyControl, { propType }, /* @__PURE__ */ React27.createElement(
    TextField7,
    {
      fullWidth: true,
...
function SelectPropEditor({ label, propType, value, onChange, disabled }) {
  ...
  return /* @__PURE__ */ React28.createElement(PropertyControl, { propType }, /* @__PURE__ */ React28.createElement(
    TextField8,
    {
      select: true,
      fullWidth: true,
    ...
    typeof propType.default === "undefined" ? /* @__PURE__ */ React28.createElement(MenuItem, { value: "" }, "-") : null,
    items.map((item) => /* @__PURE__ */ React28.createElement(MenuItem, { key: item, value: item }, enumLabels[item] || item))
  ));
}
...
function useIsSsr(defer = false) {
  const isSsrInitialValue = React29.useSyncExternalStore(subscribe, getSnapshot, getServerSnapshot);
  const [isSsr, setIsSsr] = React29.useState(defer ? true : isSsrInitialValue);
  React29.useEffect(() => setIsSsr(false), []);
  return isSsr;
}
function NoSsr({ children, defer, fallback = null }) {
  const isSsr = useIsSsr(defer);
  return /* @__PURE__ */ React29.createElement(React29.Fragment, null, isSsr ? fallback : children);
}

// src/utils/lazyComponent.tsx
function lazyComponent(importComponent, { noSsr, fallback } = {}) {
  const LazyComponent = React30.lazy(importComponent);
  return React30.forwardRef((props, ref) => {
    let content = /* @__PURE__ */ React30.createElement(LazyComponent, { ref, ...props });
    if (noSsr) {
      content = /* @__PURE__ */ React30.createElement(NoSsr, null, content);
    }
    if (fallback) {
      content = /* @__PURE__ */ React30.createElement(React30.Suspense, { fallback }, content);
    }
    return content;
  });
}
...
// src/toolpad/propertyControls/json.tsx
var JsonEditor = lazyComponent(() => import("./JsonEditor-VRX6C4C6.mjs"), {
  noSsr: true,
  fallback: /* @__PURE__ */ React31.createElement(Skeleton, { variant: "rectangular", height: "100%" })
});
function JsonPropEditor({ label, propType, value, onChange, disabled }) {
  const [dialogOpen, setDialogOpen] = React31.useState(false);
  const valueAsString = React31.useMemo(() => JSON.stringify(value, null, 2), [value]);
  const [input, setInput] = React31.useState(valueAsString);
  React31.useEffect(() => setInput(valueAsString), [valueAsString]);
  const normalizedInitial = React31.useMemo(() => JSON.stringify(value), [value]);
  const normalizedInput = React31.useMemo(() => {
    if (!input) {
      return "";
    }
    try {
  ...
  const handleSave = React31.useCallback(() => {
    const newValue = input === "" ? void 0 : JSON5.parse(input);
    onChange(newValue);
  }, [onChange, input]);
  const [schemaUri, setSchemaUri] = React31.useState(void 0);
  React31.useEffect(() => {
  ...
  return /* @__PURE__ */ React31.createElement(React31.Fragment, null, /* @__PURE__ */ React31.createElement(PropertyControl, { propType }, /* @__PURE__ */ React31.createElement(
    Button3,
    {
      variant: "outlined",
      color: "inherit",
    ...
    label
  )), /* @__PURE__ */ React31.createElement(Dialog2, { fullWidth: true, open: dialogOpen, onClose: () => setDialogOpen(false) }, /* @__PURE__ */ React31.createElement(DialogTitle2, null, "Edit JSON"), /* @__PURE__ */ React31.createElement(DialogContent2, null, /* @__PURE__ */ React31.createElement(Box3, { sx: { height: 200 } }, /* @__PURE__ */ React31.createElement(
    JsonEditor,
    {
      value: input,
  ...
  ))), /* @__PURE__ */ React31.createElement(DialogActions2, null, /* @__PURE__ */ React31.createElement(Button3, { color: "inherit", variant: "text", onClick: () => setDialogOpen(false) }, "Cancel"), /* @__PURE__ */ React31.createElement(
    Button3,
    {
...
function Editor({ propType, label }) {
  return /* @__PURE__ */ React32.createElement(PropertyControl, { propType }, /* @__PURE__ */ React32.createElement(Typography4, null, label));
}
...
import { createProvidedContext as createProvidedContext3 } from "@mui/toolpad-utils/react";
...
import * as appDom13 from "@mui/toolpad-core/appDom";
...
var ElementContext_default = React33.createContext(void 0);

// src/toolpad/AppEditor/PageEditor/JsExpressionEditor.tsx
var TypescriptEditor = lazyComponent(() => import("./TypescriptEditor-KQD2VUGY.mjs"), {
  noSsr: true,
  fallback: /* @__PURE__ */ React34.createElement(Skeleton2, { variant: "rectangular", height: "100%" })
});
...
function JsExpressionEditor({
  ...
  const element = React34.useContext(ElementContext_default);
  const nodeName = element?.name;
  const extraLibs = React34.useMemo(() => {
  ...
  return /* @__PURE__ */ React34.createElement(JsExpressionEditorRoot, { sx }, /* @__PURE__ */ React34.createElement(
    TypescriptEditor,
    {
      value,
...
import { styled as styled11, IconButton as IconButton4, Tooltip as Tooltip5, Snackbar } from "@mui/material";
...
var ObjectInspector_default = function ObjectInspector(props) {
  ...
  return /* @__PURE__ */ React35.createElement(ReactObjectInspector, { theme: inspectorTheme, ...props });
};
...
function JsonView({ src, sx, copyToClipboard, disabled, ...props }) {
  ...
  const [confirmSnackbarOpen, setConfirmSnackbarOpen] = React36.useState(false);
  const handleCopyToClipboard = React36.useCallback(() => {
    window.navigator.clipboard.writeText(JSON.stringify(src, null, 2));
    setConfirmSnackbarOpen(true);
  }, [src]);
  const handleCopySnackbarClose = React36.useCallback(() => setConfirmSnackbarOpen(false), []);
  return /* @__PURE__ */ React36.createElement(JsonViewRoot, { sx, className: clsx3({ [classes2.disabled]: disabled }) }, /* @__PURE__ */ React36.createElement(React36.Fragment, null, /* @__PURE__ */ React36.createElement("div", { className: classes2.viewport }, /* @__PURE__ */ React36.createElement(ObjectInspector_default, { expandLevel: 1, expandPaths, data: src, ...props })), copyToClipboard ? /* @__PURE__ */ React36.createElement(React36.Fragment, null, /* @__PURE__ */ React36.createElement(Tooltip5, { title: "Copy the source" }, /* @__PURE__ */ React36.createElement(IconButton4, { onClick: handleCopyToClipboard, className: classes2.copyToClipboardButton }, /* @__PURE__ */ React36.createElement(ContentCopyIcon, null))), /* @__PURE__ */ React36.createElement(
    Snackbar,
    {
...
import { mapValues as mapValues2 } from "@mui/toolpad-utils/collections";
...
import { Typography as Typography5, Divider as Divider3, Box as Box4 } from "@mui/material";
...
function GlobalScopeExplorer({ meta, value, sx }) {
  const structure = React38.useMemo(() => groupScopeMeta(value, meta), [meta, value]);
  return /* @__PURE__ */ React38.createElement(Box4, { sx: { ...sx, display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React38.createElement(Typography5, { sx: { ml: 1, mb: 1 }, variant: "subtitle2" }, "Scope"), /* @__PURE__ */ React38.createElement(Box4, { sx: { overflow: "auto", border: 1, borderColor: "divider" } }, /* @__PURE__ */ React38.createElement(Box4, { sx: { display: "flex", flexDirection: "column", justifyContent: "stretch" } }, Object.entries(structure).map(([key, group]) => {
    if (group.items.length <= 0) {
      return null;
    }
    return /* @__PURE__ */ React38.createElement(React38.Fragment, { key }, /* @__PURE__ */ React38.createElement(Typography5, { sx: { mx: 1, my: 0.5 } }, group.displayName), /* @__PURE__ */ React38.createElement(Divider3, null), /* @__PURE__ */ React38.createElement(Box4, { sx: { m: 1 } }, group.items.map((item) => {
      return /* @__PURE__ */ React38.createElement(React38.Fragment, { key: item.key }, /* @__PURE__ */ React38.createElement(ObjectInspector_default, { expandLevel: 0, name: item.key, data: item.value }));
    })), /* @__PURE__ */ React38.createElement(Divider3, null));
  }))));
}
...
var TabPanel = React39.forwardRef(
  ({ disableGutters, sx, ...props }, ref) => /* @__PURE__ */ React39.createElement(MuiTabPanel, { ref, sx: disableGutters ? { padding: 0, ...sx } : sx, ...props })
);
var TabPanel_default = TabPanel;

// src/toolpad/AppEditor/BindingEditor.tsx
var [useBindingEditorContext, BindingEditorContextProvider] = createProvidedContext3("BindingEditor");
var ErrorTooltip = styled12(({ className, ...props }) => /* @__PURE__ */ React40.createElement(Tooltip6, { ...props, classes: { popper: className } }))(({ theme }) => ({
...
function JsExpressionPreview({ jsRuntime, input, globalScope }) {
  ...
  return /* @__PURE__ */ React40.createElement(React40.Fragment, null, /* @__PURE__ */ React40.createElement(Toolbar, { disableGutters: true }, /* @__PURE__ */ React40.createElement(Typography6, { color: "error" }, previewError?.message)), /* @__PURE__ */ React40.createElement(JsonView, { sx: { flex: 1 }, src: lastGoodPreview?.value }));
}
function EnvBindingEditor({ value, onChange }) {
  const context = useBindingEditorContext();
  const envVarNames = Object.keys(context.env ?? {});
  const handleInputChange = React40.useCallback(
    (event, newValue) => {
      onChange({
        $$env: newValue || ""
      });
  ...
  return /* @__PURE__ */ React40.createElement(Box5, { sx: { my: 1 } }, /* @__PURE__ */ React40.createElement(Typography6, null, "Assign to an environment variable"), /* @__PURE__ */ React40.createElement(
    Autocomplete2,
    {
      freeSolo: true,
      options: envVarNames,
      ...
      renderInput: (params) => /* @__PURE__ */ React40.createElement(
        TextField9,
        {
          ...
          helperText: value?.$$env && !envVarNames.includes(value.$$env) ? "Warning: This variable is not in your env file!" : ""
        }
      )
    }
  ));
...
function ValueBindingEditor({ value, onChange, error }) {
  ...
  const [activeTab, setActiveTab] = React40.useState(getValueBindingTab(value));
  React40.useEffect(() => {
  ...
  const jsExpressionBindingEditor = /* @__PURE__ */ React40.createElement(Stack2, { direction: "row", sx: { height: 400, gap: 2, my: hasEnv ? 3 : 0 } }, /* @__PURE__ */ React40.createElement(GlobalScopeExplorer, { sx: { width: 250 }, value: globalScope, meta: globalScopeMeta }), /* @__PURE__ */ React40.createElement(
    Box5,
    {
      sx: {
        height: "100%",
    ...
    /* @__PURE__ */ React40.createElement(Typography6, { sx: { mb: 2 } }, 'Make the "', label, '" property dynamic with a JavaScript expression. This property expects a type: ', /* @__PURE__ */ React40.createElement("code", null, propType?.type || "any"), "."),
    ...
    error ? /* @__PURE__ */ React40.createElement(
      ...
      /* @__PURE__ */ React40.createElement(Typography6, { sx: { mb: 2, color: "red" } }, "Error while reading the prettier configuration:", errorFrom(error).message ?? "The prettier config could not be loaded and therefore the code would not be formatted")
    ) : null,
    /* @__PURE__ */ React40.createElement(JsExpressionPreview, { jsRuntime, input: value, globalScope })
  ));
  const envBindingEditor = /* @__PURE__ */ React40.createElement(
    EnvBindingEditor,
    {
      value: value?.$$env ? value : null,
      onChange
    }
  );
  if (!hasEnv) {
  ...
  return /* @__PURE__ */ React40.createElement(TabContext, { value: activeTab }, /* @__PURE__ */ React40.createElement(Box5, { sx: { borderBottom: 1, borderColor: "divider" } }, /* @__PURE__ */ React40.createElement(TabList, { onChange: handleTabChange, "aria-label": "Choose action kind " }, /* @__PURE__ */ React40.createElement(Tab, { label: "JS expression", value: "jsExpression" }), /* @__PURE__ */ React40.createElement(Tab, { label: "Environment variable", value: "env" }))), /* @__PURE__ */ React40.createElement(TabPanel_default, { value: "jsExpression", disableGutters: true }, /* @__PURE__ */ React40.createElement(Box5, { sx: { my: 1 } }, /* @__PURE__ */ React40.createElement(Typography6, null, "Bind to a JavaScript expression."), jsExpressionBindingEditor)), /* @__PURE__ */ React40.createElement(TabPanel_default, { value: "env", disableGutters: true }, envBindingEditor));
}
function JsExpressionActionEditor({ value, onChange }) {
  const { globalScope, globalScopeMeta } = useBindingEditorContext();
  const handleCodeChange = React40.useCallback(
    (newValue) => onChange({ $$jsExpressionAction: newValue }),
    [onChange]
  );
  return /* @__PURE__ */ React40.createElement(Box5, { sx: { my: 1 } }, /* @__PURE__ */ React40.createElement(Typography6, null, "Run code when this event fires"), /* @__PURE__ */ React40.createElement(
    Box5,
    {
      sx: {
        my: 3,
    ...
    /* @__PURE__ */ React40.createElement(GlobalScopeExplorer, { sx: { width: 250 }, value: globalScope, meta: globalScopeMeta }),
    /* @__PURE__ */ React40.createElement(
      JsExpressionEditor,
      {
        sx: { flex: 1 },
...
function NavigationActionEditor({ value, onChange }) {
  ...
  const actionParameters = React40.useMemo(
  ...
  const handleActionParameterChange = React40.useCallback(
  ...
  return /* @__PURE__ */ React40.createElement(Box5, { sx: { my: 1 } }, /* @__PURE__ */ React40.createElement(Typography6, null, "Navigate to a page on this event"), /* @__PURE__ */ React40.createElement(
    TextField9,
    {
      fullWidth: true,
      sx: { my: 3 },
    ...
    pages.map((page) => /* @__PURE__ */ React40.createElement(MenuItem2, { key: page.name, value: page.name }, page.name))
  ), actionParameterEntries.length > 0 ? /* @__PURE__ */ React40.createElement(React40.Fragment, null, /* @__PURE__ */ React40.createElement(Typography6, { variant: "overline" }, "Page parameters:"), Object.entries(actionParameters || defaultActionParameters).map((actionParameter) => {
...
function ActionEditor({ value, onChange }) {
  const [activeTab, setActiveTab] = React40.useState(getActionTab(value));
  React40.useEffect(() => setActiveTab(getActionTab(value)), [value]);
  const handleTabChange = (event, newValue) => {
    setActiveTab(newValue);
  };
  return /* @__PURE__ */ React40.createElement(TabContext, { value: activeTab }, /* @__PURE__ */ React40.createElement(Box5, { sx: { borderBottom: 1, borderColor: "divider" } }, /* @__PURE__ */ React40.createElement(TabList, { onChange: handleTabChange, "aria-label": "Choose action kind " }, /* @__PURE__ */ React40.createElement(Tab, { label: "JS expression", value: "jsExpressionAction" }), /* @__PURE__ */ React40.createElement(Tab, { label: "Navigation", value: "navigationAction" }))), /* @__PURE__ */ React40.createElement(TabPanel_default, { value: "jsExpressionAction", disableGutters: true }, /* @__PURE__ */ React40.createElement(
    JsExpressionActionEditor,
    {
      value: value?.$$jsExpressionAction ? value : null,
      onChange
    }
  )), /* @__PURE__ */ React40.createElement(TabPanel_default, { value: "navigationAction", disableGutters: true }, /* @__PURE__ */ React40.createElement(
...
function BindingEditorDialog({
  ...
  const [input, setInput] = React40.useState(value);
  React40.useEffect(() => {
    setInput(value);
  }, [open, value]);
  const committedInput = React40.useRef(input);
  const handleSave = React40.useCallback(async () => {
    let newValue = input;
  ...
  const handleCommit = React40.useCallback(() => {
    handleSave();
    onClose();
  }, [onClose, handleSave]);
  const handleRemove = React40.useCallback(() => {
  ...
  return /* @__PURE__ */ React40.createElement(
    ...
    /* @__PURE__ */ React40.createElement(DialogTitle3, null, 'Bind property "', label, '"'),
    /* @__PURE__ */ React40.createElement(
      DialogContent3,
      {
        sx: {
      ...
      propType?.type === "event" ? /* @__PURE__ */ React40.createElement(ActionEditor, { value: input, onChange: (newValue) => setInput(newValue) }) : /* @__PURE__ */ React40.createElement(
        ValueBindingEditor,
        {
          error,
          value: input?.$$jsExpression || input?.$$env ? input : null,
          onChange: (newValue) => setInput(newValue)
        }
      )
    ),
    /* @__PURE__ */ React40.createElement(DialogActions3, null, /* @__PURE__ */ React40.createElement(Button4, { color: "inherit", variant: "text", onClick: onClose }, hasUnsavedChanges ? "Cancel" : "Close"), /* @__PURE__ */ React40.createElement(Button4, { color: "inherit", disabled: !value, onClick: handleRemove }, "Remove binding"), /* @__PURE__ */ React40.createElement(Button4, { disabled: !hasUnsavedChanges, color: "primary", onClick: handleCommit }, "Update binding"))
  );
}
function BindingEditor({
  ...
  const handleOpen = React40.useCallback(() => setOpen(true), []);
  const handleClose = React40.useCallback(() => setOpen(false), []);
  const hasBinding = !!value && getBindingType(value) !== "const";
  const error = liveBinding?.error?.message;
  const bindingButton = /* @__PURE__ */ React40.createElement(
    Checkbox3,
    {
      "aria-label": `Bind property "${label}"`,
      checked: hasBinding,
      disabled,
      icon: /* @__PURE__ */ React40.createElement(AddLinkIcon, { fontSize: "inherit" }),
      checkedIcon: /* @__PURE__ */ React40.createElement(LinkIcon, { fontSize: "inherit" }),
      onClick: handleOpen,
      color: error ? "error" : void 0,
      sx: { visibility: hidden ? "hidden" : "visible" }
    }
  );
  const TooltipComponent = error ? ErrorTooltip : Tooltip6;
  const tooltipTitle = error ?? (hasBinding ? `Update "${label}" binding\u2026` : `Bind "${label}"\u2026`);
  const bindingButtonWithTooltip = disabled ? bindingButton : /* @__PURE__ */ React40.createElement(TooltipComponent, { disableInteractive: true, placement: "top", title: tooltipTitle }, bindingButton);
  const resolvedMeta = React40.useMemo(() => {
  ...
  const bindingEditorContext = React40.useMemo(
    () => ({
      label,
      globalScope,
  ...
  return /* @__PURE__ */ React40.createElement(BindingEditorContextProvider, { value: bindingEditorContext }, bindingButtonWithTooltip, /* @__PURE__ */ React40.createElement(BindingEditorDialog, { open, onClose: handleClose, value, onChange }));
}
...
function BindableEditor({
  ...
  const renderDefaultControl = React41.useCallback(
    (params) => {
      const Control = getDefaultControl(propTypeControls, params.propType);
      return Control ? /* @__PURE__ */ React41.createElement(Control, { ...params }) : null;
    },
    [propTypeControls]
  );
  const renderControl = renderControlProp || renderDefaultControl;
  const handlePropConstChange = React41.useCallback((newValue) => onChange(newValue), [onChange]);
  const valueBindingType = value && getBindingType(value);
  const initConstValue = React41.useCallback(() => {
  ...
  const constValue = React41.useMemo(initConstValue, [value, initConstValue]);
  ...
  return /* @__PURE__ */ React41.createElement(
    ...
    /* @__PURE__ */ React41.createElement(React41.Fragment, null, renderControl({
      label,
      propType,
...
function NodeAttributeEditor({
  ...
  const domApi = useDomApi();
  const handlePropChange = React42.useCallback(
    (newValue) => {
      domApi.update(
  ...
  const propValue = node[namespace]?.[name] ?? null;
  ...
  const scopeMeta = React42.useMemo(() => buildScopeMeta(vm, bindingScope), [vm, bindingScope]);
  const propTypeControls = usePropControlsContext();
  ...
  return Control ? /* @__PURE__ */ React42.createElement(
    BindableEditor,
    {
      liveBinding,
      ...
      renderControl: (params) => /* @__PURE__ */ React42.createElement(Box6, { sx: { flex: 1, maxWidth: "100%" } }, /* @__PURE__ */ React42.createElement(Control, { nodeId: node.id, ...params, propType: argType })),
      value: propValue,
      onChange: handlePropChange,
      sx
    }
  ) : /* @__PURE__ */ React42.createElement(Alert2, { severity: "warning" }, `No control for '${name}' (type '${argType.type}' ${argType.control ? `, control: '${argType.control.type}'` : ""})`);
}
...
function useToolpadComponent(id) {
  ...
  return React43.useMemo(() => components[id] || null, [components, id]);
}
...
var ComponentEditorRoot = styled13("div")(({ theme }) => ({
  [`& .${classes3.control}`]: {
...
function ComponentPropsEditor({
  ...
  return /* @__PURE__ */ React44.createElement(React44.Fragment, null, hasLayoutControls ? /* @__PURE__ */ React44.createElement(React44.Fragment, null, /* @__PURE__ */ React44.createElement(Typography7, { variant: "overline", className: classes3.sectionHeading }, "Layout:"), /* @__PURE__ */ React44.createElement("div", { className: classes3.control }, /* @__PURE__ */ React44.createElement(Typography7, { variant: "body2" }, "Alignment:"), /* @__PURE__ */ React44.createElement(Stack4, { direction: "row" }, hasLayoutHorizontalControls ? /* @__PURE__ */ React44.createElement(
    NodeAttributeEditor,
    {
      node,
      namespace: "layout",
  ...
  ) : null, hasLayoutVerticalControls ? /* @__PURE__ */ React44.createElement(
    NodeAttributeEditor,
    {
      node,
      namespace: "layout",
  ...
  ) : null)), /* @__PURE__ */ React44.createElement(Divider4, { sx: { mt: 1 } })) : null, Object.entries(argTypesByCategory).map(([category, argTypeEntries]) => /* @__PURE__ */ React44.createElement(React44.Fragment, { key: category }, /* @__PURE__ */ React44.createElement(Typography7, { variant: "overline", className: classes3.sectionHeading }, category, ":"), argTypeEntries.map(
    ([propName, propTypeDef]) => propTypeDef && shouldRenderControl(propTypeDef, propName, props) ? /* @__PURE__ */ React44.createElement("div", { key: propName, className: classes3.control }, /* @__PURE__ */ React44.createElement(
      NodeAttributeEditor,
      {
        node,
        namespace: "props",
...
function SelectedNodeEditor({ node }) {
  ...
  return /* @__PURE__ */ React44.createElement(ElementContext_default.Provider, { value: node }, /* @__PURE__ */ React44.createElement(Stack4, { direction: "column", gap: 0 }, /* @__PURE__ */ React44.createElement(MarkdownTooltip, { placement: "left", title: componentConfig.helperText ?? displayName }, /* @__PURE__ */ React44.createElement(Typography7, { variant: "body1" }, node.name)), /* @__PURE__ */ React44.createElement(Divider4, { sx: { mt: 1 } }), node ? /* @__PURE__ */ React44.createElement(ComponentPropsEditor, { bindings, componentConfig, node }) : null));
}
function ComponentEditor({ node, className }) {
  return /* @__PURE__ */ React44.createElement(ComponentEditorRoot, { className, "data-testid": "component-editor" }, /* @__PURE__ */ React44.createElement(SelectedNodeEditor, { key: node.id, node }));
}

// src/toolpad/AppEditor/PageEditor/ThemeEditor.tsx
import * as React47 from "react";
import * as appDom15 from "@mui/toolpad-core/appDom";
...
var TooltipRadio = React45.forwardRef(
...
function ColorTool({ sx, label, value, onChange }) {
  ...
  const handleChangeShade = (event, shade) => {
    invariant7(!Array.isArray(shade), "Material-UI: `shade` must not be an array.");
  ...
  return /* @__PURE__ */ React45.createElement(Box7, { sx }, /* @__PURE__ */ React45.createElement(Typography8, { component: "label", gutterBottom: true, htmlFor: id, variant: "h6" }, label), /* @__PURE__ */ React45.createElement(
    Input,
    {
      id,
      value: intentInput,
  ...
  ), /* @__PURE__ */ React45.createElement(Box7, { sx: { display: "flex", alignItems: "center", mt: 2, mb: 2 } }, /* @__PURE__ */ React45.createElement(Typography8, { id: `${id}ShadeSliderLabel` }, "Shade:"), /* @__PURE__ */ React45.createElement(
    Slider,
    {
  ...
  ), /* @__PURE__ */ React45.createElement(Typography8, null, shades[intentShade])), /* @__PURE__ */ React45.createElement(Box7, { sx: { width: 192, margin: "auto" } }, hues.map((hue) => {
    const shade = shades[state.shade];
    const backgroundColor = colors[hue][shade];
    return /* @__PURE__ */ React45.createElement(Tooltip7, { placement: "right", title: hue, key: hue, disableInteractive: true }, /* @__PURE__ */ React45.createElement(
      TooltipRadio,
      {
        sx: { p: 0 },
        color: "default",
        ...
        value: hue,
        name: label,
        icon: /* @__PURE__ */ React45.createElement(Box7, { sx: { width: 48, height: 48 }, style: { backgroundColor } }),
        checkedIcon: /* @__PURE__ */ React45.createElement(
          Box7,
          {
            sx: {
              width: 48,
          ...
          /* @__PURE__ */ React45.createElement(CheckIcon, { style: { fontSize: 30 } })
        )
      }
    ));
  })), /* @__PURE__ */ React45.createElement(Stack5, { direction: "row", sx: { mt: 2, justifyContent: "center" } }, ["dark", "main", "light"].map((key) => /* @__PURE__ */ React45.createElement(
    Box7,
    {
      sx: {
        width: 64,
...
import { styled as styled14 } from "@mui/material";
var FlexFill = styled14("div")({ flex: 1 });
var FlexFill_default = FlexFill;

// src/components/MuiThemeEditor.tsx
var IconToggleButton = styled15(ToggleButton2)({
  display: "flex",
  justifyContent: "center",
  width: "100%",
  "& > *": {
...
function PaletteColorPicker({ label, value, onChange }) {
  ...
  const [anchorEl, setAnchorEl] = React46.useState(null);
  ...
  return /* @__PURE__ */ React46.createElement(React46.Fragment, null, /* @__PURE__ */ React46.createElement(Button5, { "aria-describedby": id, variant: "outlined", onClick: handleClick }, label, /* @__PURE__ */ React46.createElement(FlexFill_default, null), /* @__PURE__ */ React46.createElement(
    Box8,
    {
      sx: {
        ml: 2,
    ...
    /* @__PURE__ */ React46.createElement(ColorTool_default, { sx: { m: 2 }, label, value, onChange })
  ));
}
function MuiThemeEditor({ value, onChange }) {
  const theme = useTheme3();
  const defaultTheme = React46.useMemo(
    () => createTheme({ palette: { mode: value?.palette?.mode } }),
    [value?.palette?.mode]
  );
  const colorPicker = (intent) => /* @__PURE__ */ React46.createElement(
    PaletteColorPicker,
    {
  ...
  return /* @__PURE__ */ React46.createElement(Stack6, { direction: "column", spacing: 2 }, /* @__PURE__ */ React46.createElement(
    ToggleButtonGroup2,
    {
      exclusive: true,
    ...
    /* @__PURE__ */ React46.createElement(IconToggleButton, { value: "light", "aria-label": "light" }, /* @__PURE__ */ React46.createElement(LightModeIcon, null), "Light"),
    /* @__PURE__ */ React46.createElement(IconToggleButton, { value: "dark", "aria-label": "dark" }, /* @__PURE__ */ React46.createElement(DarkModeIcon, null), "Dark")
...
function ComponentEditor2({ className }) {
  ...
  return /* @__PURE__ */ React47.createElement("div", { className, "data-testid": "theme-editor" }, /* @__PURE__ */ React47.createElement(
    MuiThemeEditor,
    {
      value: theme?.theme || {},
      onChange: (newTheme) => {
...
var ComponentPanelRoot = styled16("div")(({ theme }) => ({
  display: "flex",
  flexDirection: "column",
  height: "100%",
  [`& .${classes4.panel}`]: {
...
function ComponentPanel({ className }) {
  ...
  return /* @__PURE__ */ React48.createElement(ComponentPanelRoot, { className }, /* @__PURE__ */ React48.createElement(TabContext2, { value: currentTab || "page" }, /* @__PURE__ */ React48.createElement(Box9, { sx: { borderBottom: 1, borderColor: "divider" } }, /* @__PURE__ */ React48.createElement(TabList2, { onChange: handleChange, "aria-label": "Component options" }, /* @__PURE__ */ React48.createElement(Tab2, { label: "Page", value: "page" }), /* @__PURE__ */ React48.createElement(Tab2, { label: "Component", value: "component", disabled: !selectedNode }), /* @__PURE__ */ React48.createElement(Tab2, { label: "Theme", value: "theme" }))), /* @__PURE__ */ React48.createElement(TabPanel2, { value: "page", className: classes4.panel }, /* @__PURE__ */ React48.createElement(PageOptionsPanel, null)), /* @__PURE__ */ React48.createElement(TabPanel2, { value: "component", className: classes4.panel }, selectedNode && appDom16.isElement(selectedNode) ? /* @__PURE__ */ React48.createElement(ComponentEditor, { node: selectedNode }) : /* @__PURE__ */ React48.createElement(Typography9, { variant: "body1" }, "No component selected.")), /* @__PURE__ */ React48.createElement(TabPanel2, { value: "theme", className: classes4.panel }, /* @__PURE__ */ React48.createElement(Typography9, { className: classes4.themesDocsLink, variant: "body2" }, "Customize the app with a Material UI theme. Read more about theming in the", " ", /* @__PURE__ */ React48.createElement(Link3, { href: "https://mui.com/toolpad/concepts/theming/", target: "_blank", rel: "noopener" }, "docs"), "."), /* @__PURE__ */ React48.createElement(ComponentEditor2, null))));
}
...
import * as appDom18 from "@mui/toolpad-core/appDom";

// src/toolpad/AppEditor/PageEditor/ComponentCatalog/ComponentCatalogItem.tsx
import * as React49 from "react";
import { ButtonBase, Box as Box10 } from "@mui/material";
...
function ComponentIcon({ id: componentId, kind, sx }) {
  ...
  return Icon ? /* @__PURE__ */ React49.createElement(Icon, { sx: { fontSize: 24, opacity: kind === "future" ? 0.75 : 1, ...sx } }) : null;
}
function ComponentCatalogItem({
  ...
  return /* @__PURE__ */ React49.createElement(
    ...
    /* @__PURE__ */ React49.createElement(ComponentIcon, { id, kind }),
...
import useLatest2 from "@mui/toolpad-utils/hooks/useLatest";
import * as appDom17 from "@mui/toolpad-core/appDom";

// src/components/DialogForm.tsx
import * as React50 from "react";
import { styled as styled17 } from "@mui/material";
var StyledDialogForm = styled17("form")({
  overflowY: "auto",
  display: "flex",
  flexDirection: "column"
});
function DialogForm({ children, onKeyDown = () => {
  ...
  return /* @__PURE__ */ React50.createElement(StyledDialogForm, { onKeyDown: handleKeyDown, ...rest }, children);
}
...
function MissingEditorDialog({ open, onClose }) {
  const handleMissingEditorDialogClose = React51.useCallback(() => {
    onClose(false);
  }, [onClose]);
  const id = React51.useId();
  return /* @__PURE__ */ React51.createElement(
    ...
    /* @__PURE__ */ React51.createElement(DialogTitle4, { id: `${id}-title` }, "Editor not found"),
    /* @__PURE__ */ React51.createElement(DialogContent4, null, /* @__PURE__ */ React51.createElement(DialogContentText, { id: "alert-dialog-description" }, 'No editor was detected on your system. If you use Visual Studio Code, this may be due to a missing "code" command in your PATH. Otherwise you can set the', " ", /* @__PURE__ */ React51.createElement("code", null, "$EDITOR"), " environment variable. ", /* @__PURE__ */ React51.createElement("br", null), "Check the", " ", /* @__PURE__ */ React51.createElement(
      Link4,
      {
    ...
    /* @__PURE__ */ React51.createElement(DialogActions4, null, /* @__PURE__ */ React51.createElement(Button6, { onClick: handleMissingEditorDialogClose }, "Dismiss"))
  );
}
function OpenCodeEditorButton({
  ...
  const [missingEditorDialog, setMissingEditorDialog] = React51.useState(false);
  ...
  return /* @__PURE__ */ React51.createElement(React51.Fragment, null, iconButton ? /* @__PURE__ */ React51.createElement(Tooltip8, { title: "Open in code editor" }, /* @__PURE__ */ React51.createElement(IconButton5, { disabled: disabled || busy, size: "small", onClick: handleClick, ...rest }, busy ? /* @__PURE__ */ React51.createElement(CircularProgress2, { color: "inherit", size: 16 }) : /* @__PURE__ */ React51.createElement(CodeIcon, { fontSize: "inherit", color: "primary" }))) : /* @__PURE__ */ React51.createElement(
    LoadingButton,
    {
      disabled: disabled || busy,
      onClick: handleClick,
      loading: busy,
      startIcon: rest.variant === "outlined" ? /* @__PURE__ */ React51.createElement(CodeIcon, { fontSize: "inherit", color: "primary" }) : null,
      ...rest
    },
    actionText
  ), /* @__PURE__ */ React51.createElement(MissingEditorDialog, { open: missingEditorDialog, onClose: setMissingEditorDialog }));
}
...
function CreateCodeComponentDialog({
  ...
  const existingNames = React52.useMemo(
    () => new Set(
      Object.values(codeComponents).map((component) => component?.displayName).filter(Boolean)
    ),
    [codeComponents]
  );
  const [name, setName] = React52.useState(appDom17.proposeName(DEFAULT_NAME, existingNames));
  ...
  const [snackbarState, setSnackbarState] = React52.useState(null);
  const lastSnackbarState = useLatest2(snackbarState);
  const handleSnackbarClose = React52.useCallback(() => {
    setSnackbarState(null);
  }, []);
  return /* @__PURE__ */ React52.createElement(React52.Fragment, null, /* @__PURE__ */ React52.createElement(Dialog5, { open, onClose, ...props }, /* @__PURE__ */ React52.createElement(
    DialogForm,
    {
      autoComplete: "off",
      onSubmit: async (event) => {
        event.preventDefault();
        invariant8(isFormValid, "Invalid form should not be submitted when submit is disabled");
        await projectApi.methods.createComponent(name);
        onClose();
        setSnackbarState({ name });
      }
    },
    /* @__PURE__ */ React52.createElement(DialogTitle5, null, "Create a new Code Component"),
    /* @__PURE__ */ React52.createElement(DialogContent5, null, /* @__PURE__ */ React52.createElement(
      TextField10,
      {
        sx: { my: 1 },
        required: true,
    ...
    /* @__PURE__ */ React52.createElement(DialogActions5, null, /* @__PURE__ */ React52.createElement(Button7, { color: "inherit", variant: "text", onClick: onClose }, "Cancel"), /* @__PURE__ */ React52.createElement(Button7, { type: "submit", disabled: !isFormValid }, "Create"))
  )), lastSnackbarState ? /* @__PURE__ */ React52.createElement(Portal, null, /* @__PURE__ */ React52.createElement(
    Snackbar2,
    {
      open: !!snackbarState,
      ...
      action: /* @__PURE__ */ React52.createElement(React52.Fragment, null, /* @__PURE__ */ React52.createElement(
        ...
        /* @__PURE__ */ React52.createElement(CloseIcon, { fontSize: "small" })
      ))
    }
  )) : null);
}
...
function useLocalStorageState(key, initialValue) {
  ...
  const value = React53.useMemo(() => JSON.parse(input), [input]);
...
import { Tooltip as Tooltip9 } from "@mui/material";
import HelpOutlineIcon from "@mui/icons-material/HelpOutline";
function HelpTooltipIcon({ helpText, ...props }) {
  return /* @__PURE__ */ React54.createElement(Tooltip9, { ...props, title: helpText }, /* @__PURE__ */ React54.createElement(HelpOutlineIcon, { sx: { color: "text.secondary" } }));
}
...
var ComponentCatalogRoot = styled18("div")({
  position: "relative",
...
function ComponentCatalog({ className }) {
  const api = usePageEditorApi();
  const { dom } = useAppState();
  const [searchTerm, setSearchTerm] = React55.useState("");
  const [searchFocused, setSearchFocused] = React55.useState(false);
  const [openStart, setOpenStart] = React55.useState(0);
  ...
  const closeTimeoutRef = React55.useRef();
  const openDrawer = React55.useCallback(() => {
    if (closeTimeoutRef.current) {
      clearTimeout(closeTimeoutRef.current);
    }
    setOpenStart(Date.now());
  }, []);
  const closeDrawer = React55.useCallback(
    (delay) => {
  ...
  const handleDragStart = (componentType) => (event) => {
    ...
    invariant9(def, `No component definition found for "${componentType}"`);
  ...
  const handleMouseEnter = React55.useCallback(() => openDrawer(), [openDrawer]);
  const handleMouseLeave = React55.useCallback(() => closeDrawer(), [closeDrawer]);
  const [createCodeComponentDialogOpen, setCreateCodeComponentDialogOpen] = React55.useState(false);
  const handleCreateCodeComponentDialogOpen = React55.useCallback(() => {
    setCreateCodeComponentDialogOpen(true);
    closeDrawer(0);
  }, [closeDrawer]);
  const handleCreateCodeComponentDialogClose = React55.useCallback(
    () => setCreateCodeComponentDialogOpen(false),
    []
  );
  const filteredItems = React55.useMemo(() => {
  ...
  return /* @__PURE__ */ React55.createElement(React55.Fragment, null, /* @__PURE__ */ React55.createElement(
    ...
    /* @__PURE__ */ React55.createElement(
      ...
      /* @__PURE__ */ React55.createElement(
        ...
        /* @__PURE__ */ React55.createElement(Box11, { sx: { flexDirection: "column", display: "flex", height: "100%" } }, /* @__PURE__ */ React55.createElement(
          Box11,
          {
            sx: {
              width: "100%",
          ...
          /* @__PURE__ */ React55.createElement(
            TextField11,
            {
              ...
              InputProps: {
                startAdornment: /* @__PURE__ */ React55.createElement(InputAdornment2, { position: "start" }, /* @__PURE__ */ React55.createElement(AccountCircle, null))
              },
          ...
          /* @__PURE__ */ React55.createElement(Box11, { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 1, padding: 1 }, filteredItems.map(([componentId, componentType]) => {
            invariant9(componentType, `No component definition found for "${componentId}"`);
            return componentType.builtIn && !componentType.system ? /* @__PURE__ */ React55.createElement(
          ...
          /* @__PURE__ */ React55.createElement(
            ...
            /* @__PURE__ */ React55.createElement(Box11, { display: "flex", alignItems: "center" }, /* @__PURE__ */ React55.createElement(Typography10, { mr: 0.5, variant: "overline" }, "Custom Components"), /* @__PURE__ */ React55.createElement(
              HelpTooltipIcon,
              {
                helpText: /* @__PURE__ */ React55.createElement(Typography10, { variant: "inherit" }, "Expand Toolpad with your own React components.", " ", /* @__PURE__ */ React55.createElement(
                  Link5,
                  {
            ...
            /* @__PURE__ */ React55.createElement(
              ...
              /* @__PURE__ */ React55.createElement(ArrowDropDownSharpIcon, null)
            )
          ),
          /* @__PURE__ */ React55.createElement(Collapse, { in: openCustomComponents, orientation: "vertical" }, /* @__PURE__ */ React55.createElement(Box11, { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 1, padding: 1, pt: 0 }, filteredItems.map(([componentId, componentType]) => {
            invariant9(
              componentType,
              `No component definition found for "${componentId}"`
            );
            return !componentType.builtIn ? /* @__PURE__ */ React55.createElement(
              ComponentCatalogItem_default,
              {
                key: componentId,
                id: componentId,
          ...
          /* @__PURE__ */ React55.createElement(Box11, { padding: 1 }, /* @__PURE__ */ React55.createElement(
            Box11,
            {
              sx: (theme) => ({
                py: 2,
            ...
            /* @__PURE__ */ React55.createElement(Box11, { pb: 0, display: "flex", flexDirection: "row", justifyContent: "space-between" }, /* @__PURE__ */ React55.createElement(Typography10, { variant: "body2", color: "text.secondary" }, "More components coming soon!"), /* @__PURE__ */ React55.createElement(
              IconButton7,
              {
                "aria-label": "Expand custom components",
                sx: {
            ...
            /* @__PURE__ */ React55.createElement(Collapse, { in: openFutureComponents, orientation: "vertical" }, /* @__PURE__ */ React55.createElement(Typography10, { variant: "caption", color: "text.secondary" }, "\u{1F44D} Upvote on GitHub to get it prioritized."), /* @__PURE__ */ React55.createElement(Box11, { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 1, pt: 1, pb: 0 }, Array.from(FUTURE_COMPONENTS, ([key, { displayName, url }]) => {
      ...
      /* @__PURE__ */ React55.createElement(
        ...
        /* @__PURE__ */ React55.createElement(Box11, { sx: { mt: 2 } }, openStart ? /* @__PURE__ */ React55.createElement(ArrowLeftIcon, null) : /* @__PURE__ */ React55.createElement(ArrowRightIcon, null)),
        /* @__PURE__ */ React55.createElement(Box11, { position: "relative" }, /* @__PURE__ */ React55.createElement(
          Typography10,
          {
            sx: {
              position: "absolute",
...
function NotFoundEditor({ className, message, severity }) {
  return /* @__PURE__ */ React56.createElement(Box12, { className, sx: { p: 3 } }, /* @__PURE__ */ React56.createElement(Alert3, { severity: severity ?? "warning" }, message));
}
...
import { Stack as Stack13, Chip as Chip2, Tab as Tab6, IconButton as IconButton12, LinearProgress as LinearProgress3 } from "@mui/material";
...
import * as appDom20 from "@mui/toolpad-core/appDom";
...
function QueryIcon({ id: iconId, mode, sx }) {
  ...
  return /* @__PURE__ */ React58.createElement("div", { style: { display: "flex", gap: 0.5 } }, ModeIcon ? /* @__PURE__ */ React58.createElement(
    ModeIcon,
    {
      sx: {
        fontSize: 12,
  ...
  ) : null, DataSourceIcon ? /* @__PURE__ */ React58.createElement(DataSourceIcon, { sx }) : null);
}
...
import { useBrowserJsRuntime as useBrowserJsRuntime3 } from "@mui/toolpad-core/jsBrowserRuntime";
import invariant10 from "invariant";
import * as appDom19 from "@mui/toolpad-core/appDom";
...
function ApiKeyAuthEditor({ disabled, value, onChange }) {
  return /* @__PURE__ */ React59.createElement(Stack7, { gap: 1 }, /* @__PURE__ */ React59.createElement(
    TextField12,
    {
      disabled,
      label: "header",
...
function AuthenticationDetailsEditor({ value, ...props }) {
  switch (value.type) {
    case "basic":
      return /* @__PURE__ */ React59.createElement(BasicAuthEditor, { value, ...props });
    case "bearerToken":
      return /* @__PURE__ */ React59.createElement(BearerTokenAuthEditor, { value, ...props });
    case "apiKey":
      return /* @__PURE__ */ React59.createElement(ApiKeyAuthEditor, { value, ...props });
    default:
...
function AuthenticationEditor({
  ...
  const handleTypeChange = React59.useCallback(
    (event) => {
      onChange(getInitialAuthenticationValue(event.target.value));
    },
    [onChange]
  );
  return /* @__PURE__ */ React59.createElement(Grid2, { container: true, spacing: 1 }, /* @__PURE__ */ React59.createElement(Grid2, { item: true, xs: 4 }, /* @__PURE__ */ React59.createElement(
    TextField12,
    {
      disabled,
      select: true,
    ...
    /* @__PURE__ */ React59.createElement(MenuItem3, { value: "" }, "No authentication"),
    /* @__PURE__ */ React59.createElement(MenuItem3, { value: "basic" }, "Basic"),
    /* @__PURE__ */ React59.createElement(MenuItem3, { value: "bearerToken" }, "Bearer token"),
    /* @__PURE__ */ React59.createElement(MenuItem3, { value: "apiKey" }, "API key")
  )), /* @__PURE__ */ React59.createElement(Grid2, { item: true, xs: 4 }, value ? /* @__PURE__ */ React59.createElement(AuthenticationDetailsEditor, { disabled, value, onChange }) : null));
}
...
function ParametersEditor({
  ...
  const fieldInputRef = React60.useRef(null);
  const handleRemove = React60.useCallback(
    (index) => () => {
      onChange(value.filter((entry, i) => i !== index));
    },
    [onChange, value]
  );
  const isValidFieldName = React60.useMemo(() => {
    const counts = {};
    value.forEach(([field]) => {
      counts[field] = counts[field] ? counts[field] + 1 : 1;
    });
  ...
  return /* @__PURE__ */ React60.createElement(
    ...
    label ? /* @__PURE__ */ React60.createElement(Box13, { gridColumn: "span 3" }, label, ":") : null,
    value.map(([field, fieldValue], index) => {
      const liveBinding = liveValue[index]?.[1];
      return /* @__PURE__ */ React60.createElement(React60.Fragment, { key: index }, /* @__PURE__ */ React60.createElement(
        TextField13,
        {
          label: valueLabel,
          value: field,
        ...
        /* @__PURE__ */ React60.createElement(DeleteIcon3, { fontSize: "inherit" })
      ));
    }),
    /* @__PURE__ */ React60.createElement("form", { autoComplete: "off", style: { display: "contents" } }, /* @__PURE__ */ React60.createElement(
      TextField13,
      {
        inputRef: fieldInputRef,
        label: fieldLabel,
...
var BodyEditorToolbar = styled20((props) => /* @__PURE__ */ React61.createElement(React61.Fragment, null, /* @__PURE__ */ React61.createElement(Toolbar2, { disableGutters: true, ...props }), /* @__PURE__ */ React61.createElement(Divider5, null)))(({ theme }) => ({
  gap: theme.spacing(1),
  marginBottom: theme.spacing(1)
}));
var MonacoEditor = lazyComponent(() => import("./MonacoEditor-LK72AEWL.mjs"), {
  noSsr: true,
  fallback: /* @__PURE__ */ React61.createElement(Skeleton3, { variant: "rectangular", height: "100%" })
});
function RawBodyEditor({
  ...
  const handleContentTypeChange = React61.useCallback(
    (event) => {
  ...
  return /* @__PURE__ */ React61.createElement(React61.Fragment, null, renderToolbar({
    actions: /* @__PURE__ */ React61.createElement(
      TextField14,
      {
        select: true,
        label: "content-type",
      ...
      Array.from(RAW_CONTENT_TYPES.entries(), ([contentType, { alias }]) => /* @__PURE__ */ React61.createElement(MenuItem4, { key: contentType, value: contentType }, alias))
    )
    ...
    BindableEditor,
    {
      ...
      propType: { type: "string" },
      jsRuntime: jsServerRuntime,
      renderControl: (props) => /* @__PURE__ */ React61.createElement(
        MonacoEditor,
        {
...
function UrlEncodedBodyEditor({
  ...
  const handleParamsChange = React61.useCallback(
    (newContent) => {
      onChange({ ...value, content: newContent });
    },
    [onChange, value]
  ...
  return /* @__PURE__ */ React61.createElement(React61.Fragment, null, renderToolbar(), /* @__PURE__ */ React61.createElement(
    ParametersEditor,
    {
      sx: { mt: 1 },
      value: value.content,
...
function BodyEditor({
  ...
  const [activeTab, setActiveTab] = React61.useState(value?.kind || "raw");
  React61.useEffect(() => setActiveTab(value?.kind || "raw"), [value?.kind]);
  const handleTabChange = (event) => {
    setActiveTab(event.target.value);
  };
  const method = methodProp || "GET";
  const disabled = HTTP_NO_BODY.has(method);
  const renderToolbar = React61.useCallback(
    ({ actions } = {}) => /* @__PURE__ */ React61.createElement(BodyEditorToolbar, null, /* @__PURE__ */ React61.createElement(
      TextField14,
      {
        label: "body",
        select: true,
      ...
      /* @__PURE__ */ React61.createElement(MenuItem4, { value: "raw" }, "raw"),
      /* @__PURE__ */ React61.createElement(MenuItem4, { value: "urlEncoded" }, "x-www-form-urlencoded")
    ), actions),
    [activeTab, disabled]
  );
  return /* @__PURE__ */ React61.createElement(Box14, { sx: { ...sx, position: "relative" } }, /* @__PURE__ */ React61.createElement(TabContext3, { value: activeTab }, /* @__PURE__ */ React61.createElement(TabPanel_default, { disableGutters: true, value: "raw" }, /* @__PURE__ */ React61.createElement(
    RawBodyEditor,
    {
      renderToolbar,
      globalScope,
  ...
  )), /* @__PURE__ */ React61.createElement(TabPanel_default, { disableGutters: true, value: "urlEncoded" }, /* @__PURE__ */ React61.createElement(
  ...
  ))), HTTP_NO_BODY.has(method) ? /* @__PURE__ */ React61.createElement(
    Box14,
    {
      sx: {
        position: "absolute",
    ...
    /* @__PURE__ */ React61.createElement(Typography11, { color: "info", variant: "body2" }, '"', method, `" requests can't have a body`)
  ) : null);
}
...
function useQueryPreview(dofetch, query, params, { onPreview } = {}) {
  const [preview, setPreview] = React62.useState(null);
  const [isLoading, setIsLoading] = React62.useState(false);
  const cancelRunPreview = React62.useRef(null);
  const runPreview = React62.useCallback(() => {
    let canceled = false;
...
function TransformInput({
  ...
  const handleTransformEnabledChange = React63.useCallback(
    (event) => onEnabledChange(event.target.checked),
    [onEnabledChange]
  );
  return /* @__PURE__ */ React63.createElement(Grid3, { item: true, xs: 6, md: 12 }, /* @__PURE__ */ React63.createElement(Stack8, null, /* @__PURE__ */ React63.createElement(
    FormControlLabel3,
    {
  ...
  ), /* @__PURE__ */ React63.createElement(Stack8, { direction: "row", spacing: 2, width: "100%" }, /* @__PURE__ */ React63.createElement(
    JsonView,
    {
      src: globalScope,
  ...
  ), onUpdatePreview ? /* @__PURE__ */ React63.createElement(
    IconButton9,
    {
      disabled: !enabled,
...
import { Box as Box15, IconButton as IconButton10, LinearProgress, styled as styled22, Tab as Tab3 } from "@mui/material";
import DoDisturbIcon from "@mui/icons-material/DoDisturb";

// src/components/Console.tsx
import { darken as darken2, lighten, styled as styled21 } from "@mui/material";
...
var ConsoleRoot = styled21("div")(({ theme }) => {
...
function ConsoleEntry({ entry }) {
  return /* @__PURE__ */ React64.createElement("div", { className: clsx4(classes5.logEntry, entry.level) }, /* @__PURE__ */ React64.createElement("div", { className: classes5.logEntryText }, interleave(
    entry.args.map(
      (arg, i) => typeof arg === "string" ? arg : /* @__PURE__ */ React64.createElement(ObjectInspector_default, { key: i, data: arg })
    ),
    " "
  )));
}
function Console({ value = [], sx }) {
  return /* @__PURE__ */ React64.createElement(ConsoleRoot, { sx }, /* @__PURE__ */ React64.createElement("div", { className: classes5.logEntriesContainer }, /* @__PURE__ */ React64.createElement("div", { className: classes5.logEntries }, value.map((entry, i) => /* @__PURE__ */ React64.createElement(ConsoleEntry, { key: i, entry })))));
}

// src/components/Devtools.tsx
var HarViewer = lazyComponent(() => import("./HarViewer-GR5WGCMI.mjs"), {
  fallback: /* @__PURE__ */ React65.createElement(CenteredSpinner, null)
});
var DebuggerTabPanel = styled22(TabPanel3)({ padding: 0, flex: 1, minHeight: 0 });
function Devtools({ sx, log, onLogClear, har, onHarClear }) {
  const [activeTab, setActiveTab] = React65.useState(() => {
    if (log) {
      return "console";
    }
    if (har) {
  ...
  const clearEnabled = React65.useMemo(() => {
    switch (activeTab) {
      case "console":
        return logLength > 0;
      case "network":
  ...
  const handleClearClick = React65.useCallback(() => {
    switch (activeTab) {
      case "console":
        return onLogClear?.();
      case "network":
  ...
  return /* @__PURE__ */ React65.createElement(
    ...
    /* @__PURE__ */ React65.createElement(TabContext4, { value: activeTab }, /* @__PURE__ */ React65.createElement(
      Box15,
      {
        sx: {
          borderBottom: 1,
      ...
      handleClearClick ? /* @__PURE__ */ React65.createElement(IconButton10, { disabled: !clearEnabled, onClick: handleClearClick }, /* @__PURE__ */ React65.createElement(DoDisturbIcon, null)) : null,
      /* @__PURE__ */ React65.createElement(
        ...
        log ? /* @__PURE__ */ React65.createElement(
          Tab3,
          {
            label: "Console",
            value: "console",
        ...
        har ? /* @__PURE__ */ React65.createElement(
          Tab3,
          {
            label: "Network",
            value: "network",
    ...
    ), log ? /* @__PURE__ */ React65.createElement(DebuggerTabPanel, { value: "console" }, /* @__PURE__ */ React65.createElement(Console, { sx: { flex: 1 }, value: log })) : null, har ? /* @__PURE__ */ React65.createElement(DebuggerTabPanel, { value: "network" }, /* @__PURE__ */ React65.createElement(React65.Suspense, { fallback: /* @__PURE__ */ React65.createElement(LinearProgress, null) }, /* @__PURE__ */ React65.createElement(HarViewer, { sx: { flex: 1 }, value: har }))) : null)
  );
}
...
import { createProvidedContext as createProvidedContext4 } from "@mui/toolpad-utils/react";
...
import { styled as styled23 } from "@mui/material";
var Pre = styled23("pre")({
  margin: 0,
  fontFamily: 'Consolas, Menlo, Monaco, "Andale Mono", "Ubuntu Mono", monospace'
});
var Pre_default = Pre;
...
function ErrorAlert({ error, sx }) {
  ...
  const toggleExpanded = React67.useCallback(() => setExpanded((actual) => !actual), []);
  return /* @__PURE__ */ React67.createElement(Alert4, { severity: "error", sx: { ...sx, position: "relative" } }, stack ? /* @__PURE__ */ React67.createElement(
    IconButton11,
    {
      color: "inherit",
    ...
    expanded ? /* @__PURE__ */ React67.createElement(ExpandLessIcon, null) : /* @__PURE__ */ React67.createElement(ExpandMoreIcon, null)
  ) : null, /* @__PURE__ */ React67.createElement(AlertTitle, null, /* @__PURE__ */ React67.createElement(Pre_default, { sx: { whiteSpace: "pre-wrap" } }, message)), stack ? /* @__PURE__ */ React67.createElement(Collapse2, { in: expanded }, /* @__PURE__ */ React67.createElement(Box16, { sx: { overflow: "auto" } }, /* @__PURE__ */ React67.createElement(Pre_default, null, stack))) : null);
}
...
function QueryPreview({ children, error, isLoading }) {
  return /* @__PURE__ */ React68.createElement(
    ...
    isLoading ? /* @__PURE__ */ React68.createElement(LinearProgress2, null) : null,
    /* @__PURE__ */ React68.createElement(Box17, { sx: { flex: 1, minHeight: 0, overflow: "auto" } }, error ? /* @__PURE__ */ React68.createElement(ErrorAlert, { sx: { m: 2 }, error }) : children)
  );
}

// src/toolpadDataSources/rest/client.tsx
var HTTP_METHODS = ["GET", "POST", "PUT", "DELETE", "PATCH", "HEAD"];
var QUERY_SCOPE_META = {
  parameters: {
    description: "Parameters that can be bound to app scope variables"
  }
};
var ButtonLink = styled24("button")(({ theme }) => ({
  background: "none",
  border: "none",
  fontSize: "inherit",
  padding: 0,
...
function UrlControl({ label, disabled, baseUrl, value, onChange }) {
  const handleChange = React69.useCallback(
    (event) => {
  ...
  return /* @__PURE__ */ React69.createElement(
    TextField15,
    {
      ...
      label,
      InputProps: baseUrl ? {
        startAdornment: /* @__PURE__ */ React69.createElement(InputAdornment3, { position: "start" }, baseUrl)
      } : void 0
    }
  );
}
...
function ConnectionParamsInput({ value, onChange }) {
  ...
  React69.useEffect(() => reset(withDefaults(value)), [reset, value]);
  ...
  return /* @__PURE__ */ React69.createElement(Stack9, { direction: "column", gap: 3, sx: { py: 3 } }, /* @__PURE__ */ React69.createElement(TextField15, { ...baseUrlInputProps }), /* @__PURE__ */ React69.createElement(Typography12, null, "Headers:"), /* @__PURE__ */ React69.createElement(
    Controller,
    {
      name: "headers",
      control,
  ...
  ), /* @__PURE__ */ React69.createElement(Typography12, null, "Authentication:"), /* @__PURE__ */ React69.createElement(
    Controller,
    {
      name: "authentication",
      control,
      render: ({ field: { value: fieldValue, ref, ...field } }) => /* @__PURE__ */ React69.createElement(AuthenticationEditor, { ...field, disabled: !headersAllowed, value: fieldValue ?? null })
    }
  ), /* @__PURE__ */ React69.createElement(Toolbar3, { disableGutters: true }, /* @__PURE__ */ React69.createElement(Box18, { sx: { flex: 1 } }), /* @__PURE__ */ React69.createElement(Button8, { variant: "contained", onClick: doSubmit, disabled: isSaveDisabled(formState) }, "Save")));
}
function ResolvedPreview({
  ...
  if (typeof data === "undefined" && typeof untransformedData !== "undefined") {
    alert = /* @__PURE__ */ React69.createElement(Alert5, { severity: "warning", sx: { m: 1, p: 1, fontSize: 11 } }, /* @__PURE__ */ React69.createElement(Box18, { sx: { mb: 1 } }, "Request successfully completed and returned data", responseDataKeys.length > 0 ? " with the following keys:" : "."), responseDataKeys.map((key) => /* @__PURE__ */ React69.createElement(Box18, { sx: { display: "block" }, key }, "- ", key)), /* @__PURE__ */ React69.createElement(Box18, { sx: { mt: 1 } }, "However, it seems that the ", /* @__PURE__ */ React69.createElement(ButtonLink, { onClick: onShowTransform }, "transform"), " ", "function returned an ", /* @__PURE__ */ React69.createElement("code", null, "undefined"), " value."));
  }
  return /* @__PURE__ */ React69.createElement(React69.Fragment, null, alert, /* @__PURE__ */ React69.createElement(JsonView, { sx: { height: "100%" }, src: preview?.data }));
}
var EMPTY_PARAMS = [];
function QueryEditor({
  ...
  const urlValue = input.attributes.query.url ?? getDefaultUrl(runtimeConfig, connectionParams);
  ...
  const env = React69.useMemo(() => introspection?.data?.env, [introspection]);
  const handleParamsChange = React69.useCallback(
    (newParams) => {
      appStateApi.updateQueryDraft((draft) => ({
        ...draft,
        params: newParams
  ...
  const handleUrlChange = React69.useCallback(
    (newUrl) => {
      updateProp("url", newUrl ?? "");
    },
    [updateProp]
  );
  const handleMethodChange = React69.useCallback(
    (event) => {
      updateProp("method", event.target.value);
    },
    [updateProp]
  );
  const handleTransformEnabledChange = React69.useCallback(
    (transformEnabled) => {
      updateProp("transformEnabled", transformEnabled);
    },
    [updateProp]
  );
  const handleTransformChange = React69.useCallback(
    (transform) => {
      updateProp("transform", transform);
    },
    [updateProp]
  );
  const handleBodyChange = React69.useCallback(
    (newBody) => {
      updateProp("body", newBody || void 0);
    },
    [updateProp]
  );
  const handleSearchParamsChange = React69.useCallback(
    (newSearchParams) => {
      updateProp("searchParams", newSearchParams);
    },
    [updateProp]
  );
  const handleHeadersChange = React69.useCallback(
    (newHeaders) => {
      updateProp("headers", newHeaders);
    },
    [updateProp]
  );
  const handleResponseTypeChange = React69.useCallback(
    (event) => {
      updateProp("response", {
  ...
  const jsServerRuntime = React69.useMemo(() => createServerJsRuntime(env ?? {}), [env]);
  ...
  const queryScope = React69.useMemo(
    () => ({
  ...
  const [configTab, setConfigTab] = React69.useState("urlQuery");
  ...
  const fetchPreview = React69.useCallback(
    (query, params) => fetchPrivate({ kind: "debugExec", query, params }),
    [fetchPrivate]
  );
  const [previewHar, setPreviewHar] = React69.useState(() => createHarLog());
  const { preview, runPreview, isLoading } = useQueryPreview(
    fetchPreview,
    input.attributes.query,
    previewParams,
    {
      onPreview: React69.useCallback((result) => {
        setPreviewHar(
  ...
  const handleHarClear = React69.useCallback(() => setPreviewHar(createHarLog()), []);
  const handleConfigTabChange = React69.useCallback(
  ...
  return currentTab ? /* @__PURE__ */ React69.createElement(resizablePanels_exports.PanelGroup, { autoSaveId: "toolpad/rest-panel", direction: "horizontal" }, /* @__PURE__ */ React69.createElement(resizablePanels_exports.Panel, { id: "rest-query-left", defaultSize: 50, minSize: 40, style: { overflow: "auto" } }, /* @__PURE__ */ React69.createElement(TabContext5, { value: currentTab?.tabType ?? "config" }, /* @__PURE__ */ React69.createElement(Stack9, { direction: "column", gap: 0 }, /* @__PURE__ */ React69.createElement(Stack9, { direction: "row", sx: { display: "flex", justifyContent: "space-between" } }, /* @__PURE__ */ React69.createElement(
    TabList4,
    {
      sx: { "& button": { fontSize: 12, fontWeight: "normal" } },
    ...
    /* @__PURE__ */ React69.createElement(Tab4, { label: "Config", value: "config" }),
    /* @__PURE__ */ React69.createElement(Tab4, { label: "Settings", value: "settings" })
  )), /* @__PURE__ */ React69.createElement(Divider6, null), /* @__PURE__ */ React69.createElement(TabPanel_default, { value: "config", disableGutters: true }, /* @__PURE__ */ React69.createElement(React69.Fragment, null, /* @__PURE__ */ React69.createElement(
    Box18,
    {
      sx: {
        display: "grid",
    ...
    /* @__PURE__ */ React69.createElement(
      ...
      HTTP_METHODS.map((method) => /* @__PURE__ */ React69.createElement(MenuItem5, { key: method, value: method }, method))
    ),
    /* @__PURE__ */ React69.createElement(
      BindableEditor,
      {
        ...
        label: "url",
        propType: { type: "string" },
        renderControl: (props) => /* @__PURE__ */ React69.createElement(UrlControl, { baseUrl, ...props }),
        value: urlValue,
        onChange: handleUrlChange
      }
    )
  ), /* @__PURE__ */ React69.createElement(Box18, { sx: { display: "flex", flexDirection: "column", gap: 1, mt: 2.5, mx: 0 } }, /* @__PURE__ */ React69.createElement(TabContext5, { value: configTab }, /* @__PURE__ */ React69.createElement(Box18, { sx: { border: 1, borderColor: "divider" } }, /* @__PURE__ */ React69.createElement(
    TabList4,
    {
      sx: { "& button": { fontSize: 12, fontWeight: "normal" } },
    ...
    /* @__PURE__ */ React69.createElement(Tab4, { label: "URL query", value: "urlQuery" }),
    /* @__PURE__ */ React69.createElement(Tab4, { label: "Body", value: "body" }),
    /* @__PURE__ */ React69.createElement(Tab4, { label: "Headers", value: "headers" }),
    /* @__PURE__ */ React69.createElement(Tab4, { label: "Response", value: "response" }),
    /* @__PURE__ */ React69.createElement(Tab4, { label: "Transform", value: "transform" })
  )), /* @__PURE__ */ React69.createElement(TabPanel_default, { disableGutters: true, value: "urlQuery", sx: { ml: 1 } }, /* @__PURE__ */ React69.createElement(
    ParametersEditor,
    {
  ...
  )), /* @__PURE__ */ React69.createElement(TabPanel_default, { disableGutters: true, value: "body", sx: { ml: 1 } }, /* @__PURE__ */ React69.createElement(
    BodyEditor,
    {
  ...
  )), /* @__PURE__ */ React69.createElement(TabPanel_default, { disableGutters: true, value: "headers", sx: { ml: 1 } }, /* @__PURE__ */ React69.createElement(
    ParametersEditor,
    {
  ...
  )), /* @__PURE__ */ React69.createElement(TabPanel_default, { disableGutters: true, value: "response", sx: { ml: 1 } }, /* @__PURE__ */ React69.createElement(
    TextField15,
    {
      select: true,
      label: "response type",
    ...
    /* @__PURE__ */ React69.createElement(MenuItem5, { value: "raw" }, "raw"),
    /* @__PURE__ */ React69.createElement(MenuItem5, { value: "json" }, "JSON"),
    /* @__PURE__ */ React69.createElement(MenuItem5, { value: "csv", disabled: true }, "\u{1F6A7} CSV"),
    /* @__PURE__ */ React69.createElement(MenuItem5, { value: "xml", disabled: true }, "\u{1F6A7} XML")
  )), /* @__PURE__ */ React69.createElement(TabPanel_default, { disableGutters: true, value: "transform", sx: { ml: 1 } }, /* @__PURE__ */ React69.createElement(
    TransformInput,
    {
  ...
  )))))), /* @__PURE__ */ React69.createElement(TabPanel_default, { value: "settings", disableGutters: true }, settingsTab)))), /* @__PURE__ */ React69.createElement(PanelResizeHandle, null), /* @__PURE__ */ React69.createElement(resizablePanels_exports.Panel, { id: "rest-query-right", defaultSize: 50, minSize: 20 }, /* @__PURE__ */ React69.createElement(resizablePanels_exports.PanelGroup, { autoSaveId: "toolpad/rest/params-tools-split", direction: "vertical" }, /* @__PURE__ */ React69.createElement(resizablePanels_exports.Panel, { defaultSize: 50, style: { overflow: "auto", scrollbarGutter: "stable" } }, /* @__PURE__ */ React69.createElement(Box18, { display: "flex", flexDirection: "column" }, /* @__PURE__ */ React69.createElement(TabContext5, { value: "parameters" }, /* @__PURE__ */ React69.createElement(
    TabList4,
    {
      sx: {
    ...
    /* @__PURE__ */ React69.createElement(Tab4, { label: "Parameters", value: "parameters" })
  ), /* @__PURE__ */ React69.createElement(Divider6, { sx: { mb: 1.5 } }), /* @__PURE__ */ React69.createElement(TabPanel_default, { value: "parameters", disableGutters: true, sx: { ml: 1 } }, /* @__PURE__ */ React69.createElement(
    ParametersEditor,
    {
      value: paramsEntries,
      onChange: handleParamsChange,
  ...
  ))))), /* @__PURE__ */ React69.createElement(PanelResizeHandle, null), /* @__PURE__ */ React69.createElement(resizablePanels_exports.Panel, { defaultSize: 50, style: { overflow: "auto", scrollbarGutter: "stable" } }, /* @__PURE__ */ React69.createElement(TabContext5, { value: currentTab.toolsTabType }, /* @__PURE__ */ React69.createElement(
    Box18,
    {
      sx: {
        borderBottom: 1,
    ...
    /* @__PURE__ */ React69.createElement(
      ...
      /* @__PURE__ */ React69.createElement(Tab4, { label: "Preview", value: "preview" }),
      /* @__PURE__ */ React69.createElement(Tab4, { label: "Dev Tools", value: "devTools" })
    ),
    /* @__PURE__ */ React69.createElement(
      LoadingButton2,
      {
        ...
        disabled: isLoading,
        onClick: runPreview,
        endIcon: /* @__PURE__ */ React69.createElement(PlayArrowIcon, { "aria-label": "Run preview", onClick: runPreview })
      },
      "Run"
    )
  ), /* @__PURE__ */ React69.createElement(TabPanel_default, { value: "preview", disableGutters: true }, /* @__PURE__ */ React69.createElement(QueryPreview, { isLoading: currentTab.isPreviewLoading, error: preview?.error }, /* @__PURE__ */ React69.createElement(
    ResolvedPreview,
    {
      preview,
      onShowTransform: () => setConfigTab("transform")
    }
  ))), /* @__PURE__ */ React69.createElement(TabPanel_default, { value: "devTools", disableGutters: true }, /* @__PURE__ */ React69.createElement(Devtools, { sx: { overflow: "auto" }, har: previewHar, onHarClear: handleHarClear }))))))) : /* @__PURE__ */ React69.createElement(Alert5, { severity: "error" }, "An error occurred while rendering this tab. Please refresh and try again.");
}
...
import { Alert as Alert6, Box as Box20, Divider as Divider7, Stack as Stack11, Tab as Tab5 } from "@mui/material";
import PlayArrowIcon2 from "@mui/icons-material/PlayArrow";
import { TabContext as TabContext6, TabList as TabList5 } from "@mui/lab";
import { useBrowserJsRuntime as useBrowserJsRuntime2 } from "@mui/toolpad-core/jsBrowserRuntime";
import { errorFrom as errorFrom3 } from "@mui/toolpad-utils/errors";
import { useQuery } from "@tanstack/react-query";
import Grid22 from "@mui/material/Unstable_Grid2/Grid2";
...
var StyledAutocompletePopper = styled25("div")(({ theme }) => ({
...
function PopperComponent(props) {
  ...
  return /* @__PURE__ */ React70.createElement(StyledAutocompletePopper, { ...other });
}
var StyledPopper = styled25(Popper)(({ theme }) => ({
  border: `1px solid ${theme.palette.divider}`,
...
var StyledInput = styled25(InputBase)(({ theme }) => ({
  padding: 10,
  width: "100%",
  border: `1px solid ${theme.palette.divider}`,
  "& input": {
...
var FunctionButton = styled25(Chip)(({ theme }) => ({
  fontSize: 12,
  width: "100%",
...
var StyledListSubheader = styled25(ListSubheader)(({ theme }) => ({
  lineHeight: 2.5,
  fontSize: 13,
  fontFamily: theme.typography.fontFamilyCode,
...
function FunctionSelector({
  ...
  const { selectedFileName, selectedFunctionName } = React70.useMemo(() => {
  ...
  const handleCreateNew = React70.useCallback(async () => {
    const functionId = await onCreateNew();
    onSelect(functionId);
  }, [onCreateNew, onSelect]);
  const handleInput = React70.useCallback((event) => {
  ...
  return /* @__PURE__ */ React70.createElement(React70.Fragment, null, /* @__PURE__ */ React70.createElement(
    FunctionButton,
    {
      "aria-describedby": id,
      clickable: true,
      icon: /* @__PURE__ */ React70.createElement(DataObjectOutlinedIcon, { fontSize: "inherit", color: "inherit" }),
      onClick: handleClick,
    ...
    /* @__PURE__ */ React70.createElement(ClickAwayListener, { onClickAway: handleClose }, /* @__PURE__ */ React70.createElement("div", null, /* @__PURE__ */ React70.createElement(
      Box19,
      {
        sx: {
          px: 1,
      ...
      Autocomplete3,
      {
        ...
        renderGroup: (params) => [
          /* @__PURE__ */ React70.createElement(StyledListSubheader, { key: params.key }, /* @__PURE__ */ React70.createElement(Stack10, { direction: "row", justifyContent: "space-between" }, params.group, /* @__PURE__ */ React70.createElement(
            OpenCodeEditorButton,
            {
        ...
        renderOption: (props, option, { selected }) => /* @__PURE__ */ React70.createElement("li", { ...props }, /* @__PURE__ */ React70.createElement(
          Box19,
          {
            component: DoneIcon,
            sx: {
      ...
      {
        sx: { m: 1, mb: 0.5 },
        startIcon: /* @__PURE__ */ React70.createElement(AddOutlinedIcon, { fontSize: "inherit" }),
...
function ResolvedPreview2({ preview }) {
  if (!preview) {
    return /* @__PURE__ */ React71.createElement(
      ...
      "No request has been sent yet. ",
      /* @__PURE__ */ React71.createElement("br", null),
      "Click Run",
  ...
  const { data } = preview;
  return /* @__PURE__ */ React71.createElement(JsonView, { sx: { height: "100%" }, src: data, copyToClipboard: true });
}
function QueryEditor2({
  ...
  const updateProp = React71.useCallback(
    function updateProp2(prop, value) {
      appStateApi.updateQueryDraft((draft) => ({
        ...draft,
        attributes: {
  ...
  const currentTab = React71.useMemo(() => {
    if (currentView.kind === "page" && currentView.view?.kind === "query" && currentView.queryPanel?.currentTabIndex !== void 0) {
      return currentView.queryPanel?.queryTabs?.[currentView.queryPanel?.currentTabIndex];
    }
    return null;
  ...
  const parameterDefs = React71.useMemo(
    () => Object.fromEntries(selectedOption?.parameters || []),
    [selectedOption?.parameters]
  );
  const paramsEntries = React71.useMemo(
  ...
  const previewParams = React71.useMemo(
    () => Object.fromEntries(paramsEditorLiveValue.map(([key, binding]) => [key, binding?.value])),
    [paramsEditorLiveValue]
  );
  const handleToolsTabTypeChange = React71.useCallback(
    (value) => {
      appStateApi.updateQueryTab((tab) => ({
        ...tab,
        toolsTabType: value
  ...
  const fetchServerPreview = React71.useCallback(
    async (query, params) => {
  ...
  const handleRunPreview = React71.useCallback(() => {
    runPreview();
  }, [runPreview]);
  React71.useEffect(() => {
    appStateApi.updateQueryTab((tab) => ({
  ...
  const handleSelectFunction = React71.useCallback(
    (functionId) => {
      updateProp("function", functionId);
    },
    [updateProp]
  );
  const proposedFileName = React71.useMemo(() => {
  ...
  const handleCreateNewCommit = React71.useCallback(async () => {
    try {
  ...
  const handleTabTypeChange = React71.useCallback(
    (value) => {
      appStateApi.updateQueryTab((tab) => ({
        ...tab,
        tabType: value
  ...
  return currentTab ? /* @__PURE__ */ React71.createElement(resizablePanels_exports.PanelGroup, { autoSaveId: "toolpad/local-panel", direction: "horizontal" }, /* @__PURE__ */ React71.createElement(
    ...
    /* @__PURE__ */ React71.createElement(TabContext6, { value: currentTab?.tabType ?? "config" }, /* @__PURE__ */ React71.createElement(Stack11, { direction: "column", gap: 0 }, /* @__PURE__ */ React71.createElement(Stack11, { direction: "row", sx: { display: "flex", justifyContent: "space-between" } }, /* @__PURE__ */ React71.createElement(
      TabList5,
      {
        sx: { "& button": { fontSize: 12, fontWeight: "normal" } },
      ...
      /* @__PURE__ */ React71.createElement(Tab5, { label: "Config", value: "config" }),
      /* @__PURE__ */ React71.createElement(Tab5, { label: "Settings", value: "settings" })
    )), /* @__PURE__ */ React71.createElement(Divider7, null), /* @__PURE__ */ React71.createElement(TabPanel_default, { value: "config", disableGutters: true }, /* @__PURE__ */ React71.createElement(
      Stack11,
      {
        display: "flex",
        flexDirection: "row",
      ...
      introspection.error ? /* @__PURE__ */ React71.createElement(
        Box20,
        {
          sx: {
            position: "absolute",
    ...
    )), /* @__PURE__ */ React71.createElement(TabPanel_default, { value: "settings", disableGutters: true }, settingsTab)))
  ), /* @__PURE__ */ React71.createElement(PanelResizeHandle, null), /* @__PURE__ */ React71.createElement(resizablePanels_exports.Panel, { id: "local-query-right", defaultSize: 50, minSize: 20 }, /* @__PURE__ */ React71.createElement(resizablePanels_exports.PanelGroup, { autoSaveId: "toolpad/local/params-tools-split", direction: "vertical" }, /* @__PURE__ */ React71.createElement(
    resizablePanels_exports.Panel,
    {
    ...
    /* @__PURE__ */ React71.createElement(Box20, { display: "flex", flexDirection: "column" }, /* @__PURE__ */ React71.createElement(TabContext6, { value: "parameters" }, /* @__PURE__ */ React71.createElement(
      TabList5,
      {
        sx: {
          "& button": { fontSize: 12, fontWeight: "normal", cursor: "default" }
      ...
      /* @__PURE__ */ React71.createElement(Tab5, { label: "Parameters", value: "parameters" })
    ), /* @__PURE__ */ React71.createElement(Divider7, { sx: { mb: 1.5 } }), /* @__PURE__ */ React71.createElement(TabPanel_default, { value: "parameters", disableGutters: true, sx: { ml: 1 } }, /* @__PURE__ */ React71.createElement(Grid22, { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 2 }, Object.entries(parameterDefs).map(([name, definiton]) => {
      const Control = getDefaultControl(propTypeControls, definiton, liveBindings);
      return Control ? /* @__PURE__ */ React71.createElement(
        BindableEditor,
        {
          key: name,
          ...
          propType: definiton,
          jsRuntime: jsBrowserRuntime,
          renderControl: (renderControlParams) => /* @__PURE__ */ React71.createElement(Control, { ...renderControlParams, propType: definiton }),
  ...
  ), /* @__PURE__ */ React71.createElement(PanelResizeHandle, null), /* @__PURE__ */ React71.createElement(
    resizablePanels_exports.Panel,
    {
      id: "preview",
      defaultSize: 50,
    ...
    /* @__PURE__ */ React71.createElement(TabContext6, { value: currentTab.toolsTabType }, /* @__PURE__ */ React71.createElement(
      Box20,
      {
        sx: {
          borderBottom: 1,
      ...
      /* @__PURE__ */ React71.createElement(
        ...
        /* @__PURE__ */ React71.createElement(Tab5, { label: "Preview", value: "preview" })
      ),
      /* @__PURE__ */ React71.createElement(
        LoadingButton3,
        {
          ...
          disabled: isLoading,
          onClick: runPreview,
          endIcon: /* @__PURE__ */ React71.createElement(PlayArrowIcon2, { "aria-label": "Run preview", onClick: runPreview })
        },
        "Run"
      )
    ), /* @__PURE__ */ React71.createElement(TabPanel_default, { value: "preview", disableGutters: true }, /* @__PURE__ */ React71.createElement(QueryPreview, { isLoading: currentTab.isPreviewLoading, error: preview?.error }, /* @__PURE__ */ React71.createElement(ResolvedPreview2, { preview }))))
  )))) : /* @__PURE__ */ React71.createElement(Alert6, { severity: "error" }, "An error occurred while rendering this tab. Please refresh and try again.");
}
...
function QuerySettingsTab({
  ...
  const appStateApi = useAppStateApi();
  const updateAttribute = React72.useCallback(
  ...
  const handleModeChange = React72.useCallback(
    (event) => {
  ...
  const handleEnabledChange = React72.useCallback(
    (newValue) => {
      if (newValue !== null) {
  ...
  const handleRefetchIntervalChange = React72.useCallback(
    (event) => {
  ...
  return /* @__PURE__ */ React72.createElement(
    ...
    /* @__PURE__ */ React72.createElement(
      ...
      /* @__PURE__ */ React72.createElement(Typography13, { fontSize: 12, sx: { alignSelf: "center" } }, "Set query mode:"),
      /* @__PURE__ */ React72.createElement(
        TextField16,
        {
          select: true,
        ...
        /* @__PURE__ */ React72.createElement(MenuItem6, { value: "query" }, "Fetch at any time to always be available on the page"),
        /* @__PURE__ */ React72.createElement(MenuItem6, { value: "mutation" }, "Only fetch on manual action")
      ),
      draft?.attributes?.mode !== "mutation" ? /* @__PURE__ */ React72.createElement(React72.Fragment, null, /* @__PURE__ */ React72.createElement(Typography13, { fontSize: 12, sx: { alignSelf: "center" } }, "Set refetch interval:"), /* @__PURE__ */ React72.createElement(
        TextField16,
        {
          InputProps: {
            startAdornment: /* @__PURE__ */ React72.createElement(InputAdornment4, { position: "start" }, "s")
          },
          sx: {
            [`& .${inputLabelClasses4.root}`]: { fontSize: 12 },
            [`& .${inputBaseClasses4.root}`]: { fontSize: 12 },
      ...
      ), /* @__PURE__ */ React72.createElement(Typography13, { fontSize: 12, sx: { alignSelf: "center" } }, "Set query enabled/disabled:"), /* @__PURE__ */ React72.createElement(
        BindableEditor,
        {
...
function QueryEditorPanel({ draft, saved }) {
  ...
  const queryEditorContext = React72.useMemo(
  ...
  const execPrivate = React72.useCallback(
    (method, args) => {
      invariant10(dataSourceId, "dataSourceId must be set");
      return projectApi.methods.dataSourceExecPrivate(dataSourceId, method, args);
    },
    [projectApi, dataSourceId]
  );
  return dataSourceId && dataSource3 && queryEditorContext ? /* @__PURE__ */ React72.createElement(ConnectionContextProvider, { value: queryEditorContext }, /* @__PURE__ */ React72.createElement(Box21, { sx: { height: "100%", p: 0, overflow: "hidden" } }, /* @__PURE__ */ React72.createElement(
    dataSource3.QueryEditor,
    {
      ...
      execApi: execPrivate,
      runtimeConfig,
      settingsTab: /* @__PURE__ */ React72.createElement(
        QuerySettingsTab,
        {
          ...{
            draft,
  ...
  ))) : /* @__PURE__ */ React72.createElement(Alert7, { severity: "error" }, 'Datasource "', dataSourceId, '" not found');
}
...
function getModifierKey() {
  return isMac() ? "\u2318" : /* @__PURE__ */ React73.createElement("kbd", null, "Ctrl");
}

// src/toolpad/AppEditor/PageEditor/QueryEditor/index.tsx
function SaveShortcutIndicator() {
  return /* @__PURE__ */ React74.createElement("span", null, getModifierKey(), "+", /* @__PURE__ */ React74.createElement("kbd", null, "S"));
}
function TabCloseIcon({
  ...
  const appStateApi = useAppStateApi();
  const [notHovered, setNotHovered] = React74.useState(true);
  const onClose = React74.useCallback(() => {
    if (queryId === void 0) {
      return;
    }
  ...
  return unsaved && notHovered ? /* @__PURE__ */ React74.createElement(
    CircleIcon,
    {
...
function QueryEditor3() {
  ...
  const hasUnsavedChanges = React74.useCallback(
    (queryIndex) => {
  ...
  const handleSave = React74.useCallback(() => {
  ...
  const onClosePanel = React74.useCallback(() => {
    appStateApi.closeQueryPanel();
  }, [appStateApi]);
  const saveDisabled = React74.useMemo(
    () => !hasUnsavedChanges(Number(currentTabIndex)),
    [hasUnsavedChanges, currentTabIndex]
  );
  const hasUnsavedChangesInPanel = React74.useMemo(() => {
  ...
  return currentView.kind === "page" && currentView.view?.kind === "query" && currentQueryId && currentView?.queryPanel?.queryTabs ? /* @__PURE__ */ React74.createElement(
    Stack13,
    {
      direction: "column",
    ...
    /* @__PURE__ */ React74.createElement(TabContext7, { value: currentTabIndex }, /* @__PURE__ */ React74.createElement(
      Stack13,
      {
        direction: "row",
        justifyContent: "space-between",
      ...
      /* @__PURE__ */ React74.createElement(TabList6, { onChange: handleTabChange, "aria-label": "Query editor tabs" }, currentView.queryPanel?.queryTabs?.map((query, index) => /* @__PURE__ */ React74.createElement(
        Tab6,
        {
          key: index,
          label: /* @__PURE__ */ React74.createElement(
            Chip2,
            {
              ...
              deleteIcon: /* @__PURE__ */ React74.createElement(
                TabCloseIcon,
                {
                  queryIndex: index,
          ...
          icon: /* @__PURE__ */ React74.createElement(
            QueryIcon,
            {
      ...
      /* @__PURE__ */ React74.createElement("div", null, /* @__PURE__ */ React74.createElement(
        ...
        "Save \xA0",
        /* @__PURE__ */ React74.createElement(SaveShortcutIndicator, null)
      ), /* @__PURE__ */ React74.createElement(IconButton12, { size: "small", disableRipple: true, onClick: handleClosePanel }, /* @__PURE__ */ React74.createElement(
      ...
      if (query && query.draft) {
        return /* @__PURE__ */ React74.createElement(
          ...
          /* @__PURE__ */ React74.createElement(React74.Suspense, { fallback: /* @__PURE__ */ React74.createElement(LinearProgress3, null) }, /* @__PURE__ */ React74.createElement(QueryEditorPanel, { draft: query.draft, saved: query.saved }))
        );
      }
      return null;
    }))
...
var PageEditorRoot = styled26("div")({
  width: "100%",
  height: "100%",
  overflow: "hidden",
  display: "flex",
...
function PageEditorContent({ node }) {
  usePageTitle(`${appDom21.getPageTitle(node)} | Toolpad editor`);
  const { currentView } = useAppState();
  const showQuery = currentView.kind === "page" && currentView.view?.kind === "query" && currentView.queryPanel?.queryTabs;
  return /* @__PURE__ */ React75.createElement(PageEditorProvider, { key: node.id, nodeId: node.id }, /* @__PURE__ */ React75.createElement(resizablePanels_exports.PanelGroup, { autoSaveId: "toolpad/editor-panel-split", direction: "vertical" }, /* @__PURE__ */ React75.createElement(resizablePanels_exports.Panel, { order: 1, id: "editor" }, /* @__PURE__ */ React75.createElement(resizablePanels_exports.PanelGroup, { autoSaveId: "editor/component-panel-split", direction: "horizontal" }, /* @__PURE__ */ React75.createElement(resizablePanels_exports.Panel, { id: "page-editor", defaultSize: 75, minSize: 50, maxSize: 80 }, /* @__PURE__ */ React75.createElement(PageEditorRoot, null, appDom21.isCodePage(node) ? null : /* @__PURE__ */ React75.createElement(ComponentCatalog_default, null), /* @__PURE__ */ React75.createElement(RenderPanel_default, { className: classes6.renderPanel }))), /* @__PURE__ */ React75.createElement(PanelResizeHandle, null), /* @__PURE__ */ React75.createElement(resizablePanels_exports.Panel, { id: "component-panel", defaultSize: 25, maxSize: 50, minSize: 20 }, /* @__PURE__ */ React75.createElement(ComponentPanel, null)))), /* @__PURE__ */ React75.createElement(PanelResizeHandle, null), showQuery ? /* @__PURE__ */ React75.createElement(resizablePanels_exports.Panel, { minSize: 10, maxSize: 90, defaultSize: 35, order: 2, id: "query-panel" }, /* @__PURE__ */ React75.createElement(QueryEditor3, null)) : null));
}
function PageEditor({ name }) {
  const { dom } = useAppState();
  const pageNode = React75.useMemo(() => appDom21.getPageByName(dom, name), [dom, name]);
  useUndoRedo();
  return pageNode ? /* @__PURE__ */ React75.createElement(PageEditorContent, { node: pageNode }) : /* @__PURE__ */ React75.createElement(NotFoundEditor, { message: `Non-existing Page "${name}"` });
}
...
import { styled as styled30, Box as Box25, Divider as Divider9, Typography as Typography18 } from "@mui/material";
import * as appDom26 from "@mui/toolpad-core/appDom";

// src/toolpad/AppEditor/PagesExplorer/index.tsx
import * as React81 from "react";
import { styled as styled28, Box as Box22, IconButton as IconButton14, Stack as Stack15, Tooltip as Tooltip11 } from "@mui/material";
...
import useBoolean2 from "@mui/toolpad-utils/hooks/useBoolean";
import * as appDom23 from "@mui/toolpad-core/appDom";
...
import useLatest3 from "@mui/toolpad-utils/hooks/useLatest";
import * as appDom22 from "@mui/toolpad-core/appDom";
...
var SystemDialogCancelButton = React76.forwardRef(
  ({ children = "cancel", ...props }, ref) => /* @__PURE__ */ React76.createElement(Button10, { ref, color: "inherit", variant: "text", ...props }, children)
);
var SystemDialogOkButton = React76.forwardRef(
  ({ children = "ok", ...props }, ref) => /* @__PURE__ */ React76.createElement(LoadingButton5, { ref, ...props }, children)
);
function ConfirmDialog({
  ...
  const handleCancel = React76.useCallback(
    (event) => onClose(false, event),
    [onClose]
  );
  const handleOk = React76.useCallback((event) => onClose(true, event), [onClose]);
  return /* @__PURE__ */ React76.createElement(SystemDialog, { open, onClose: handleCancel }, /* @__PURE__ */ React76.createElement(SystemDialogTitle, null, title ?? "Confirm"), /* @__PURE__ */ React76.createElement(SystemDialogContent, null, children), /* @__PURE__ */ React76.createElement(SystemDialogActions, null, /* @__PURE__ */ React76.createElement(SystemDialogCancelButton, { onClick: handleCancel }, cancelButton), /* @__PURE__ */ React76.createElement(SystemDialogOkButton, { color: severity, loading, onClick: handleOk }, okButton)));
}

// src/utils/useMenu.ts
import * as React77 from "react";
function useMenu() {
  const buttonId = React77.useId();
  const menuId = React77.useId();
  const [anchorEl, setAnchorEl] = React77.useState(null);
  const open = Boolean(anchorEl);
  const onMenuClose = React77.useCallback((event) => {
    event?.stopPropagation?.();
    setAnchorEl(null);
  }, []);
  const buttonProps = React77.useMemo(
    () => ({
      id: buttonId,
  ...
  const menuProps = React77.useMemo(
    () => ({
      id: menuId,
      anchorEl,
      open,
...
function NodeMenu({
  ...
  const [deletedNodeId, setDeletedNodeId] = React78.useState(null);
  const handleDeleteNodeDialogOpen = React78.useCallback(
    (event) => {
      event.stopPropagation();
  ...
  const isAction = React78.useMemo(() => {
    if (latestDeletedNode?.type === "query" && latestDeletedNode?.attributes?.mode === "mutation") {
      return true;
    }
    return false;
  }, [latestDeletedNode]);
  const handleDeleteNodeDialogClose = React78.useCallback(
    (confirmed, event) => {
      event.stopPropagation();
  ...
  const handleRenameClick = React78.useCallback(
    (event) => {
      onRenameNode?.(nodeId);
      onMenuClose(event);
    },
  ...
  const handleDuplicateClick = React78.useCallback(
    (event) => {
      onMenuClose(event);
  ...
  return /* @__PURE__ */ React78.createElement(React78.Fragment, null, renderButton({
    buttonProps,
    menuProps
    ...
    onRenameNode ? /* @__PURE__ */ React78.createElement(MenuItem7, { onClick: handleRenameClick }, /* @__PURE__ */ React78.createElement(ListItemIcon, null, /* @__PURE__ */ React78.createElement(ModeEditIcon, null)), /* @__PURE__ */ React78.createElement(ListItemText, null, renameLabelText)) : null,
    onDuplicateNode ? /* @__PURE__ */ React78.createElement(MenuItem7, { onClick: handleDuplicateClick }, /* @__PURE__ */ React78.createElement(ListItemIcon, null, /* @__PURE__ */ React78.createElement(ContentCopyIcon2, null)), /* @__PURE__ */ React78.createElement(ListItemText, null, duplicateLabelText)) : null,
    onDeleteNode ? /* @__PURE__ */ React78.createElement(MenuItem7, { onClick: handleDeleteNodeDialogOpen }, /* @__PURE__ */ React78.createElement(ListItemIcon, null, /* @__PURE__ */ React78.createElement(DeleteIcon4, null)), /* @__PURE__ */ React78.createElement(ListItemText, null, deleteLabelText)) : null
  ), /* @__PURE__ */ React78.createElement(
    ConfirmDialog,
    {
      open: !!deletedNode,
...
function EditableTreeItem({
  ...
  const [itemNameInput, setItemNameInput] = React79.useState(suggestedNewItemName);
  const [isInternalEditing, setIsInternalEditing] = React79.useState(false);
  const isEditing = isExternalEditing || isInternalEditing;
  const newItemValidationResult = React79.useMemo(
  ...
  const handleCancel = React79.useCallback(() => {
    setItemNameInput(suggestedNewItemName);
  ...
  const handleConfirm = React79.useCallback(async () => {
  ...
  const handleFocus = React79.useCallback((event) => {
    event.target.select();
    event.stopPropagation();
  }, []);
  ...
  const handleKeyDown = React79.useCallback(
    (event) => {
      event.stopPropagation();
      if (event.key === "Enter") {
        handleConfirm();
  ...
  return /* @__PURE__ */ React79.createElement(
    TreeItem,
    {
      ...
      onClick: handleClick,
      label: renderLabel(
        isEditing ? /* @__PURE__ */ React79.createElement(React79.Fragment, null, /* @__PURE__ */ React79.createElement(
          InputBase2,
          {
            ...inputProps,
            ref: inputRef,
            ...
            fullWidth: true,
            disabled: isLoading,
            endAdornment: isLoading ? /* @__PURE__ */ React79.createElement(CircularProgress3, { size: 14 }) : null,
            sx: {
              ...inputProps?.sx || {},
              ...labelTextSx,
              padding: 0
        ...
        ), inputErrorPopoverAnchorEl ? /* @__PURE__ */ React79.createElement(
          Popover2,
          {
          ...
          validationErrorMessage ? /* @__PURE__ */ React79.createElement(Alert8, { severity: "error", variant: "outlined" }, validationErrorMessage) : null
        ) : null) : /* @__PURE__ */ React79.createElement(
          Typography14,
          {
            variant: "body2",
            sx: {
      ...
      sx: isEditing ? {
        ...sx,
        "> .MuiTreeItem-content": {
          backgroundColor: alpha2(theme.palette.primary.main, 0.2)
        }
      } : sx
    }
  );
...
var ExplorerHeaderContainer = styled27(Stack14)(({ theme }) => ({
  backgroundColor: theme.palette.background.paper,
  width: "100%",
  height: 36
}));
var ExplorerHeaderTitle = styled27(Typography15)(({ theme }) => ({
  fontSize: 13,
  flexGrow: 1,
...
function ExplorerHeader({
  ...
  const [isSearching, setIsSearching] = React80.useState(hasPersistentSearch);
  const [searchTerm, setSearchTerm] = React80.useState("");
  const handleSearchClick = React80.useCallback(() => {
    if (isSearching && searchTerm) {
      setSearchTerm("");
    }
    setIsSearching((previousIsSearching) => !previousIsSearching);
  }, [isSearching, searchTerm]);
  const handleSearchChange = React80.useCallback((event) => {
  ...
  return /* @__PURE__ */ React80.createElement(
    ...
    isSearching ? /* @__PURE__ */ React80.createElement(
      TextField18,
      {
        hiddenLabel: true,
        value: searchTerm,
        ...
        InputProps: {
          startAdornment: hasPersistentSearch ? /* @__PURE__ */ React80.createElement(InputAdornment5, { position: "start" }, /* @__PURE__ */ React80.createElement(SearchIcon, { fontSize: "small", sx: { mt: "-4px" } })) : null,
    ...
    ) : /* @__PURE__ */ React80.createElement(React80.Fragment, null, headerIcon, /* @__PURE__ */ React80.createElement(
      ExplorerHeaderTitle,
      {
        variant: "body2",
        sx: {
    ...
    onSearch && searchLabelText && !hasPersistentSearch ? /* @__PURE__ */ React80.createElement(Tooltip10, { title: searchLabelText }, /* @__PURE__ */ React80.createElement(IconButton13, { "aria-label": searchLabelText, size: "medium", onClick: handleSearchClick }, /* @__PURE__ */ React80.createElement(SearchIcon, { color: isSearching ? "primary" : "inherit" }))) : null,
    onCreate && createLabelText ? /* @__PURE__ */ React80.createElement(Tooltip10, { title: createLabelText }, /* @__PURE__ */ React80.createElement(IconButton13, { "aria-label": createLabelText, size: "medium", onClick: onCreate }, /* @__PURE__ */ React80.createElement(AddIcon3, null))) : null
  );
}

// src/toolpad/AppEditor/PagesExplorer/index.tsx
var PagesExplorerRoot = styled28(Stack15)({
  height: "100%",
  width: "100%"
});
var classes7 = {
...
var StyledEditableTreeItem = styled28(EditableTreeItem)({
...
function PagesExplorerTreeItem(props) {
  ...
  const handleRenameConfirm = React81.useCallback(
    (updatedName) => {
      if (onRenameNode) {
        onRenameNode(nodeId, updatedName);
        stopEditing();
      }
    },
    [nodeId, onRenameNode, stopEditing]
  );
  const validateEditablePageName = React81.useCallback(
    (newName) => {
  ...
  return /* @__PURE__ */ React81.createElement(
    StyledEditableTreeItem,
    {
      nodeId,
      labelText,
      renderLabel: (children) => /* @__PURE__ */ React81.createElement(Tooltip11, { title, placement: "right", disableInteractive: true }, /* @__PURE__ */ React81.createElement(Box22, { sx: { display: "flex", alignItems: "center" } }, labelIcon, children, toolpadNodeId ? /* @__PURE__ */ React81.createElement(
        NodeMenu,
        {
          renderButton: ({ buttonProps, menuProps }) => /* @__PURE__ */ React81.createElement(
            ...
            /* @__PURE__ */ React81.createElement(MoreVertIcon, { fontSize: "inherit" })
          ),
...
function PagesExplorer({ className }) {
  ...
  const existingNames = React81.useMemo(
  ...
  const pagesTreeRef = React81.useRef(null);
  const [hasMounted, setHasMounted] = React81.useState(false);
  React81.useEffect(() => {
    setHasMounted(true);
  }, []);
  React81.useEffect(() => {
  ...
  const nextProposedName = React81.useMemo(
    () => appDom23.proposeName(DEFAULT_NEW_PAGE_NAME, existingNames),
    [existingNames]
  );
  const handleCreateNewCommit = React81.useCallback(
    async (newPageName) => {
  ...
  const validatePageName = React81.useCallback(
    (pageName) => {
  ...
  const handleDeletePage = React81.useCallback(
    async (nodeId) => {
  ...
  const handleRenameNode = React81.useCallback(
    (nodeId, updatedName) => {
      appStateApi.update(
        (draft) => {
  ...
  const handleDuplicateNode = React81.useCallback(
    (nodeId) => {
  ...
  const alphabeticSortedPages = React81.useMemo(
    () => [...pages].sort(createPropComparator("name", alphabeticComparator)),
    [pages]
  );
  return /* @__PURE__ */ React81.createElement(PagesExplorerRoot, { "data-testid": "pages-explorer", direction: "column", className }, /* @__PURE__ */ React81.createElement(
    ExplorerHeader,
    {
      headerText: "Pages",
    ...
    TreeView,
    {
      ...
      multiSelect: true,
      defaultCollapseIcon: /* @__PURE__ */ React81.createElement(ExpandMoreIcon2, { sx: { fontSize: "0.9rem", opacity: 0.5 } }),
      defaultExpandIcon: /* @__PURE__ */ React81.createElement(ChevronRightIcon, { sx: { fontSize: "0.9rem", opacity: 0.5 } }),
      sx: {
        overflow: "auto",
        scrollbarGutter: "stable"
      }
    },
    isCreateNewPageOpen ? /* @__PURE__ */ React81.createElement(
      EditableTreeItem,
      {
        nodeId: "::create::",
        isEditing: true,
    ...
    alphabeticSortedPages.map((page) => /* @__PURE__ */ React81.createElement(
...
import { Box as Box23, Typography as Typography16 } from "@mui/material";
import { TreeView as TreeView2, TreeItem as TreeItem2 } from "@mui/x-tree-view";
import ExpandMoreIcon3 from "@mui/icons-material/ExpandMore";
import ChevronRightIcon2 from "@mui/icons-material/ChevronRight";
import useBoolean3 from "@mui/toolpad-utils/hooks/useBoolean";
import * as appDom24 from "@mui/toolpad-core/appDom";
function CustomTreeItem(props) {
  const domApi = useDomApi();
  const { dom } = useAppState();
  const appStateApi = useAppStateApi();
  const { label, node, ...other } = props;
  const { value: domNodeEditing, setFalse: stopDomNodeEditing } = useBoolean3(false);
  const existingNames = React82.useMemo(() => appDom24.getExistingNamesForNode(dom, node), [dom, node]);
  const validateEditableNodeName = React82.useCallback(
    (newName) => {
  ...
  const handleNameSave = React82.useCallback(
    (newName) => {
      domApi.setNodeName(node.id, newName);
    },
    [domApi, node.id]
  );
  const handleNodeHover = React82.useCallback(
    (event, nodeId) => {
      appStateApi.hoverNode(nodeId);
    },
    [appStateApi]
  );
  const handleNodeBlur = React82.useCallback(() => {
  ...
  return /* @__PURE__ */ React82.createElement(
    EditableTreeItem,
    {
      key: node.id,
      labelText: node.name,
      renderLabel: (children) => /* @__PURE__ */ React82.createElement(
        Box23,
        {
...
function RecursiveSubTree({ dom, root }) {
  const { children = [], renderItem = [] } = React82.useMemo(
    () => appDom24.getChildNodes(dom, root),
    [dom, root]
  );
  if (children.length > 0) {
    return /* @__PURE__ */ React82.createElement(CustomTreeItem, { nodeId: root.id, node: root }, children.map((childNode) => /* @__PURE__ */ React82.createElement(RecursiveSubTree, { key: childNode.id, dom, root: childNode })));
  }
  if (renderItem.length > 0) {
    return /* @__PURE__ */ React82.createElement(
      CustomTreeItem,
      {
        nodeId: root.id,
        node: root,
        label: /* @__PURE__ */ React82.createElement(Typography16, { variant: "body2" }, root.name)
      },
      /* @__PURE__ */ React82.createElement(
        TreeItem2,
        {
          nodeId: `${root.id}-renderItem`,
          label: /* @__PURE__ */ React82.createElement(Typography16, { variant: "body2" }, "renderItem")
        },
        renderItem.map((childNode) => /* @__PURE__ */ React82.createElement(RecursiveSubTree, { key: childNode.id, dom, root: childNode }))
      )
    );
  }
  return /* @__PURE__ */ React82.createElement(CustomTreeItem, { nodeId: root.id, node: root });
}
function HierarchyExplorer() {
  const { dom, currentView } = useAppState();
  const appStateApi = useAppStateApi();
  const [expandedDomNodeIds, setExpandedDomNodeIds] = React82.useState([]);
  ...
  const selectedNodeAncestorIds = React82.useMemo(() => {
  ...
  const { children: rootChildren = [] } = React82.useMemo(() => {
    if (!currentPageNode) {
      return { children: [] };
    }
    return appDom24.getChildNodes(dom, currentPageNode);
  }, [dom, currentPageNode]);
  const handleNodeSelect = React82.useCallback(
    (event, nodeId) => {
      appStateApi.selectNode(nodeId);
    },
    [appStateApi]
  );
  const handleNodeFocus = React82.useCallback(
    (event, nodeId) => {
      appStateApi.hoverNode(nodeId);
    },
    [appStateApi]
  );
  const handleNodeToggle = React82.useCallback(
    (event, nodeIds) => {
      setExpandedDomNodeIds(nodeIds);
    },
    [setExpandedDomNodeIds]
  );
  const deleteNode = React82.useCallback(() => {
    if (!selectedDomNodeId) {
      return;
    }
    appStateApi.update(
  ...
  const expandedDomNodeIdSet = React82.useMemo(() => {
    return /* @__PURE__ */ new Set([...selectedNodeAncestorIds, ...expandedDomNodeIds]);
  }, [selectedNodeAncestorIds, expandedDomNodeIds]);
  return /* @__PURE__ */ React82.createElement(React82.Fragment, null, /* @__PURE__ */ React82.createElement(ExplorerHeader, { headerText: "Page hierarchy" }), /* @__PURE__ */ React82.createElement(
    TreeView2,
    {
      "aria-label": "Page hierarchy explorer",
      defaultCollapseIcon: /* @__PURE__ */ React82.createElement(ExpandMoreIcon3, { sx: { fontSize: "0.9rem", opacity: 0.5 } }),
      defaultExpandIcon: /* @__PURE__ */ React82.createElement(ChevronRightIcon2, { sx: { fontSize: "0.9rem", opacity: 0.5 } }),
    ...
    rootChildren.map((childNode) => /* @__PURE__ */ React82.createElement(RecursiveSubTree, { key: childNode.id, dom, root: childNode }))
  ));
}
...
import IconButton15 from "@mui/material/IconButton";
import MoreVertIcon2 from "@mui/icons-material/MoreVert";
import CodeIcon2 from "@mui/icons-material/Code";
import useBoolean4 from "@mui/toolpad-utils/hooks/useBoolean";
...
function AppExportDialog({ open, onClose, dom }) {
  const dialogTitleId = React83.useId();
  return /* @__PURE__ */ React83.createElement(Dialog7, { "aria-labelledby": dialogTitleId, fullWidth: true, maxWidth: "sm", open, onClose }, /* @__PURE__ */ React83.createElement(DialogTitle7, { id: dialogTitleId }, "Application DOM"), /* @__PURE__ */ React83.createElement(DialogContent7, { sx: { position: "relative", display: "flex", alignItems: "stretch" } }, /* @__PURE__ */ React83.createElement(JsonView, { sx: { flex: 1 }, copyToClipboard: true, src: dom, expandPaths: [], expandLevel: 5 })), /* @__PURE__ */ React83.createElement(DialogActions7, null, /* @__PURE__ */ React83.createElement(Button11, { onClick: onClose }, "Close")));
}
...
function AppOptions({ dom }) {
  ...
  const handleAppExportClick = React84.useCallback(() => {
    onMenuClose();
    handleOpenAppExport();
  }, [handleOpenAppExport, onMenuClose]);
  return /* @__PURE__ */ React84.createElement(React84.Fragment, null, /* @__PURE__ */ React84.createElement(IconButton15, { ...buttonProps, "aria-label": "Application menu" }, /* @__PURE__ */ React84.createElement(MoreVertIcon2, null)), /* @__PURE__ */ React84.createElement(Menu2, { ...menuProps }, /* @__PURE__ */ React84.createElement(Divider8, null), dom ? /* @__PURE__ */ React84.createElement(MenuItem8, { onClick: handleAppExportClick }, /* @__PURE__ */ React84.createElement(ListItemIcon2, null, /* @__PURE__ */ React84.createElement(CodeIcon2, null)), /* @__PURE__ */ React84.createElement(ListItemText2, null, "View DOM")) : null), dom ? /* @__PURE__ */ React84.createElement(AppExportDialog_default, { open: appExportOpen, onClose: handleCloseAppExport, dom }) : null);
}
...
import { TreeView as TreeView3, treeItemClasses as treeItemClasses2 } from "@mui/x-tree-view";
...
import useBoolean5 from "@mui/toolpad-utils/hooks/useBoolean";
import * as appDom25 from "@mui/toolpad-core/appDom";
var classes8 = {
  treeItemMenuButton: "Toolpad__QueryListItem",
  treeItemMenuOpen: "Toolpad__QueryListItemMenuOpen"
};
var StyledTreeItem = styled29(EditableTreeItem)({
  [`& .${classes8.treeItemMenuButton}`]: {
    visibility: "hidden"
  },
  [`
  & .${treeItemClasses2.content}:hover .${classes8.treeItemMenuButton},
      & .${classes8.treeItemMenuOpen}
    `]: {
    visibility: "visible"
  }
});
function DataTreeItem(props) {
  ...
  const handleRenameConfirm = React85.useCallback(
    (updatedName) => {
      if (onRenameNode) {
        onRenameNode(nodeId, updatedName);
        stopEditing();
  ...
  const validateEditableQueryName = React85.useCallback(
    (newName) => {
      if (newName !== labelText && validateItemName) {
        return validateItemName(newName);
      }
  ...
  const queryCreationMode = React85.useMemo(() => {
  ...
  return /* @__PURE__ */ React85.createElement(
    StyledTreeItem,
    {
      nodeId,
      labelText,
      renderLabel: (children) => /* @__PURE__ */ React85.createElement(Box24, { sx: { display: "flex", alignItems: "center" }, onClick: handleClick }, /* @__PURE__ */ React85.createElement(QueryIcon, { id: labelIconId || "query", sx: { fontSize: 24, my: 0, ...labelIconSx } }), children, onCreate ? /* @__PURE__ */ React85.createElement(
        IconButton16,
        {
        ...
        /* @__PURE__ */ React85.createElement(AddIcon4, { fontSize: "inherit" })
      ) : null, toolpadNodeId ? /* @__PURE__ */ React85.createElement(
        NodeMenu,
        {
          renderButton: ({ buttonProps, menuProps }) => /* @__PURE__ */ React85.createElement(
            IconButton16,
            {
            ...
            /* @__PURE__ */ React85.createElement(MoreVertIcon3, { fontSize: "inherit" })
          ),
          nodeId: toolpadNodeId,
          deleteLabelText,
          duplicateLabelText,
...
function CreatePopover({
  ...
  return /* @__PURE__ */ React85.createElement(
    ...
    /* @__PURE__ */ React85.createElement(Paper, { sx: { p: 2, maxWidth: 500 } }, /* @__PURE__ */ React85.createElement(Typography17, { variant: "body2", sx: { mb: 2, textAlign: "center" } }, createMode === "query" ? "Make backend data available as state on the page" : "Run an action on the page"), /* @__PURE__ */ React85.createElement(Stack16, { direction: "row", gap: 1, display: "grid", gridTemplateColumns: "1fr 1fr" }, Object.keys(client_default3).map((dataSourceId) => {
      ...
      return /* @__PURE__ */ React85.createElement(
        ...
        /* @__PURE__ */ React85.createElement(QueryIcon, { id: dataSourceId, sx: { fontSize: 28 } }),
        " ",
...
function Explorer({ nodes, setAnchorEl, nodeName, headerText }) {
  ...
  const handleQuerySelect = React85.useCallback(
    (selectedQueryId) => {
      appStateApi.openQueryTab(selectedQueryId);
    },
    [appStateApi]
  );
  const handleCreateClick = React85.useCallback(
    (event) => {
      event.stopPropagation();
      setAnchorEl(event.currentTarget);
    },
  ...
  const handleDeleteNode = React85.useCallback(
    (selectedQueryId) => {
  ...
  const existingNames = React85.useMemo(() => {
    if (!currentPageName) {
      return void 0;
    }
  ...
  const handleDuplicateNode = React85.useCallback(
    (nodeId) => {
  ...
  const validateName = React85.useCallback(
    (queryName) => {
      if (!existingNames) {
        return {
          isValid: true
  ...
  const handleRenameNode = React85.useCallback(
    (nodeId, updatedName) => {
      const node = appDom25.getNode(dom, nodeId, "query");
  ...
  return /* @__PURE__ */ React85.createElement(Stack16, { "data-testid": `${nodeName}-explorer`, sx: { height: "100%", width: "100%" } }, /* @__PURE__ */ React85.createElement(
    ExplorerHeader,
    {
      headerIcon: /* @__PURE__ */ React85.createElement(QueryIcon, { mode: nodeName }),
      headerText,
    ...
    TreeView3,
    {
      ...
      selected: currentView.kind === "page" && currentView.view?.kind === "query" ? currentView.view.nodeId : "",
      defaultCollapseIcon: /* @__PURE__ */ React85.createElement(ExpandMoreIcon4, { sx: { fontSize: "0.9rem", opacity: 0.5 } }),
      defaultExpandIcon: /* @__PURE__ */ React85.createElement(ChevronRightIcon3, { sx: { fontSize: "0.9rem", opacity: 0.5 } }),
      sx: {
        flexGrow: 1,
        maxWidth: 400,
        overflowY: "auto",
    ...
    nodes.map((node) => /* @__PURE__ */ React85.createElement(
      DataTreeItem,
      {
        key: node.id,
        nodeId: node.id,
...
function QueriesExplorer() {
  ...
  const appStateApi = useAppStateApi();
  const currentPageName = currentView.name;
  const queryNodes = React85.useMemo(() => {
    if (!currentPageName) {
      return [];
    }
    if (currentPageName) {
  ...
  const handleCreateNode = React85.useCallback(
    (dataSourceId) => () => {
      const dataSource3 = client_default3[dataSourceId];
  ...
  return /* @__PURE__ */ React85.createElement(React85.Fragment, null, /* @__PURE__ */ React85.createElement(Explorer, { nodes: queries, setAnchorEl, headerText: "Queries", nodeName: "query" }), /* @__PURE__ */ React85.createElement(
    CreatePopover,
    {
      anchorEl,
      createPopoverOpen,
...
function ActionsExplorer() {
  ...
  return /* @__PURE__ */ React85.createElement(React85.Fragment, null, /* @__PURE__ */ React85.createElement(Explorer, { nodes: actions, setAnchorEl, headerText: "Actions", nodeName: "action" }), /* @__PURE__ */ React85.createElement(
    CreatePopover,
    {
      anchorEl,
      createPopoverOpen,
...
function PagePanel({ className, sx }) {
  ...
  return /* @__PURE__ */ React86.createElement(PagePanelRoot, { className, sx }, /* @__PURE__ */ React86.createElement(
    Box25,
    {
      sx: {
        pl: 2,
    ...
    /* @__PURE__ */ React86.createElement(Typography18, { noWrap: true }, project.rootDir.split(/[/\\]/).pop()),
    /* @__PURE__ */ React86.createElement(AppOptions_default, { dom })
  ), /* @__PURE__ */ React86.createElement(Divider9, null), /* @__PURE__ */ React86.createElement(resizablePanels_exports.PanelGroup, { autoSaveId: "toolpad-page-panel", direction: "vertical" }, /* @__PURE__ */ React86.createElement(resizablePanels_exports.Panel, { id: "pages-explorer", order: 1, minSize: 10, defaultSize: 30 }, /* @__PURE__ */ React86.createElement(PagesExplorer, null)), currentPageNode && !appDom26.isCodePage(currentPageNode) ? /* @__PURE__ */ React86.createElement(React86.Fragment, null, /* @__PURE__ */ React86.createElement(PanelResizeHandle, null), /* @__PURE__ */ React86.createElement(resizablePanels_exports.Panel, { id: "hierarchy-explorer", order: 2, minSize: 25, maxSize: 90 }, /* @__PURE__ */ React86.createElement(HierarchyExplorer, null)), /* @__PURE__ */ React86.createElement(PanelResizeHandle, null), /* @__PURE__ */ React86.createElement(resizablePanels_exports.Panel, { id: "queries-explorer", order: 3, minSize: 10, defaultSize: 25, maxSize: 90 }, /* @__PURE__ */ React86.createElement(QueriesExplorer, null)), /* @__PURE__ */ React86.createElement(PanelResizeHandle, null), /* @__PURE__ */ React86.createElement(resizablePanels_exports.Panel, { id: "actions-explorer", order: 4, minSize: 10, defaultSize: 25, maxSize: 90 }, /* @__PURE__ */ React86.createElement(ActionsExplorer, null))) : null));
}
...
var MarkdownEditor = lazyComponent(() => import("./MarkdownEditor-ICGZ4PD5.mjs"), {
  noSsr: true,
  fallback: /* @__PURE__ */ React87.createElement(Skeleton4, { variant: "rectangular", height: "100%" })
});
function MarkdownPropEditor({ propType, value, onChange }) {
  const [dialogOpen, setDialogOpen] = React87.useState(false);
  useShortcut({ key: "s", metaKey: true, disabled: !dialogOpen }, () => {
    setDialogOpen(false);
  });
  return /* @__PURE__ */ React87.createElement(React87.Fragment, null, /* @__PURE__ */ React87.createElement(PropertyControl, { propType }, /* @__PURE__ */ React87.createElement(Button13, { variant: "outlined", color: "inherit", fullWidth: true, onClick: () => setDialogOpen(true) }, "Edit Markdown")), /* @__PURE__ */ React87.createElement(Dialog8, { fullWidth: true, open: dialogOpen, onClose: () => setDialogOpen(false) }, /* @__PURE__ */ React87.createElement(DialogTitle8, null, "Edit Markdown"), /* @__PURE__ */ React87.createElement(DialogContent8, null, /* @__PURE__ */ React87.createElement(Box26, { sx: { height: 200 } }, /* @__PURE__ */ React87.createElement(MarkdownEditor, { value, onChange: (newValue = "") => onChange(newValue) }))), /* @__PURE__ */ React87.createElement(DialogActions8, null, /* @__PURE__ */ React87.createElement(Button13, { color: "inherit", variant: "text", onClick: () => setDialogOpen(false) }, "Done"))));
}
...
function useImmediateTextField(props) {
  ...
  const createInputState = React88.useCallback(
    (rawInput) => {
  ...
  const [state, setState] = React88.useState(createInputState(value));
  React88.useEffect(() => {
...
function GridColumnEditor({
  ...
  const toolpadComponents = useToolpadComponents();
  const codeComponents = React88.useMemo(() => {
  ...
  return /* @__PURE__ */ React88.createElement(Stack17, { gap: 1, py: 1 }, /* @__PURE__ */ React88.createElement(TextField19, { ...fieldInput }), /* @__PURE__ */ React88.createElement(
    TextField19,
    {
      label: "header",
    ...
    ALIGNMENTS.map((alignment) => /* @__PURE__ */ React88.createElement(MenuItem9, { key: alignment, value: alignment }, alignment))
  ), /* @__PURE__ */ React88.createElement(
    TextField19,
    {
      label: "width",
    ...
    COLUMN_TYPES.map((type) => /* @__PURE__ */ React88.createElement(MenuItem9, { key: type, value: type }, type))
  ), /* @__PURE__ */ React88.createElement(
    FormControlLabel4,
    {
      control: /* @__PURE__ */ React88.createElement(
        Checkbox5,
        {
  ...
  ), /* @__PURE__ */ React88.createElement(Box27, { sx: { ml: 1, pl: 1, borderLeft: 1, borderColor: "divider" } }, editedColumn.type === "number" ? /* @__PURE__ */ React88.createElement(
    NumberFormatEditor,
    {
      disabled,
  ...
  ) : null, editedColumn.type === "date" ? /* @__PURE__ */ React88.createElement(
    DateFormatEditor,
    {
      disabled,
  ...
  ) : null, editedColumn.type === "dateTime" ? /* @__PURE__ */ React88.createElement(
    DateFormatEditor,
    {
      disabled,
  ...
  ) : null, editedColumn.type === "codeComponent" ? /* @__PURE__ */ React88.createElement(
    TextField19,
    {
      select: true,
      required: true,
    ...
    codeComponents.map(({ displayName }) => /* @__PURE__ */ React88.createElement(MenuItem9, { key: displayName, value: displayName }, displayName))
  ) : null));
}
function GridColumnsPropEditor({
  ...
  const [editedIndex, setEditedIndex] = React88.useState(null);
  const editedColumn = typeof editedIndex === "number" ? value[editedIndex] : null;
  const [menuAnchorEl, setMenuAnchorEl] = React88.useState(null);
  ...
  const inferredColumns = React88.useMemo(
    () => inferColumns(Array.isArray(rawRows) ? rawRows : []),
    [rawRows]
  );
  const columnSuggestions = React88.useMemo(() => {
  ...
  const handleCreateColumn = React88.useCallback(
    (suggestion) => () => {
      const existingFields = new Set(value.map(({ field }) => field));
  ...
  const handleColumnItemClick = React88.useCallback(
    (index) => () => {
      setEditedIndex(index);
    },
    []
  );
  const handleColumnChange = React88.useCallback(
    (newValue) => {
      onChange(value.map((column, i) => i === editedIndex ? newValue : column));
    },
    [editedIndex, onChange, value]
  );
  const handleColumnDelete = React88.useCallback(
    (deletedIndex) => (event) => {
      event.stopPropagation();
  ...
  const handleRecreateColumns = React88.useCallback(() => {
  ...
  const open = Boolean(anchorEl);
  const popoverIdValue = React88.useId();
  ...
  return /* @__PURE__ */ React88.createElement(React88.Fragment, null, /* @__PURE__ */ React88.createElement(PropertyControl, { propType }, /* @__PURE__ */ React88.createElement(Button14, { "aria-describedby": popoverId, onClick: handlePopoverClick }, label)), /* @__PURE__ */ React88.createElement(
    Popover4,
    {
      id: popoverId,
      open,
    ...
    /* @__PURE__ */ React88.createElement(Box27, { sx: { minWidth: 300, p: 2 } }, editedColumn ? /* @__PURE__ */ React88.createElement(React88.Fragment, null, /* @__PURE__ */ React88.createElement(IconButton17, { "aria-label": "Back", onClick: () => setEditedIndex(null) }, /* @__PURE__ */ React88.createElement(ArrowBackIcon, null)), /* @__PURE__ */ React88.createElement(
      GridColumnEditor,
      {
        value: editedColumn,
        onChange: handleColumnChange,
    ...
    )) : /* @__PURE__ */ React88.createElement(React88.Fragment, null, /* @__PURE__ */ React88.createElement(Tooltip12, { describeChild: true, title: "Recreate columns" }, /* @__PURE__ */ React88.createElement("span", null, /* @__PURE__ */ React88.createElement(
      IconButton17,
      {
      ...
      /* @__PURE__ */ React88.createElement(RefreshIcon, null)
    ))), /* @__PURE__ */ React88.createElement(Tooltip12, { title: "Add column" }, /* @__PURE__ */ React88.createElement(IconButton17, { onClick: handleMenuClick, disabled }, /* @__PURE__ */ React88.createElement(AddIcon5, null))), /* @__PURE__ */ React88.createElement(
      Menu3,
      {
        id: "new-column-menu",
      ...
      columnSuggestions.map((suggestion) => /* @__PURE__ */ React88.createElement(MenuItem9, { key: suggestion.field, onClick: handleCreateColumn(suggestion) }, suggestion.field)),
      /* @__PURE__ */ React88.createElement(MenuItem9, { onClick: handleCreateColumn({ field: "new" }) }, "New column")
    ), /* @__PURE__ */ React88.createElement(List, null, value.map((colDef, i) => {
      return /* @__PURE__ */ React88.createElement(
        ListItem,
        {
          ...
          secondaryAction: /* @__PURE__ */ React88.createElement(
            IconButton17,
            {
            ...
            /* @__PURE__ */ React88.createElement(DeleteIcon5, null)
          )
        },
        /* @__PURE__ */ React88.createElement(ListItemButton, null, /* @__PURE__ */ React88.createElement(ListItemText3, { primary: colDef.headerName || colDef.field }))
      );
    }))))
  ));
}
...
function SelectPropEditor2({ label, propType, value, onChange, disabled }) {
  const items = propType.type === "string" ? propType.enum ?? [] : [];
  const handleChange = React89.useCallback(
    (event, newValue) => {
  ...
  const enumLabels = propType.type === "string" ? propType.enumLabels ?? {} : {};
  return /* @__PURE__ */ React89.createElement(PropertyControl, { propType }, /* @__PURE__ */ React89.createElement(Box28, { sx: { my: 0.5 } }, /* @__PURE__ */ React89.createElement(Typography19, { variant: "body2" }, label), /* @__PURE__ */ React89.createElement(
    ...
    items.map((item) => /* @__PURE__ */ React89.createElement(ToggleButton3, { key: item, value: item }, enumLabels[item] || item))
  )));
}
...
function SelectOptionsPropEditor({
  ...
  const [editOptionsDialogOpen, setEditOptionsDialogOpen] = React90.useState(false);
  const optionInputRef = React90.useRef(null);
  const [editingIndex, setEditingIndex] = React90.useState(null);
  const editingOption = React90.useMemo(() => {
  ...
  const handleOptionTextInput = React90.useCallback(
    (event) => {
      if (event.key === "Enter") {
  ...
  const handleOptionDelete = React90.useCallback(
    (deletedIndex) => (event) => {
      event.stopPropagation();
      onChange(value.filter((column, i) => i !== deletedIndex));
    },
  ...
  const handleDeleteAll = React90.useCallback(() => {
    onChange([]);
  }, [onChange]);
  const handleOptionItemClick = React90.useCallback(
    (index) => () => {
      setEditingIndex(index);
    },
    []
  );
  const handleOptionChange = React90.useCallback(
    (newOption) => {
  ...
  const handleEditOptionsDialogClose = React90.useCallback(() => {
    setEditingIndex(null);
    setEditOptionsDialogOpen(false);
  }, []);
  return /* @__PURE__ */ React90.createElement(React90.Fragment, null, /* @__PURE__ */ React90.createElement(PropertyControl, { propType }, /* @__PURE__ */ React90.createElement(
    Button15,
    {
      variant: "outlined",
      color: "inherit",
    ...
    editingOption ? /* @__PURE__ */ React90.createElement(React90.Fragment, null, /* @__PURE__ */ React90.createElement(DialogTitle9, null, /* @__PURE__ */ React90.createElement(IconButton18, { "aria-label": "Back", onClick: () => setEditingIndex(null) }, /* @__PURE__ */ React90.createElement(ArrowBackIcon2, null)), "Edit option \u201C", editingOption.value, "\u201D"), /* @__PURE__ */ React90.createElement(DialogContent9, null, /* @__PURE__ */ React90.createElement(Stack18, { gap: 1, py: 1 }, /* @__PURE__ */ React90.createElement(
      TextField20,
      {
        label: "Value",
    ...
    )))) : /* @__PURE__ */ React90.createElement(React90.Fragment, null, /* @__PURE__ */ React90.createElement(DialogTitle9, null, "Edit options", value.length > 0 ? /* @__PURE__ */ React90.createElement(
      Button15,
      {
      ...
      "Delete All"
    ) : null), /* @__PURE__ */ React90.createElement(DialogContent9, null, value.length > 0 ? /* @__PURE__ */ React90.createElement(List2, null, value.map((option, i) => {
      return /* @__PURE__ */ React90.createElement(
        ListItem2,
        {
          ...
          secondaryAction: /* @__PURE__ */ React90.createElement(
            IconButton18,
            {
            ...
            /* @__PURE__ */ React90.createElement(DeleteIcon6, null)
          )
        },
        /* @__PURE__ */ React90.createElement(ListItemButton2, null, /* @__PURE__ */ React90.createElement(
          ListItemText4,
          {
      ...
      TextField20,
      {
        ...
        label: "Add option",
        helperText: /* @__PURE__ */ React90.createElement("span", null, "Press ", /* @__PURE__ */ React90.createElement("kbd", null, "Enter"), " or ", /* @__PURE__ */ React90.createElement("kbd", null, "Return"), " to add")
      }
    ))),
    /* @__PURE__ */ React90.createElement(DialogActions9, null, /* @__PURE__ */ React90.createElement(Button15, { color: "inherit", variant: "text", onClick: handleEditOptionsDialogClose }, "Close"))
  ));
}
...
import { useBrowserJsRuntime as useBrowserJsRuntime4 } from "@mui/toolpad-core/jsBrowserRuntime";
...
import { evaluateBindable as evaluateBindable2 } from "@mui/toolpad-core/jsRuntime";
import { blueberryTwilightPalette } from "@mui/x-charts/colorPalettes";
import { updateArray, remove } from "@mui/toolpad-utils/immutability";
import * as appDom27 from "@mui/toolpad-core/appDom";

// src/components/ColorPicker.tsx
import { Box as Box29, IconButton as IconButton19, InputAdornment as InputAdornment6, Popover as Popover5, TextField as TextField21 } from "@mui/material";
import * as React91 from "react";
function ColorPickerIconButton({ label, value, onChange }) {
  const [anchorEl, setAnchorEl] = React91.useState(null);
  const handleClick = (event) => {
    setAnchorEl(event.currentTarget);
  };
  const handleClose = () => {
  ...
  const open = Boolean(anchorEl);
  const id = React91.useId();
  return /* @__PURE__ */ React91.createElement(React91.Fragment, null, /* @__PURE__ */ React91.createElement(IconButton19, { "aria-label": "select color", edge: "end", onClick: handleClick }, /* @__PURE__ */ React91.createElement(
    Box29,
    {
      sx: {
        background: value,
    ...
    /* @__PURE__ */ React91.createElement(ColorTool_default, { sx: { m: 2 }, label, value, onChange })
  ));
}
function ColorPicker({ label, value, onChange }) {
  return /* @__PURE__ */ React91.createElement(
    TextField21,
    {
      ...
      onChange: (event) => onChange?.(event.target.value),
      InputProps: {
        endAdornment: /* @__PURE__ */ React91.createElement(InputAdornment6, { position: "end" }, /* @__PURE__ */ React91.createElement(ColorPickerIconButton, { value, onChange, label }))
      }
    }
  );
}
...
function ChartDataPropEditor({
  ...
  const appTheme = React92.useMemo(() => createToolpadAppTheme(dom), [dom]);
  const defaultPalette = blueberryTwilightPalette(appTheme.palette.mode);
  const [dataSeriesEditIndex, setDataSeriesEditIndex] = React92.useState(null);
  const [popoverAnchorElement, setPopoverAnchorElement] = React92.useState(null);
  const handleAddDataSeries = React92.useCallback(() => {
  ...
  const previousDataSeriesCountRef = React92.useRef(value.length);
  React92.useEffect(() => {
  ...
  const handleDataSeriesClick = React92.useCallback(
    (index) => (event) => {
  ...
  const handleDuplicateDataSeries = React92.useCallback(
    (index) => () => {
      const newDataSeriesCount = value.length + 1;
      onChange([
  ...
  const handleRemoveDataSeries = React92.useCallback(
    (index) => () => {
      onChange(remove(value, index));
    },
    [onChange, value]
  );
  const popoverId = React92.useId();
  const isPopoverOpen = Boolean(popoverAnchorElement);
  const handlePopoverClose = React92.useCallback(() => {
    setPopoverAnchorElement(null);
  }, []);
  const updateDataSeriesProp = React92.useCallback(
  ...
  const handleDataSeriesDataChange = React92.useCallback(
    (index) => (newValue) => {
  ...
  const handleDataSeriesTextInputPropChange = React92.useCallback(
  ...
  const handleDataSeriesAutocompletePropChange = React92.useCallback(
    (index, propName) => (event, newValue) => {
      domApi.update((draft) => updateDataSeriesProp(draft, index, newValue, propName));
    },
    [domApi, updateDataSeriesProp]
  );
  const handleDataSeriesColorChange = React92.useCallback(
    (index) => (newValue) => {
      domApi.update((draft) => updateDataSeriesProp(draft, index, newValue, "color"));
    },
    [domApi, updateDataSeriesProp]
  );
  const dataSeriesKeySuggestions = React92.useMemo(
  ...
  return /* @__PURE__ */ React92.createElement(React92.Fragment, null, /* @__PURE__ */ React92.createElement(PropertyControl, { propType }, /* @__PURE__ */ React92.createElement("div", null, /* @__PURE__ */ React92.createElement(List3, { sx: { mb: 1 } }, value.map((dataSeries, index) => {
    const { label } = dataSeries;
    return /* @__PURE__ */ React92.createElement(ListItem3, { key: index, disableGutters: true }, /* @__PURE__ */ React92.createElement(
      ListItemButton3,
      {
      ...
      /* @__PURE__ */ React92.createElement(ContentCopyIcon3, null)
    ), /* @__PURE__ */ React92.createElement(
      IconButton20,
      {
      ...
      /* @__PURE__ */ React92.createElement(DeleteIcon7, null)
    ));
  })), /* @__PURE__ */ React92.createElement(
    Button16,
    {
      variant: "outlined",
      startIcon: /* @__PURE__ */ React92.createElement(AddIcon6, null),
      fullWidth: true,
    ...
    editDataSeries && dataSeriesEditIndex !== null ? /* @__PURE__ */ React92.createElement(Box30, { sx: { minWidth: 300, p: 2 } }, /* @__PURE__ */ React92.createElement(Typography20, { variant: "body1", sx: { mb: 1 } }, editDataSeries.label), /* @__PURE__ */ React92.createElement(Stack19, { gap: 1, py: 1 }, /* @__PURE__ */ React92.createElement(
      TextField22,
      {
        label: "label",
      ...
      CHART_KIND_OPTIONS.map((option) => /* @__PURE__ */ React92.createElement(MenuItem10, { key: option.kind, value: option.kind }, /* @__PURE__ */ React92.createElement(Stack19, { direction: "row", alignItems: "center" }, /* @__PURE__ */ React92.createElement(option.icon, null), /* @__PURE__ */ React92.createElement(ListItemText5, { sx: { ml: 1 } }, option.kind))))
    ), /* @__PURE__ */ React92.createElement(
      BindableEditor,
      {
...
function ColumnSelect({ propType, nodeId, ...props }) {
  ...
  const newPropType = React93.useMemo(() => {
  ...
  return /* @__PURE__ */ React93.createElement(select_default, { nodeId, ...props, propType: newPropType });
}
var RowIdFieldSelect_default = ColumnSelect;

// src/toolpad/propertyControls/HorizontalAlign.tsx
import * as React94 from "react";
import { ToggleButton as ToggleButton4, ToggleButtonGroup as ToggleButtonGroup4, Typography as Typography21 } from "@mui/material";
...
function HorizontalAlignPropEditor({
  ...
  return /* @__PURE__ */ React94.createElement(PropertyControl, { propType }, /* @__PURE__ */ React94.createElement("div", null, label ? /* @__PURE__ */ React94.createElement(Typography21, { variant: "body2" }, label, ":") : null, /* @__PURE__ */ React94.createElement(
    ToggleButtonGroup4,
    {
      exclusive: true,
      disabled,
    ...
    /* @__PURE__ */ React94.createElement(ToggleButton4, { value: "start", "aria-label": "start" }, /* @__PURE__ */ React94.createElement(AlignHorizontalLeftIcon, null)),
    /* @__PURE__ */ React94.createElement(ToggleButton4, { value: "center", "aria-label": "center" }, /* @__PURE__ */ React94.createElement(AlignHorizontalCenterIcon, null)),
    /* @__PURE__ */ React94.createElement(ToggleButton4, { value: "end", "aria-label": "end" }, /* @__PURE__ */ React94.createElement(AlignHorizontalRightIcon, null))
  )));
}
...
import { ToggleButton as ToggleButton5, ToggleButtonGroup as ToggleButtonGroup5, Typography as Typography22 } from "@mui/material";
...
function VerticalAlignPropEditor({
  ...
  return /* @__PURE__ */ React95.createElement(PropertyControl, { propType }, /* @__PURE__ */ React95.createElement("div", null, label ? /* @__PURE__ */ React95.createElement(Typography22, { variant: "body2" }, label, ":") : null, /* @__PURE__ */ React95.createElement(
    ToggleButtonGroup5,
    {
      exclusive: true,
      disabled,
    ...
    /* @__PURE__ */ React95.createElement(ToggleButton5, { value: "start", "aria-label": "start" }, /* @__PURE__ */ React95.createElement(AlignverticalTopIcon, null)),
    /* @__PURE__ */ React95.createElement(ToggleButton5, { value: "center", "aria-label": "center" }, /* @__PURE__ */ React95.createElement(AlignVerticalCenterIcon, null)),
    /* @__PURE__ */ React95.createElement(ToggleButton5, { value: "end", "aria-label": "end" }, /* @__PURE__ */ React95.createElement(AlignVerticalBottomIcon, null))
  )));
}
...
import { NumberFormatEditor as NumberFormatEditor2 } from "@mui/toolpad-core/numberFormat";
function NumberFormatPropEditor({
  ...
  return /* @__PURE__ */ React96.createElement(PropertyControl, { propType }, /* @__PURE__ */ React96.createElement("span", null, /* @__PURE__ */ React96.createElement(NumberFormatEditor2, { label, disabled, value, onChange })));
}
...
function ColorScaleListItem({
  ...
  return /* @__PURE__ */ React97.createElement(ListItem4, { ...props, sx: { ...sx, gap: 1 } }, valueLabel ? /* @__PURE__ */ React97.createElement(Typography23, null, valueLabel) : /* @__PURE__ */ React97.createElement(React97.Fragment, null, ">", /* @__PURE__ */ React97.createElement(
    Input2,
    {
      type: "number",
      value: value?.value ?? 0,
  ...
  )), /* @__PURE__ */ React97.createElement(FlexFill_default, null), /* @__PURE__ */ React97.createElement(
    ...
    /* @__PURE__ */ React97.createElement(DeleteIcon8, { fontSize: "inherit" })
  ));
}
...
function ColorScaleEditor({ value, onChange }) {
  ...
  const stopsOrder = React97.useMemo(() => getOrderedIndices(stops), [stops]);
  ...
  return /* @__PURE__ */ React97.createElement(Stack20, { spacing: 1, direction: "row" }, /* @__PURE__ */ React97.createElement(
    Box31,
    {
      sx: {
        display: "flex",
    ...
    /* @__PURE__ */ React97.createElement(Box31, { sx: { maxHeight: 300, overflow: "auto" } }, /* @__PURE__ */ React97.createElement(List4, { sx: { width: 300 } }, /* @__PURE__ */ React97.createElement(
      ColorScaleListItem,
      {
    ...
    /* @__PURE__ */ React97.createElement(Button17, { startIcon: /* @__PURE__ */ React97.createElement(AddIcon7, null), onClick: handleAddStop }, "Add Stop")
  ));
}
function ColorScaleControl({ label, propType, value, onChange }) {
  ...
  const open = Boolean(anchorEl);
  const popoverIdValue = React97.useId();
  const popoverId = open ? popoverIdValue : void 0;
  return /* @__PURE__ */ React97.createElement(React97.Fragment, null, /* @__PURE__ */ React97.createElement(PropertyControl, { propType }, /* @__PURE__ */ React97.createElement(Button17, { "aria-describedby": popoverId, onClick: handlePopoverClick }, label)), /* @__PURE__ */ React97.createElement(
    Popover7,
    {
      id: popoverId,
      open,
    ...
    /* @__PURE__ */ React97.createElement(Box31, { sx: { minWidth: 300, p: 1 } }, /* @__PURE__ */ React97.createElement(
      ColorScaleEditor,
      {
        value,
        onChange: (newValue) => {
...
import { errorFrom as errorFrom4 } from "@mui/toolpad-utils/errors";
import AddIcon8 from "@mui/icons-material/Add";
import { useMutation } from "@tanstack/react-query";
import { LoadingButton as LoadingButton6 } from "@mui/lab";
import { generateUniqueString as generateUniqueString2 } from "@mui/toolpad-utils/strings";
import { Stack as Stack21 } from "@mui/system";
var PAGINATION_DOCUMENTATION_URL = "https://mui.com/toolpad/concepts/data-providers/#pagination";
...
var DataProviderSelectorRoot = styled32("div")({
  ...
  [`&:hover .${classes9.editButton}, & .${autocompleteClasses2.focused} .${classes9.editButton}`]: {
    visibility: "visible"
  }
});
function CreateNewDataProviderDialog({
  ...
  const projectApi = useProjectApi();
  const [newName, setNewName] = React98.useState(initialName);
  React98.useEffect(() => {
    if (open) {
      setNewName(initialName);
    }
  }, [open, initialName]);
  const [options2, setOptions] = React98.useState({
  ...
  const errorMessage2 = React98.useMemo(() => {
    if (nameExists) {
  ...
  const paginationModeSelectId = React98.useId();
  return /* @__PURE__ */ React98.createElement(Dialog10, { open, onClose }, /* @__PURE__ */ React98.createElement("form", { onSubmit: handleSubmit }, /* @__PURE__ */ React98.createElement(DialogTitle10, null, "Create a new data provider"), /* @__PURE__ */ React98.createElement(DialogContent10, null, /* @__PURE__ */ React98.createElement(DialogContentText2, null, "To create a new data provider please enter the name here."), /* @__PURE__ */ React98.createElement(Stack21, { sx: { gap: 2 } }, /* @__PURE__ */ React98.createElement(
    TextField23,
    {
      autoFocus: true,
      margin: "dense",
  ...
  ), /* @__PURE__ */ React98.createElement(FormControl, null, /* @__PURE__ */ React98.createElement(FormLabel, { id: paginationModeSelectId }, "Pagination mode"), /* @__PURE__ */ React98.createElement(
    RadioGroup,
    {
      row: true,
    ...
    /* @__PURE__ */ React98.createElement(FormControlLabel5, { value: "index", control: /* @__PURE__ */ React98.createElement(Radio2, null), label: "Index based" }),
    /* @__PURE__ */ React98.createElement(FormControlLabel5, { value: "cursor", control: /* @__PURE__ */ React98.createElement(Radio2, null), label: "Cursor based" })
  ), /* @__PURE__ */ React98.createElement(FormHelperText, null, "How is your backend data paginated? By index, or by cursor? Find more about pagination modes in the", " ", /* @__PURE__ */ React98.createElement("a", { href: PAGINATION_DOCUMENTATION_URL, target: "_blank", rel: "noopener noreferrer" }, "documentation"), ".")))), /* @__PURE__ */ React98.createElement(DialogActions10, null, /* @__PURE__ */ React98.createElement(Button18, { onClick: onClose }, "Cancel"), /* @__PURE__ */ React98.createElement(
    LoadingButton6,
    {
      type: "submit",
...
function DataProviderSelector({ value, onChange }) {
  ...
  const options2 = React98.useMemo(() => {
  ...
  const autocompleteValue = React98.useMemo(() => {
  ...
  const [dialogOpen, setDialogOpen] = React98.useState(false);
  const handleClose = () => {
    setDialogOpen(false);
  };
  const [dialogValue, setDialogValue] = React98.useState("");
  const existingNames = React98.useMemo(
    () => new Set(introspection?.files.map((file) => getProviderNameFromFile(file))),
    [introspection]
  );
  const handleCreateNewDataProvider = React98.useCallback((suggestion) => {
    setDialogValue(suggestion);
    setDialogOpen(true);
  }, []);
  return /* @__PURE__ */ React98.createElement(DataProviderSelectorRoot, null, /* @__PURE__ */ React98.createElement(
    ...
    Autocomplete5,
    {
      ...
      renderInput: (params) => /* @__PURE__ */ React98.createElement(
        TextField23,
        {
          ...params,
          InputLabelProps: {
          ...
          InputProps: {
            ...params.InputProps,
            endAdornment: /* @__PURE__ */ React98.createElement(React98.Fragment, null, fileName ? /* @__PURE__ */ React98.createElement(
              OpenCodeEditorButton,
              {
                className: classes9.editButton,
                filePath: fileName,
                fileType: "resource",
                iconButton: true
              }
      ...
      renderOption: (props, option, state, ownerState) => {
        const icon = option.kind === "create" ? /* @__PURE__ */ React98.createElement(AddIcon8, null) : void 0;
        return /* @__PURE__ */ React98.createElement("li", { ...props }, /* @__PURE__ */ React98.createElement(Box32, { sx: { display: "flex", flexDirection: "row", alignItems: "center", gap: 1 } }, icon, ownerState.getOptionLabel(option)));
      },
      selectOnFocus: true,
      clearOnBlur: true,
      freeSolo: true,
...
function AppEditorShell({ children }) {
  return /* @__PURE__ */ React99.createElement(PropControlsContextProvider, { value: PROP_TYPE_CONTROLS }, /* @__PURE__ */ React99.createElement(
    Box33,
    {
      sx: {
        display: "flex",
...
import { Grid as Grid4, Typography as Typography24, Button as Button20 } from "@mui/material";
import * as React101 from "react";
import useBoolean6 from "@mui/toolpad-utils/hooks/useBoolean";
...
import useEventCallback6 from "@mui/utils/useEventCallback";
import * as appDom28 from "@mui/toolpad-core/appDom";
var DEFAULT_NAME2 = "page";
function CreatePageDialog({ open, onClose, ...props }) {
  const { dom } = useAppState();
  const appStateApi = useAppStateApi();
  const existingNames = React100.useMemo(
    () => appDom28.getExistingNamesForChildren(dom, appDom28.getApp(dom), "pages"),
    [dom]
  );
  const [name, setName] = React100.useState(appDom28.proposeName(DEFAULT_NAME2, existingNames));
  const handleReset = useEventCallback6(
  ...
  const isNameValid = !inputErrorMsg;
  const isFormValid = isNameValid;
  return /* @__PURE__ */ React100.createElement(Dialog11, { open, onClose, ...props }, /* @__PURE__ */ React100.createElement(
    DialogForm,
    {
      autoComplete: "off",
      onSubmit: (event) => {
    ...
    /* @__PURE__ */ React100.createElement(DialogTitle11, null, "Create a new Page"),
    /* @__PURE__ */ React100.createElement(DialogContent11, null, /* @__PURE__ */ React100.createElement(
      TextField24,
      {
        sx: { my: 1 },
        required: true,
    ...
    /* @__PURE__ */ React100.createElement(DialogActions11, null, /* @__PURE__ */ React100.createElement(Button19, { color: "inherit", variant: "text", onClick: onClose }, "Cancel"), /* @__PURE__ */ React100.createElement(Button19, { type: "submit", disabled: !isFormValid }, "Create"))
  ));
}
...
function NoPageFound() {
  ...
  return /* @__PURE__ */ React101.createElement(
    ...
    /* @__PURE__ */ React101.createElement(Grid4, { item: true }, /* @__PURE__ */ React101.createElement(Typography24, { variant: "h6" }, "No pages in this app.")),
    /* @__PURE__ */ React101.createElement(Grid4, { item: true }, /* @__PURE__ */ React101.createElement(Button20, { variant: "outlined", color: "inherit", onClick: handleCreatePageDialogOpen }, "Create new")),
    /* @__PURE__ */ React101.createElement(CreatePageDialog, { open: !!createPageDialogOpen, onClose: handleCreatepageDialogClose })
  );
}
...
var EditorRoot = styled33("div")(({ theme }) => ({
  ...
  [`& .${classes10.hierarchyPanel}`]: {
    width: 250,
    borderRight: `1px solid ${theme.palette.divider}`
  },
  [`& .${classes10.editorPanel}`]: {
    flex: 1,
    overflow: "hidden"
  }
}));
function FileEditor() {
  ...
  const currentViewContent = React102.useMemo(() => {
    switch (currentView.kind) {
      case "page": {
        if (currentView.name) {
          return /* @__PURE__ */ React102.createElement(PageEditor, { name: currentView.name });
        }
        return /* @__PURE__ */ React102.createElement(NoPageFound, null);
      }
      default:
        return /* @__PURE__ */ React102.createElement(NoPageFound, null);
    }
  }, [currentView.kind, currentView.name]);
  return /* @__PURE__ */ React102.createElement(AppEditorShell, null, currentViewContent);
}
function Editor2() {
  return /* @__PURE__ */ React102.createElement(EditorRoot, null, /* @__PURE__ */ React102.createElement(FileEditor, null));
}
...
function ThemeProvider({ children }) {
  ...
  return /* @__PURE__ */ React103.createElement(MuiThemeProvider, { theme }, /* @__PURE__ */ React103.createElement(ScopedCssBaseline, { enableColorScheme: true }, children));
}

// src/routes.ts
var APP_FUNCTIONS_ROUTE = "/app/functions";
...
import { AppBar, Box as Box35, Toolbar as Toolbar4, Tooltip as Tooltip15, Chip as Chip4, Link as Link6, useTheme as useTheme5 } from "@mui/material";
...
import useBoolean7 from "@mui/toolpad-utils/hooks/useBoolean";
...
var SUPPORT_URL = "https://mui.com/toolpad/getting-started/support";
...
function FeedbackMenuItemLink({ href, children }) {
  return /* @__PURE__ */ React104.createElement(MenuItem11, { component: "a", target: "_blank", href }, /* @__PURE__ */ React104.createElement(ListItemText6, null, children), /* @__PURE__ */ React104.createElement(OpenInNewIcon2, { fontSize: "inherit", sx: { ml: 3, color: "text.secondary" } }));
}
...
function UserFeedback() {
  ...
  return /* @__PURE__ */ React104.createElement(React104.Fragment, null, /* @__PURE__ */ React104.createElement(Dialog12, { open: updateDialogOpen, onClose: handleUpdateDialogClose, maxWidth: "xs" }, /* @__PURE__ */ React104.createElement(DialogTitle12, null, "Update Toolpad"), /* @__PURE__ */ React104.createElement(DialogContent12, null, /* @__PURE__ */ React104.createElement(DialogContentText3, null, "A new Toolpad version is available. To upgrade to the latest version, run:", /* @__PURE__ */ React104.createElement(CliCommandSnippet, null, getUpgradeMessage(versionInfo?.packageManager ?? null)))), /* @__PURE__ */ React104.createElement(DialogActions12, null, /* @__PURE__ */ React104.createElement(Button21, { onClick: handleUpdateDialogClose, autoFocus: true }, "Close"))), /* @__PURE__ */ React104.createElement(Tooltip13, { title: "Help and resources" }, /* @__PURE__ */ React104.createElement(IconButton22, { ...buttonProps, color: "primary" }, /* @__PURE__ */ React104.createElement(HelpOutlinedIcon, null))), /* @__PURE__ */ React104.createElement(Menu4, { ...menuProps }, /* @__PURE__ */ React104.createElement(FeedbackMenuItemLink, { href: DOCUMENTATION_URL }, "Documentation"), /* @__PURE__ */ React104.createElement(FeedbackMenuItemLink, { href: REPORT_BUG_URL }, "Report bug"), /* @__PURE__ */ React104.createElement(FeedbackMenuItemLink, { href: FEATURE_REQUEST_URL }, "Request or upvote feature"), /* @__PURE__ */ React104.createElement(FeedbackMenuItemLink, { href: SUPPORT_URL }, "Request support"), /* @__PURE__ */ React104.createElement(Divider10, null), /* @__PURE__ */ React104.createElement(
    MenuItem11,
    {
    ...
    updateAvailable ? /* @__PURE__ */ React104.createElement(Chip3, { size: "small", color: "error", variant: "outlined", label: "Update", clickable: true }) : null
  ), /* @__PURE__ */ React104.createElement(MenuItem11, { disabled: true }, "Build ", process.env.TOOLPAD_BUILD)));
}
var UserFeedback_default = UserFeedback;

// src/toolpad/ToolpadShell/Header/ThemeModeMenu.tsx
import * as React105 from "react";
import { IconButton as IconButton23, Menu as Menu5, MenuItem as MenuItem12, ListItemText as ListItemText7, ListItemIcon as ListItemIcon3, Tooltip as Tooltip14 } from "@mui/material";
...
var options = {
  light: {
    label: "Light",
    value: "light",
    icon: /* @__PURE__ */ React105.createElement(LightModeOutlined, null)
  },
  dark: {
    label: "Dark",
    value: "dark",
    icon: /* @__PURE__ */ React105.createElement(DarkModeOutlined, null)
  },
  system: {
    label: "System",
    value: "system",
    icon: /* @__PURE__ */ React105.createElement(SettingsBrightnessOutlined, null)
  }
};
function ThemeModeMenu({ mode, onChange }) {
  const { buttonProps, menuProps, onMenuClose } = useMenu();
  return /* @__PURE__ */ React105.createElement(React105.Fragment, null, /* @__PURE__ */ React105.createElement(Tooltip14, { title: "Change theme" }, /* @__PURE__ */ React105.createElement(IconButton23, { ...buttonProps, "aria-label": "Change theme", color: "primary" }, options[mode].icon)), /* @__PURE__ */ React105.createElement(Menu5, { ...menuProps }, Object.values(options).map((option) => /* @__PURE__ */ React105.createElement(
    MenuItem12,
    {
      key: option.value,
    ...
    /* @__PURE__ */ React105.createElement(ListItemIcon3, null, option.icon),
    /* @__PURE__ */ React105.createElement(ListItemText7, { primary: option.label })
  ))));
}
...
function Header({ navigation, actions, status, enableUserFeedback = true }) {
  ...
  const handleThemeModeChange = React106.useCallback(
    (event, mode) => {
      setThemeMode(mode);
    },
    [setThemeMode]
  ...
  return /* @__PURE__ */ React106.createElement(React106.Fragment, null, /* @__PURE__ */ React106.createElement(
    ...
    /* @__PURE__ */ React106.createElement(Toolbar4, null, /* @__PURE__ */ React106.createElement(
      Box35,
      {
        sx: {
          flex: 1,
      ...
      /* @__PURE__ */ React106.createElement(Tooltip15, { title: "Home" }, /* @__PURE__ */ React106.createElement(
        Link6,
        {
          color: "inherit",
          "aria-label": "Home",
        ...
        /* @__PURE__ */ React106.createElement("img", { src: productIcon, alt: "Toolpad product icon", width: 25, height: 25 }),
      ...
      /* @__PURE__ */ React106.createElement(Chip4, { sx: { ml: 1 }, label: "Beta", size: "small", color: "grey" }),
      navigation
    ), /* @__PURE__ */ React106.createElement(
      Box35,
      {
      ...
      status,
      /* @__PURE__ */ React106.createElement(ThemeModeMenu_default, { mode: themeMode, onChange: handleThemeModeChange }),
      enableUserFeedback ? /* @__PURE__ */ React106.createElement(UserFeedback_default, null) : null
    ))
  ), /* @__PURE__ */ React106.createElement(Toolbar4, null));
}
...
import {
  ...
  List as List5,
  Stack as Stack22,
  IconButton as IconButton24,
  Tooltip as Tooltip16
} from "@mui/material";
import { Link as Link7, matchPath as matchPath2, useLocation as useLocation3 } from "react-router-dom";
var DRAWER_WIDTH = 44;
...
function ToolpadNavigation() {
  ...
  return /* @__PURE__ */ React107.createElement(Drawer, { variant: "permanent", anchor: "left", open: true }, /* @__PURE__ */ React107.createElement(Toolbar5, { variant: "dense" }), /* @__PURE__ */ React107.createElement(List5, { component: "nav", sx: { pt: 1 } }, navigationOptions.map(({ name, path, icon }) => {
    const OptionIcon = icon;
    const isSelected = !!matchPath2(`${path}/*`, location.pathname);
    return /* @__PURE__ */ React107.createElement(ListItem5, { key: name, sx: { pt: 0.5, pb: 0.5, pl: 0, pr: 0 } }, /* @__PURE__ */ React107.createElement(Link7, { to: path, style: { textDecoration: "none", color: "inherit" } }, /* @__PURE__ */ React107.createElement(
      Stack22,
      {
        flex: 1,
        direction: "column",
      ...
      /* @__PURE__ */ React107.createElement(Tooltip16, { title: name, placement: "right" }, /* @__PURE__ */ React107.createElement(IconButton24, null, /* @__PURE__ */ React107.createElement(OptionIcon, { color: isSelected ? "primary" : "action", fontSize: "medium" })))
    )));
  })));
}
...
function ToolpadShell({ children, ...props }) {
  return /* @__PURE__ */ React108.createElement(ToolpadShellRoot, null, /* @__PURE__ */ React108.createElement(Header_default, { ...props }), /* @__PURE__ */ React108.createElement(Stack23, { direction: "row", sx: { flex: 1 } }, FEATURE_FLAG_GLOBAL_FUNCTIONS ? /* @__PURE__ */ React108.createElement(ToolpadNavigation, null) : null, /* @__PURE__ */ React108.createElement(ViewPort, null, children)));
}
...
import { errorFrom as errorFrom5 } from "@mui/toolpad-utils/errors";
import { TreeView as TreeView4, treeItemClasses as treeItemClasses3, TreeItem as TreeItem3 } from "@mui/x-tree-view";
import ExpandMoreIcon5 from "@mui/icons-material/ExpandMore";
...
import useBoolean8 from "@mui/toolpad-utils/hooks/useBoolean";
import { useQuery as useQuery2 } from "@tanstack/react-query";
import { ensureSuffix } from "@mui/toolpad-utils/strings";
import usePageTitle2 from "@mui/toolpad-utils/hooks/usePageTitle";
import * as appDom29 from "@mui/toolpad-core/appDom";
...
var FileTreeItemRoot = styled36(EditableTreeItem)(({ theme }) => ({
  ...
  [`& .${fileTreeItemClasses.handlerItem} .${treeItemClasses3.label}`]: {
    fontFamily: theme.typography.fontFamilyCode,
    fontSize: 14,
    padding: 4,
    display: "inline-block",
...
function HandlerFileTreeItem({
  ...
  const validateEditableFileName = React109.useCallback(
    (newName) => {
      if (newName !== labelText && validateItemName) {
        return validateItemName(newName);
      }
  ...
  return /* @__PURE__ */ React109.createElement(
    FileTreeItemRoot,
    {
      ...
      nodeId,
      labelText,
      renderLabel: (children) => /* @__PURE__ */ React109.createElement(React109.Fragment, null, /* @__PURE__ */ React109.createElement(JavascriptIcon2, { fontSize: "large" }), children, /* @__PURE__ */ React109.createElement(FlexFill_default, null), /* @__PURE__ */ React109.createElement(
        OpenCodeEditorButton,
        {
...
function FunctionsEditor() {
  usePageTitle2(`Functions | Toolpad editor`);
  const theme = useTheme6();
  const projectApi = useProjectApi();
  const [selectedHandler, setSelectedHandler] = React109.useState(null);
  ...
  const [expanded, setExpanded] = React109.useState(selectedFile ? [selectedFile] : []);
  const [latestCreatedHandler, setLatestCreatedHandler] = React109.useState(null);
  const execPrivate = React109.useCallback(
    (method, args) => {
  ...
  const handleSelectFunction = React109.useCallback(
    (_event, nodeId) => {
  ...
  const handlerTreeRef = React109.useRef(null);
  React109.useEffect(() => {
    handlerTreeRef.current?.querySelector(`.${treeItemClasses3.selected}`)?.scrollIntoView();
  }, []);
  const [newHandlerLoading, setNewHandlerLoading] = React109.useState(false);
  const [hasMounted, setHasMounted] = React109.useState(false);
  React109.useEffect(() => {
    setHasMounted(true);
  }, []);
  React109.useEffect(() => {
    ...
    if (handlerTree && hasMounted) {
      const selectedItem = handlerTree.querySelector(`.${treeItemClasses3.selected}`);
      if (selectedItem) {
        scrollIntoViewIfNeeded(selectedItem);
      }
    }
  ...
  const existingFileNames = React109.useMemo(
    () => new Set(
  ...
  const validateFileName = React109.useCallback(
    (fileName) => {
  ...
  const nextProposedName = React109.useMemo(
    () => appDom29.proposeName("myfunctions", existingFileNames),
    [existingFileNames]
  );
  const handleCreateNewCommit = React109.useCallback(
    async (newFileName) => {
  ...
  const handleSnackbarClose = React109.useCallback(() => {
    setLatestCreatedHandler(null);
  }, []);
  const [searchTerm, setSearchTerm] = React109.useState("");
  const handleSearch = React109.useCallback((newSearchTerm) => {
    setSearchTerm(newSearchTerm);
  }, []);
  const handleFileRename = React109.useCallback(async () => {
    try {
      await introspection.refetch();
    } catch (error) {
      window.alert(errorFrom5(error).message);
  ...
  const functionFiles = React109.useMemo(() => {
    const regex = new RegExp(searchTerm.split("").join(".*"), "i");
  ...
  return /* @__PURE__ */ React109.createElement(React109.Fragment, null, /* @__PURE__ */ React109.createElement(Box36, { sx: { height: "calc(100vh - 48px)" } }, /* @__PURE__ */ React109.createElement(resizablePanels_exports.PanelGroup, { direction: "horizontal" }, /* @__PURE__ */ React109.createElement(resizablePanels_exports.Panel, { defaultSize: 16, minSize: 16 }, /* @__PURE__ */ React109.createElement(
    Stack24,
    {
      direction: "column",
      sx: {
    ...
    /* @__PURE__ */ React109.createElement(
      TreeView4,
      {
        ...
        defaultCollapseIcon: /* @__PURE__ */ React109.createElement(ExpandMoreIcon5, null),
        defaultExpandIcon: /* @__PURE__ */ React109.createElement(ChevronRightIcon4, null),
        expanded,
      ...
      isCreateNewHandlerOpen ? /* @__PURE__ */ React109.createElement(
        EditableTreeItem,
        {
          nodeId: "::create::",
          isEditing: true,
          ...
          renderLabel: (children) => /* @__PURE__ */ React109.createElement(Box36, { sx: { display: "flex", alignItems: "center" } }, /* @__PURE__ */ React109.createElement(JavascriptIcon2, { fontSize: "large" }), children)
        }
      ) : null,
      functionFiles.map((file) => /* @__PURE__ */ React109.createElement(
        HandlerFileTreeItem,
        {
          key: file.name,
      ...
      introspection.data?.files.length === 0 ? /* @__PURE__ */ React109.createElement(Stack24, { alignItems: "center", sx: { mt: 2 } }, /* @__PURE__ */ React109.createElement(Typography25, { variant: "body1", fontSize: 14 }, "You don't have any functions yet\u2026"), /* @__PURE__ */ React109.createElement(
        Button22,
        {
          onClick: handleOpenCreateNewHandler,
          variant: "outlined",
          startIcon: /* @__PURE__ */ React109.createElement(AddIcon9, null),
          size: "medium",
          sx: { mt: 1 }
        },
        "Create function file"
      )) : null,
      introspection.isLoading ? /* @__PURE__ */ React109.createElement(React109.Fragment, null, /* @__PURE__ */ React109.createElement(TreeItem3, { disabled: true, nodeId: "::loading::", label: /* @__PURE__ */ React109.createElement(Skeleton5, null) }), /* @__PURE__ */ React109.createElement(TreeItem3, { disabled: true, nodeId: "::loading::", label: /* @__PURE__ */ React109.createElement(Skeleton5, null) }), /* @__PURE__ */ React109.createElement(TreeItem3, { disabled: true, nodeId: "::loading::", label: /* @__PURE__ */ React109.createElement(Skeleton5, null) })) : null
    ),
    introspection.error ? /* @__PURE__ */ React109.createElement(
      Box36,
      {
        sx: {
          position: "absolute",
  ...
  )), /* @__PURE__ */ React109.createElement(PanelResizeHandle, null), /* @__PURE__ */ React109.createElement(resizablePanels_exports.Panel, null, selectedHandler && selectedFile && selectedFunction ? /* @__PURE__ */ React109.createElement(Toolbar6, { sx: { borderBottom: `1px solid ${theme.palette.divider}` } }, /* @__PURE__ */ React109.createElement(
    Stack24,
    {
      direction: "row",
      alignItems: "center",
    ...
    /* @__PURE__ */ React109.createElement(Stack24, { direction: "row", alignItems: "center" }, /* @__PURE__ */ React109.createElement(JavascriptIcon2, { fontSize: "large" }), /* @__PURE__ */ React109.createElement(Typography25, { variant: "subtitle1", fontSize: 14 }, selectedFile, "\xA0\xA0\u203A\xA0\xA0", /* @__PURE__ */ React109.createElement("span", { style: { fontFamily: theme.typography.fontFamilyCode } }, selectedFunction))),
    /* @__PURE__ */ React109.createElement(Stack24, { direction: "row", alignItems: "center", gap: 1 }, /* @__PURE__ */ React109.createElement(
      OpenCodeEditorButton,
      {
        className: fileTreeItemClasses.actionButton,
        filePath: selectedFile,
    ...
    ), /* @__PURE__ */ React109.createElement(Button22, { variant: "contained", size: "medium", startIcon: /* @__PURE__ */ React109.createElement(PlayArrowIcon3, null) }, "Preview"))
  )) : /* @__PURE__ */ React109.createElement(
    Box36,
    {
      sx: {
    ...
    /* @__PURE__ */ React109.createElement(Stack24, { alignItems: "center", sx: { px: 4 } }, /* @__PURE__ */ React109.createElement(Typography25, { variant: "body1", textAlign: "center", fontSize: 14 }, /* @__PURE__ */ React109.createElement("strong", null, "Custom Functions"), " allow you to run your own JavaScript code, directly from your file system."), /* @__PURE__ */ React109.createElement(
      Link8,
      {
  ...
  )))), /* @__PURE__ */ React109.createElement(Portal2, null, latestCreatedHandler ? /* @__PURE__ */ React109.createElement(
    Snackbar3,
    {
      ...
      action: /* @__PURE__ */ React109.createElement(React109.Fragment, null, /* @__PURE__ */ React109.createElement(
        OpenCodeEditorButton,
        {
          className: fileTreeItemClasses.actionButton,
        ...
        /* @__PURE__ */ React109.createElement(CloseIcon2, { fontSize: "small" })
      ))
    }
  ) : null));
}
...
import { updateArray as updateArray2 } from "@mui/toolpad-utils/immutability";
import * as appDom30 from "@mui/toolpad-core/appDom";

// src/components/icons/AzureIcon.tsx
import * as React110 from "react";
function AzureIcon({ size = 18, color = "currentColor" }) {
  return /* @__PURE__ */ React110.createElement("svg", { viewBox: "0 0 59.242 47.271", width: size, height: size, xmlns: "http://www.w3.org/2000/svg" }, /* @__PURE__ */ React110.createElement(
    "path",
    {
...
var AUTH_PROVIDER_OPTIONS = /* @__PURE__ */ new Map([
  ["github", { name: "GitHub", icon: /* @__PURE__ */ React111.createElement(GitHubIcon, { fontSize: "small" }), hasRoles: false }],
  ["google", { name: "Google", icon: /* @__PURE__ */ React111.createElement(GoogleIcon, { fontSize: "small" }), hasRoles: false }],
  [
    "azure-ad",
    {
      name: "Azure AD",
      icon: /* @__PURE__ */ React111.createElement(AzureIcon, null),
      hasRoles: true
    }
  ]
]);
function AppAuthenticationEditor() {
  ...
  const isPaidPlan = plan !== void 0 && plan !== "free";
  const handleAuthProvidersChange = React111.useCallback(
    (event) => {
      const {
  ...
  const handleRestrictedDomainsChange = React111.useCallback(
    (index) => (event) => {
      const {
        target: { value: domain }
      } = event;
  ...
  const authProviders = React111.useMemo(
    () => authentication?.providers ?? [],
    [authentication?.providers]
  ).map((providerConfig) => providerConfig.provider);
  const restrictedDomains = authentication?.restrictedDomains ?? [];
  return /* @__PURE__ */ React111.createElement(Stack25, { direction: "column" }, /* @__PURE__ */ React111.createElement(Typography26, { variant: "subtitle1", mb: 1 }, "Providers"), /* @__PURE__ */ React111.createElement(FormControl2, null, /* @__PURE__ */ React111.createElement(InputLabel, { id: "auth-providers-label" }, "Authentication providers"), /* @__PURE__ */ React111.createElement(
    Select,
    {
    ...
    [...AUTH_PROVIDER_OPTIONS].map(([value, { name, icon, hasRoles }]) => /* @__PURE__ */ React111.createElement(MenuItem13, { key: value, value, disabled: hasRoles && !isPaidPlan }, /* @__PURE__ */ React111.createElement(Stack25, { direction: "row", alignItems: "center" }, /* @__PURE__ */ React111.createElement(Checkbox6, { checked: authProviders.indexOf(value) > -1 }), icon, /* @__PURE__ */ React111.createElement(Typography26, { mx: 1 }, name), hasRoles && !isPaidPlan ? /* @__PURE__ */ React111.createElement(UpgradeAlert, { feature: name, hideAction: true }) : null)))
  ), /* @__PURE__ */ React111.createElement(FormHelperText2, { id: "auth-providers-helper-text" }, "If set, only authenticated users can use the app.")), /* @__PURE__ */ React111.createElement(Alert9, { severity: "info", sx: { mt: 1 } }, "Certain environment variables must be set for authentication providers to work.", " ", /* @__PURE__ */ React111.createElement(Link9, { href: "https://mui.com/toolpad/concepts/authentication", target: "_blank" }, "Learn how to set up authentication"), "."), /* @__PURE__ */ React111.createElement(Typography26, { variant: "subtitle1", mt: 2 }, "Required email domains"), /* @__PURE__ */ React111.createElement(Typography26, { variant: "body2", mt: 1 }, "If set, authenticated user emails must be in one of the domains below."), [...restrictedDomains, ""].map((domain, index) => /* @__PURE__ */ React111.createElement(
    TextField25,
    {
      key: index,
      value: domain,
  ...
  )), !isPaidPlan ? /* @__PURE__ */ React111.createElement(
    UpgradeAlert,
    {
      type: "error",
...
function RolesToolbar({ addNewRoleDisabled, onAddNewRole }) {
  return /* @__PURE__ */ React111.createElement(GridToolbarContainer, null, /* @__PURE__ */ React111.createElement(
    Button23,
    {
      color: "primary",
      startIcon: /* @__PURE__ */ React111.createElement(AddIcon10, null),
...
function AppRolesEditor({ onRowUpdateError }) {
  const { dom } = useAppState();
  const appState = useAppStateApi();
  const [draftRow, setDraftRow] = React111.useState(null);
  const addRole = React111.useCallback(
    (role) => {
      appState.update((draft) => {
        const app = appDom30.getApp(draft);
  ...
  const updateRole = React111.useCallback(
    (name, values) => {
      appState.update((draft) => {
        const app = appDom30.getApp(draft);
        draft = appDom30.setNodeNamespacedProp(draft, app, "attributes", "authorization", {
  ...
  const deleteRole = React111.useCallback(
    (name) => {
      appState.update((draft) => {
        const app = appDom30.getApp(draft);
        draft = appDom30.setNodeNamespacedProp(draft, app, "attributes", "authorization", {
  ...
  const rolesRows = React111.useMemo(() => {
    const appNode = appDom30.getApp(dom);
  ...
  const rolesColumns = React111.useMemo(() => {
    return [
      {
        field: "name",
        headerName: "Name",
      ...
      },
      {
        ...
        renderCell: ({ value }) => {
          ...
          return /* @__PURE__ */ React111.createElement(Tooltip17, { title: preview }, /* @__PURE__ */ React111.createElement("span", null, value.length));
        }
      },
      {
        field: "actions",
        ...
        getActions: ({ row }) => {
          ...
          const deleteButton = /* @__PURE__ */ React111.createElement(
            GridActionsCellItem,
            {
              key: "delete",
              disabled: isBlockedByPages || row.isNew,
              icon: /* @__PURE__ */ React111.createElement(DeleteIcon9, null),
              label: "Delete",
          ...
          return [
            isBlockedByPages ? /* @__PURE__ */ React111.createElement(
              Tooltip17,
              {
                key: "delete",
                title: "This role can't be deleted because it is still associated with existing pages."
              },
              /* @__PURE__ */ React111.createElement("span", null, deleteButton)
            ) : deleteButton
          ];
        }
      }
  ...
  const handleAddNewRole = React111.useCallback(() => {
...
function AppRoleMappingsEditor({
  ...
  const { dom } = useAppState();
  const appState = useAppStateApi();
  const [activeAuthProvider, setAuthProvider] = React111.useState(
    roleEnabledActiveAuthProviderOptions[0]?.[0] ?? null
  );
  const handleAuthProviderChange = React111.useCallback(
    (event) => {
  ...
  const updateRoleMapping = React111.useCallback(
    (role, providerRoles) => {
  ...
  const roleMappingsRows = React111.useMemo(() => {
    if (!activeAuthProvider) {
      return [];
    }
    const appNode = appDom30.getApp(dom);
  ...
  const roleMappingsColumns = React111.useMemo(() => {
    return [
      {
        field: "role",
        headerName: "Role",
  ...
  return /* @__PURE__ */ React111.createElement(React111.Fragment, null, /* @__PURE__ */ React111.createElement(
    ...
    roleEnabledActiveAuthProviderOptions.map(([value, { name }]) => /* @__PURE__ */ React111.createElement(MenuItem13, { key: value, value }, name))
  ), /* @__PURE__ */ React111.createElement(
    "div",
    {
      style: { height: 350, width: "100%" },
...
function AppAuthorizationDialog({ open, onClose }) {
  ...
  const plan = appDom30.getPlan(dom);
  const isPaidPlan = plan !== void 0 && plan !== "free";
  const [activeTab, setActiveTab] = React111.useState(
    "authentication"
  );
  const handleActiveTabChange = React111.useCallback((event, newTab) => {
    setActiveTab(newTab);
  }, []);
  const [errorSnackbarMessage, setErrorSnackbarMessage] = React111.useState("");
  const handleRowUpdateError = React111.useCallback((error) => {
    setErrorSnackbarMessage(error.message);
  }, []);
  const handleErrorSnackbarClose = React111.useCallback(() => {
    setErrorSnackbarMessage("");
  }, []);
  const roleEnabledActiveAuthProviderOptions = React111.useMemo(() => {
    const appNode = appDom30.getApp(dom);
  ...
  return /* @__PURE__ */ React111.createElement(React111.Fragment, null, /* @__PURE__ */ React111.createElement(Dialog13, { open, onClose, fullWidth: true, maxWidth: "md" }, /* @__PURE__ */ React111.createElement(DialogTitle13, null, "Authorization"), /* @__PURE__ */ React111.createElement(TabContext8, { value: activeTab }, /* @__PURE__ */ React111.createElement(Box37, { sx: { borderBottom: 1, borderColor: "divider" } }, /* @__PURE__ */ React111.createElement(
    TabList7,
    {
      onChange: handleActiveTabChange,
      "aria-label": "Authorization configuration options"
    },
    /* @__PURE__ */ React111.createElement(Tab7, { label: "Authentication", value: "authentication", sx: { px: 2 } }),
    /* @__PURE__ */ React111.createElement(Tab7, { label: "Roles", value: "roles", sx: { px: 2 } }),
    roleEnabledActiveAuthProviderOptions.length > 0 ? /* @__PURE__ */ React111.createElement(Tab7, { label: "Role mappings", value: "roleMappings", sx: { px: 2 } }) : null
  )), /* @__PURE__ */ React111.createElement(DialogContent13, { sx: { minHeight: 480 } }, /* @__PURE__ */ React111.createElement(TabPanel_default, { disableGutters: true, value: "authentication" }, /* @__PURE__ */ React111.createElement(AppAuthenticationEditor, null)), /* @__PURE__ */ React111.createElement(React111.Fragment, null, /* @__PURE__ */ React111.createElement(TabPanel_default, { disableGutters: true, value: "roles" }, isPaidPlan ? /* @__PURE__ */ React111.createElement(React111.Fragment, null, /* @__PURE__ */ React111.createElement(Typography26, { variant: "body2" }, "Define the roles for your application. You can configure your pages to be accessible to specific roles only."), /* @__PURE__ */ React111.createElement(AppRolesEditor, { onRowUpdateError: handleRowUpdateError })) : /* @__PURE__ */ React111.createElement(UpgradeAlert, { type: "error", feature: "Role based access control" })), /* @__PURE__ */ React111.createElement(TabPanel_default, { disableGutters: true, value: "roleMappings" }, isPaidPlan ? /* @__PURE__ */ React111.createElement(React111.Fragment, null, /* @__PURE__ */ React111.createElement(Typography26, { variant: "body2" }, "Define mappings from authentication provider roles to Toolpad roles."), /* @__PURE__ */ React111.createElement(
    AppRoleMappingsEditor,
    {
      onRowUpdateError: handleRowUpdateError,
      roleEnabledActiveAuthProviderOptions
    }
  )) : /* @__PURE__ */ React111.createElement(UpgradeAlert, { feature: "Role mapping" }))))), /* @__PURE__ */ React111.createElement(DialogActions13, null, /* @__PURE__ */ React111.createElement(Button23, { color: "inherit", variant: "text", onClick: onClose }, "Close"))), /* @__PURE__ */ React111.createElement(
    Snackbar4,
    {
    ...
    errorSnackbarMessage ? /* @__PURE__ */ React111.createElement(Alert9, { onClose: handleErrorSnackbarClose, severity: "error" }, errorSnackbarMessage) : void 0
  ));
}
...
function FullPageLoader() {
  return /* @__PURE__ */ React112.createElement(Centered, null, /* @__PURE__ */ React112.createElement(CircularProgress4, null));
}
function FullPageError({ error }) {
  return /* @__PURE__ */ React112.createElement(Centered, { sx: { p: 4 } }, /* @__PURE__ */ React112.createElement(ErrorAlert, { sx: { width: "100%" }, error }));
}
function ErrorFallback({ error }) {
  return /* @__PURE__ */ React112.createElement(FullPageError, { error });
}
function renderAppSaveState(appState) {
  if (appState.saveDomError) {
    return /* @__PURE__ */ React112.createElement(Tooltip18, { title: "Error while saving" }, /* @__PURE__ */ React112.createElement(SyncProblemIcon, { color: "primary" }));
  }
  const isSaving = appState.unsavedDomChanges > 0;
  if (isSaving) {
    return /* @__PURE__ */ React112.createElement(Tooltip18, { title: "Saving changes\u2026" }, /* @__PURE__ */ React112.createElement(SyncIcon, { color: "primary" }));
  }
  return /* @__PURE__ */ React112.createElement(Tooltip18, { title: "All changes saved!" }, /* @__PURE__ */ React112.createElement(CloudDoneIcon, { color: "primary" }));
}
function EditorShell({ children }) {
  const appState = useAppStateContext();
  const location = useLocation4();
  const previewPath = React112.useMemo(() => {
  ...
  return /* @__PURE__ */ React112.createElement(
    ToolpadShell,
    {
      navigation: /* @__PURE__ */ React112.createElement(Stack26, { sx: { ml: 3 } }, /* @__PURE__ */ React112.createElement(Button24, { onClick: handleAuthorizationDialogOpen }, "Authorization")),
      actions: previewPath ? /* @__PURE__ */ React112.createElement(Stack26, { direction: "row", gap: 1, alignItems: "center" }, /* @__PURE__ */ React112.createElement(
        Button24,
        {
          variant: "outlined",
          endIcon: /* @__PURE__ */ React112.createElement(OpenInNewIcon3, null),
          color: "primary",
          component: "a",
          href: previewPath,
          target: "_blank"
...
function ToolpadEditorRoutes({ appUrl }) {
  return /* @__PURE__ */ React112.createElement(ThemeProvider, null, /* @__PURE__ */ React112.createElement(CssBaseline, null), /* @__PURE__ */ React112.createElement(Box38, { sx: { height: "1px", minHeight: "100vh" } }, /* @__PURE__ */ React112.createElement(ErrorBoundary, { fallbackRender: ErrorFallback }, /* @__PURE__ */ React112.createElement(React112.Suspense, { fallback: /* @__PURE__ */ React112.createElement(FullPageLoader, null) }, /* @__PURE__ */ React112.createElement(QueryClientProvider, { client: queryClient2 }, /* @__PURE__ */ React112.createElement(ProjectProvider, { url: appUrl, fallback: /* @__PURE__ */ React112.createElement(FullPageLoader, null) }, /* @__PURE__ */ React112.createElement(AppProvider, { appUrl }, /* @__PURE__ */ React112.createElement(EditorShell, null, /* @__PURE__ */ React112.createElement(Routes, null, FEATURE_FLAG_GLOBAL_FUNCTIONS ? /* @__PURE__ */ React112.createElement(Route, { path: APP_FUNCTIONS_ROUTE, element: /* @__PURE__ */ React112.createElement(FunctionsEditor, null) }) : null, /* @__PURE__ */ React112.createElement(Route, { path: "*", element: /* @__PURE__ */ React112.createElement(Editor2, null) }))))))))));
}
function ToolpadEditor({ basename, state }) {
  return /* @__PURE__ */ React112.createElement(BrowserRouter, { basename }, /* @__PURE__ */ React112.createElement(Routes, null, /* @__PURE__ */ React112.createElement(Route, { path: "/editor/*", element: /* @__PURE__ */ React112.createElement(ToolpadEditorRoutes, { appUrl: basename }) }), /* @__PURE__ */ React112.createElement(Route, { path: "/*", element: /* @__PURE__ */ React112.createElement(ToolpadAppRoutes, { basename, state }) })));
}
